...
function parseTopLevel() {
  ...
  _base.state.scopes.push(
    new (0, _state.Scope)(0, _base.state.tokens.length, true),
  );
  if (_base.state.scopeDepth !== 0) {
    throw new Error(
      `Invalid scope depth at end of file: ${_base.state.scopeDepth}`,
    );
  }
...
function parseStatementContent(declaration) {
  ...
  switch (starttype) {
    ...
    case _types.TokenType._import: {
      ...
      if (
        nextType === _types.TokenType.parenL ||
        nextType === _types.TokenType.dot
      ) {
        break;
      }
    ...
    case _types.TokenType.name:
      if (
        _base.state.contextualKeyword === _keywords.ContextualKeyword._async
      ) {
        ...
        _tokenizer.next.call(void 0);
        if (
          _tokenizer.match.call(void 0, _types.TokenType._function) &&
...
function startsAwaitUsing() {
  ...
  _tokenizer.next.call(void 0);
  if (
    !_util.isContextual.call(void 0, _keywords.ContextualKeyword._using) ||
  ...
  _tokenizer.next.call(void 0);
  if (
    !_tokenizer.match.call(void 0, _types.TokenType.name) ||
    _util.hasPrecedingLineBreak.call(void 0)
  ) {
    _base.state.restoreFromSnapshot(snapshot);
    return false;
...
function parseForStatement() {
  ...
  _base.state.scopes.push(
    new (0, _state.Scope)(startTokenIndex, endTokenIndex, false),
  );
  _base.state.scopeDepth--;
}
...
function isUsingInLoop() {
  ...
  // variable.
  if (
    _util.isLookaheadContextual.call(void 0, _keywords.ContextualKeyword._of)
  ) {
    return false;
  }
  return true;
...
function parseAmbiguousForStatement() {
  ...
  if (
    isAwaitUsing ||
    _tokenizer.match.call(void 0, _types.TokenType._var) ||
    _tokenizer.match.call(void 0, _types.TokenType._let) ||
    _tokenizer.match.call(void 0, _types.TokenType._const) ||
    isUsingInLoop()
  ) {
    if (isAwaitUsing) {
      _util.expectContextual.call(void 0, _keywords.ContextualKeyword._await);
    ...
    if (
      _tokenizer.match.call(void 0, _types.TokenType._in) ||
      _util.isContextual.call(void 0, _keywords.ContextualKeyword._of)
    ) {
      parseForIn(forAwait);
      return;
    }
...
function parseSwitchStatement() {
  ...
  while (
    !_tokenizer.match.call(void 0, _types.TokenType.braceR) &&
    !_base.state.error
  ) {
    if (
      _tokenizer.match.call(void 0, _types.TokenType._case) ||
      _tokenizer.match.call(void 0, _types.TokenType._default)
    ) {
...
function parseBlock(isFunctionScope = false, contextId = 0) {
  ...
  const endTokenIndex = _base.state.tokens.length;
  _base.state.scopes.push(
    new (0, _state.Scope)(startTokenIndex, endTokenIndex, isFunctionScope),
  );
  _base.state.scopeDepth--;
}
...
function parseFunction(functionStart, isStatement, optionalId = false) {
  ...
  if (
    ...
    !optionalId &&
    !_tokenizer.match.call(void 0, _types.TokenType.name) &&
    !_tokenizer.match.call(void 0, _types.TokenType._yield)
  ) {
    _util.unexpected.call(void 0);
  }
  ...
  _base.state.scopes.push(
    new (0, _state.Scope)(startTokenIndex, endTokenIndex, true),
  );
  _base.state.scopeDepth--;
  if (nameScopeStartTokenIndex !== null) {
    _base.state.scopes.push(
      new (0, _state.Scope)(nameScopeStartTokenIndex, endTokenIndex, true),
    );
    _base.state.scopeDepth--;
  }
}
...
function parseClass(isStatement, optionalId = false) {
  ...
  if (nameScopeStartTokenIndex !== null) {
    const endTokenIndex = _base.state.tokens.length;
    _base.state.scopes.push(
      new (0, _state.Scope)(nameScopeStartTokenIndex, endTokenIndex, false),
    );
    _base.state.scopeDepth--;
  }
}
...
function isClassProperty() {
  return (
    _tokenizer.match.call(void 0, _types.TokenType.eq) ||
    _tokenizer.match.call(void 0, _types.TokenType.semi) ||
    _tokenizer.match.call(void 0, _types.TokenType.braceR) ||
    _tokenizer.match.call(void 0, _types.TokenType.bang) ||
    _tokenizer.match.call(void 0, _types.TokenType.colon)
  );
}

function isClassMethod() {
  return (
    _tokenizer.match.call(void 0, _types.TokenType.parenL) ||
    _tokenizer.match.call(void 0, _types.TokenType.lessThan)
  );
}
...
function parseClassBody(classContextId) {
  ...
  while (
    !_tokenizer.eat.call(void 0, _types.TokenType.braceR) &&
    !_base.state.error
  ) {
...
function parseClassMember(memberStart, classContextId) {
  ...
  if (
    _tokenizer.match.call(void 0, _types.TokenType.name) &&
    _base.state.contextualKeyword === _keywords.ContextualKeyword._static
  ) {
    ...
    if (_tokenizer.match.call(void 0, _types.TokenType.braceL)) {
      ...
      _base.state.tokens[_base.state.tokens.length - 1].contextId =
        classContextId;
      parseBlock();
      return;
    }
...
function parseClassMemberWithIsStatic(memberStart, isStatic, classContextId) {
  ...
  if (isClassMethod()) {
    ...
    token.contextualKeyword === _keywords.ContextualKeyword._async &&
    ...
    !(
      _util.isLineTerminator.call(void 0) &&
      _tokenizer.match.call(void 0, _types.TokenType.star)
    )
  ) {
    ...
    token.contextualKeyword === _keywords.ContextualKeyword._accessor &&
    !_util.isLineTerminator.call(void 0)
  ) {
    parseClassPropertyName(classContextId);
    parseClassProperty();
...
function parseClassProperty() {
  ...
  if (_tokenizer.match.call(void 0, _types.TokenType.eq)) {
    ...
    _base.state.tokens[equalsTokenIndex].rhsEndIndex =
      _base.state.tokens.length;
  }
  _util.semicolon.call(void 0);
}
...
function parseExport() {
  ...
  if (shouldParseExportStar()) {
    ...
    _expression.parseIdentifier.call(void 0);
    if (
      _tokenizer.match.call(void 0, _types.TokenType.comma) &&
      _tokenizer.lookaheadType.call(void 0) === _types.TokenType.star
    ) {
...
function parseExportDefaultExpression() {
  ...
  if (_tokenizer.eat.call(void 0, _types.TokenType._function)) {
    ...
    _tokenizer.lookaheadType.call(void 0) === _types.TokenType._function
  ) {
...
function isExportDefaultSpecifier() {
  if (
    _base.isTypeScriptEnabled &&
    _typescript.tsIsDeclarationStart.call(void 0)
  ) {
    return false;
  } else if (
    _base.isFlowEnabled &&
    _flow.flowShouldDisallowExportDefaultSpecifier.call(void 0)
  ) {
    return false;
  }
  if (_tokenizer.match.call(void 0, _types.TokenType.name)) {
  ...
  const hasFrom =
    lookahead.type === _types.TokenType.name &&
  ...
  if (hasFrom) {
    const nextAfterFrom = _base.input.charCodeAt(
      _tokenizer.nextTokenStartSince.call(void 0, _next + 4),
    );
    return (
      nextAfterFrom === _charcodes.charCodes.quotationMark ||
      nextAfterFrom === _charcodes.charCodes.apostrophe
    );
  }
  return false;
}
...
function shouldParseExportDeclaration() {
  return (
    (_base.isTypeScriptEnabled &&
      _typescript.tsIsDeclarationStart.call(void 0)) ||
    (_base.isFlowEnabled &&
      _flow.flowShouldParseExportDeclaration.call(void 0)) ||
...
function parseExportSpecifier() {
  ...
  _base.state.tokens[_base.state.tokens.length - 1].identifierRole =
    _tokenizer.IdentifierRole.ExportAccess;
...
function parseImport() {
  if (
    _base.isTypeScriptEnabled &&
    _tokenizer.match.call(void 0, _types.TokenType.name) &&
    _tokenizer.lookaheadType.call(void 0) === _types.TokenType.eq
  ) {
  ...
  if (
    ...
    if (
      ...
      lookahead.type === _types.TokenType.star ||
      lookahead.type === _types.TokenType.braceL
    ) {
...
function parseImportSpecifier() {
  ...
  if (_util.isContextual.call(void 0, _keywords.ContextualKeyword._as)) {
    _base.state.tokens[_base.state.tokens.length - 1].identifierRole =
      _tokenizer.IdentifierRole.ImportAccess;
    _tokenizer.next.call(void 0);
    _lval.parseImportedIdentifier.call(void 0);
  }
}
...
function maybeParseImportAttributes() {
  if (
    _tokenizer.match.call(void 0, _types.TokenType._with) ||
    (_util.isContextual.call(void 0, _keywords.ContextualKeyword._assert) &&
      !_util.hasPrecedingLineBreak.call(void 0))
  ) {
    _tokenizer.next.call(void 0);
