...
function isLookaheadContextual(contextualKeyword) {
  ...
  return (
    l.type === _types.TokenType.name &&
    l.contextualKeyword === contextualKeyword
  );
}
...
function canInsertSemicolon() {
  return (
    _index.match.call(void 0, _types.TokenType.eof) ||
...
function expect(type) {
  ...
  if (!matched) {
    unexpected(
      `Unexpected token, expected "${_types.formatTokenType.call(void 0, type)}"`,
    );
  }
}
