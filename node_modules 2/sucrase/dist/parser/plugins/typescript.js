...
function tsParseTypeParameter() {
  ...
  const hadOut = _util.eatContextual.call(
    void 0,
    _keywords.ContextualKeyword._out,
  );
  _index.eat.call(void 0, _types.TokenType._const);
...
function tsParseTypeParameters() {
  ...
  if (
    _index.match.call(void 0, _types.TokenType.lessThan) ||
    _index.match.call(void 0, _types.TokenType.typeParameterStart)
  ) {
    _index.next.call(void 0);
  } else {
  ...
  while (
    !_index.eat.call(void 0, _types.TokenType.greaterThan) &&
    !_base.state.error
  ) {
...
function tsIsUnambiguouslyIndexSignature() {
  ...
  const isIndexSignature =
    _index.eat.call(void 0, _types.TokenType.name) &&
...
function tsParseTypeMember() {
  ...
  if (
    (_util.isContextual.call(void 0, _keywords.ContextualKeyword._get) ||
      _util.isContextual.call(void 0, _keywords.ContextualKeyword._set)) &&
    tsNextTokenCanFollowModifier()
  ) {
  ...
  _expression.parsePropertyName.call(
    void 0,
    -1 /* Types don't need context IDs. */,
  );
...
function tsParseObjectTypeMembers() {
  ...
  while (
    !_index.eat.call(void 0, _types.TokenType.braceR) &&
    !_base.state.error
  ) {
    tsParseTypeMember();
  }
...
function tsIsStartOfMappedType() {
  _index.next.call(void 0);
  if (
    _index.eat.call(void 0, _types.TokenType.plus) ||
    _index.eat.call(void 0, _types.TokenType.minus)
  ) {
    return _util.isContextual.call(
      void 0,
...
function tsParseMappedType() {
  _util.expect.call(void 0, _types.TokenType.braceL);
  if (
    _index.match.call(void 0, _types.TokenType.plus) ||
    _index.match.call(void 0, _types.TokenType.minus)
  ) {
    _index.next.call(void 0);
...
function tsParseTupleType() {
  _util.expect.call(void 0, _types.TokenType.bracketL);
  while (
    !_index.eat.call(void 0, _types.TokenType.bracketR) &&
    !_base.state.error
  ) {
...
function tsParseTemplateLiteralType() {
  ...
  _index.nextTemplateToken.call(void 0);
  while (
    !_index.match.call(void 0, _types.TokenType.backQuote) &&
    !_base.state.error
  ) {
...
function tsParseFunctionOrConstructorType(type) {
  ...
  const oldInDisallowConditionalTypesContext =
    _base.state.inDisallowConditionalTypesContext;
...
function tsParseNonArrayType() {
  switch (_base.state.type) {
    ...
    case _types.TokenType._this: {
      tsParseThisTypeNode();
      if (
        _util.isContextual.call(void 0, _keywords.ContextualKeyword._is) &&
        !_util.hasPrecedingLineBreak.call(void 0)
      ) {
...
function tsParseArrayTypeOrHigher() {
  ...
  while (
    !_util.hasPrecedingLineBreak.call(void 0) &&
    _index.eat.call(void 0, _types.TokenType.bracketL)
  ) {
...
function tsParseTypeOperatorOrHigher() {
  if (
    ...
    _util.isContextual.call(void 0, _keywords.ContextualKeyword._infer)
  ) {
    tsParseInferType();
  } else {
    const oldInDisallowConditionalTypesContext =
...
function tsIsStartOfFunctionType() {
  ...
  return (
    _index.match.call(void 0, _types.TokenType.parenL) &&
    tsLookaheadIsUnambiguouslyStartOfFunctionType()
  );
}
...
function tsSkipParameterStart() {
  if (
    _index.match.call(void 0, _types.TokenType.name) ||
    _index.match.call(void 0, _types.TokenType._this)
  ) {
    _index.next.call(void 0);
    return true;
  }
  ...
  if (
    ...
    while (depth > 0 && !_base.state.error) {
      if (
        ...
        _index.match.call(void 0, _types.TokenType.braceR) ||
        _index.match.call(void 0, _types.TokenType.bracketR)
      ) {
        depth--;
      }
      _index.next.call(void 0);
...
function tsIsUnambiguouslyStartOfFunctionType() {
  ...
  if (tsSkipParameterStart()) {
    if (
      _index.match.call(void 0, _types.TokenType.colon) ||
      _index.match.call(void 0, _types.TokenType.comma) ||
      _index.match.call(void 0, _types.TokenType.question) ||
...
function tsParseType() {
  ...
  if (
    _base.state.inDisallowConditionalTypesContext ||
    _util.hasPrecedingLineBreak.call(void 0) ||
    !_index.eat.call(void 0, _types.TokenType._extends)
  ) {
    return;
  }
  // extends type
...
function isAbstractConstructorSignature() {
  return (
    _util.isContextual.call(void 0, _keywords.ContextualKeyword._abstract) &&
    _index.lookaheadType.call(void 0) === _types.TokenType._new
  );
}
...
function tsTryParseJSXTypeArgument() {
  if (_index.eat.call(void 0, _types.TokenType.jsxTagStart)) {
    _base.state.tokens[_base.state.tokens.length - 1].type =
      _types.TokenType.typeParameterStart;
    const oldIsType = _index.pushTypeContext.call(void 0, 1);
    while (
      !_index.match.call(void 0, _types.TokenType.greaterThan) &&
      !_base.state.error
    ) {
      tsParseType();
      _index.eat.call(void 0, _types.TokenType.comma);
...
function tsIsExternalModuleReference() {
  return (
    _util.isContextual.call(void 0, _keywords.ContextualKeyword._require) &&
    _index.lookaheadType.call(void 0) === _types.TokenType.parenL
  );
}
...
function tsTryParseDeclare() {
  ...
  switch (_base.state.type) {
    ...
    case _types.TokenType._const: {
      if (
        _index.match.call(void 0, _types.TokenType._const) &&
        _util.isLookaheadContextual.call(
          void 0,
          _keywords.ContextualKeyword._enum,
        )
      ) {
        const oldIsType = _index.pushTypeContext.call(void 0, 1);
    ...
    case _types.TokenType._let: {
      const oldIsType = _index.pushTypeContext.call(void 0, 1);
      _statement.parseVarStatement.call(
        void 0,
...
function tsParseDeclaration(contextualKeyword, isBeforeToken) {
  switch (contextualKeyword) {
    case _keywords.ContextualKeyword._abstract:
      if (
        tsCheckLineTerminator(isBeforeToken) &&
    ...
    case _keywords.ContextualKeyword._interface:
      if (
        ...
        // as well.
        const oldIsType = _index.pushTypeContext.call(
          void 0,
          isBeforeToken ? 2 : 1,
        );
...
function tsParseFunctionBodyAndFinish(functionStart, funcContextId) {
  ...
  if (
    !_index.match.call(void 0, _types.TokenType.braceL) &&
    _util.isLineTerminator.call(void 0)
  ) {
...
function tsParseSubscript(startTokenIndex, noCalls, stopState) {
  if (
    ...
    _base.state.tokens[_base.state.tokens.length - 1].type =
      _types.TokenType.nonNullAssertion;
    return;
  }

  if (
    _index.match.call(void 0, _types.TokenType.lessThan) ||
    _index.match.call(void 0, _types.TokenType.bitShiftL)
  ) {
    ...
    if (!noCalls && _index.eat.call(void 0, _types.TokenType.parenL)) {
      ...
      _base.state.tokens[_base.state.tokens.length - 1].subscriptStartIndex =
        startTokenIndex;
    ...
    !noCalls &&
    _index.match.call(void 0, _types.TokenType.questionDot) &&
    _index.lookaheadType.call(void 0) === _types.TokenType.lessThan
  ) {
  ...
  _expression.baseParseSubscript.call(
    void 0,
    startTokenIndex,
    noCalls,
    stopState,
...
function tsTryParseExport() {
  if (_index.eat.call(void 0, _types.TokenType._import)) {
    ...
    if (
      ...
      _index.lookaheadType.call(void 0) !== _types.TokenType.eq
    ) {
    ...
    if (_util.isContextual.call(void 0, _keywords.ContextualKeyword._type)) {
      ...
      if (
        nextType === _types.TokenType.braceL ||
        nextType === _types.TokenType.star
      ) {
        _index.next.call(void 0);
      }
    }
...
function tsParseImportSpecifier() {
  ...
  if (
    ...
    _base.state.tokens[_base.state.tokens.length - 1].identifierRole =
      _index.IdentifierRole.ImportDeclaration;
    return;
  }
  _expression.parseIdentifier.call(void 0);
  if (
  ...
  if (
    ...
    // import {foo as bar}
    _base.state.tokens[_base.state.tokens.length - 3].identifierRole =
      _index.IdentifierRole.ImportAccess;
    _base.state.tokens[_base.state.tokens.length - 1].identifierRole =
      _index.IdentifierRole.ImportDeclaration;
    return;
  }
...
function tsParseExportSpecifier() {
  ...
  if (
    ...
    // export {foo}
    _base.state.tokens[_base.state.tokens.length - 1].identifierRole =
      _index.IdentifierRole.ExportAccess;
    return;
  }
  _expression.parseIdentifier.call(void 0);
  if (
...
function tsTryParseExportDefaultExpression() {
  if (
    _util.isContextual.call(void 0, _keywords.ContextualKeyword._abstract) &&
    _index.lookaheadType.call(void 0) === _types.TokenType._class
  ) {
...
function tsTryParseStatementContent() {
  if (_base.state.type === _types.TokenType._const) {
    ...
    if (
      ahead.type === _types.TokenType.name &&
      ahead.contextualKeyword === _keywords.ContextualKeyword._enum
    ) {
      _util.expect.call(void 0, _types.TokenType._const);
      _util.expectContextual.call(void 0, _keywords.ContextualKeyword._enum);
      _base.state.tokens[_base.state.tokens.length - 1].type =
...
function tsParseExportDeclaration() {
  ...
  const isDeclare = _util.eatContextual.call(
    void 0,
    _keywords.ContextualKeyword._declare,
  );
  if (isDeclare) {
...
function tsAfterParseClassSuper(hasSuper) {
  ...
  if (
    _util.eatContextual.call(void 0, _keywords.ContextualKeyword._implements)
  ) {
    _base.state.tokens[_base.state.tokens.length - 1].type =
      _types.TokenType._implements;
    const oldIsType = _index.pushTypeContext.call(void 0, 1);
    tsParseHeritageClause();
    _index.popTypeContext.call(void 0, oldIsType);
  }
...
exports.tsStartParseAsyncArrowFromCallExpression =
...
function tsParseMaybeAssignWithJSX(noIn, isWithinParens) {
  ...
  const snapshot = _base.state.snapshot();
  let wasArrow = _expression.baseParseMaybeAssign.call(
    void 0,
    noIn,
    isWithinParens,
  );
  ...
  tsParseTypeParameters();
  wasArrow = _expression.baseParseMaybeAssign.call(
    void 0,
    noIn,
    isWithinParens,
  );
...
function tsParseMaybeAssignWithoutJSX(noIn, isWithinParens) {
  ...
  // This is similar to TypeScript's `tryParseParenthesizedArrowFunctionExpression`.
  tsParseTypeParameters();
  const wasArrow = _expression.baseParseMaybeAssign.call(
    void 0,
    noIn,
    isWithinParens,
  );
