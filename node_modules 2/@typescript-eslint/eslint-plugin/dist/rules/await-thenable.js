  ...
  create(context) {
    ...
    return {
      AwaitExpression(node) {
        ...
        const certainty = (0, util_1.needsToBeAwaited)(
          checker,
          awaitArgumentTsNode,
          awaitArgumentType,
        );
      ...
      CallExpression(node) {
        if (
          !(0, isPromiseAggregatorMethod_1.isPromiseAggregatorMethod)(
            context,
            services,
            node,
          )
          ...
          context.report({
            ...
            suggest: [
              ...
              // of promises, since the loop variable is not awaited.
              {
                ...
                fix(fixer) {
                  const awaitToken = (0, util_1.nullThrows)(
                    context.sourceCode.getFirstToken(
                      node,
                      util_1.isAwaitKeyword,
                    ),
...
function isAlwaysNonAwaitableType(type, node, checker) {
  return tsutils
    ...
    .every(
      (typeArgumentPart) =>
        (0, util_1.needsToBeAwaited)(checker, node, typeArgumentPart) ===
        util_1.Awaitable.Never,
    );
}
