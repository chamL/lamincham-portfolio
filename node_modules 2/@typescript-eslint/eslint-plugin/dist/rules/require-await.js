      ...
      if (
        ...
        const nodeWithAsyncKeyword =
          ...
          (node.parent.type === utils_1.AST_NODE_TYPES.Property &&
            ...
            ? node.parent
            : node;
        const asyncToken = (0, util_1.nullThrows)(
        ...
        const addSemiColon =
          nextToken.type === utils_1.AST_TOKEN_TYPES.Punctuator &&
          (nextToken.value === "[" || nextToken.value === "(") &&
          (nodeWithAsyncKeyword.type ===
            utils_1.AST_NODE_TYPES.MethodDefinition ||
            (0, util_1.isStartOfExpressionStatement)(nodeWithAsyncKeyword)) &&
          (0, util_1.needsPrecedingSemicolon)(
            context.sourceCode,
            nodeWithAsyncKeyword,
          );
        const changes = [
        ...
        if (
          ...
          if (scopeInfo.isGen) {
            ...
            const openAngle = (0, util_1.nullThrows)(
              context.sourceCode.getFirstToken(
            ...
            const closeAngle = (0, util_1.nullThrows)(
...
function hasTypeName(typeReference, typeName) {
  return (
    typeReference.typeName.type === utils_1.AST_NODE_TYPES.Identifier &&
