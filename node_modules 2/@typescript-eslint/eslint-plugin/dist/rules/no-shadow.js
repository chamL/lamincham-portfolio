...
const functionsHoistedNodes = new Set([
  ...
  create(context, [options]) {
    ...
    function isTypeValueShadow(variable, shadowed) {
      ...
      const isShadowedValue =
        ...
        !firstDefinition ||
        (!(0, isTypeImport_1.isTypeImport)(firstDefinition) &&
    ...
    function isDeclareInDTSFile(variable) {
      ...
      return variable.defs.some((def) => {
        return (
          (def.type === scope_manager_1.DefinitionType.Variable &&
            def.parent.declare) ||
          (def.type === scope_manager_1.DefinitionType.ClassName &&
            def.node.declare) ||
          (def.type === scope_manager_1.DefinitionType.TSEnumName &&
            def.node.declare) ||
          (def.type === scope_manager_1.DefinitionType.TSModuleName &&
            def.node.declare)
        );
      });
    }
