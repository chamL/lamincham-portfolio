  ...
  create(
    ...
    function canBeUndefined(type) {
      ...
      return tsutils
        ...
        .some((part) =>
          (0, util_1.isTypeFlagSet)(part, ts.TypeFlags.Undefined),
        );
    }
    ...
    function hasConditionalInitializer(node) {
      ...
      if (
        ...
        return (
          parent.init.type === utils_1.AST_NODE_TYPES.ConditionalExpression ||
    ...
    function getSourceTypeForPattern(pattern) {
      ...
      if ((0, util_1.isFunction)(parent)) {
        ...
        const signature = (0, util_1.nullThrows)(
          ...
          util_1.NullThrowsReasons.MissingToken("signature", "function"),
        );
      ...
      return (
        (expression.type === utils_1.AST_NODE_TYPES.ObjectExpression &&
          expression.properties.some(
            (prop) =>
              prop.type === utils_1.AST_NODE_TYPES.Property &&
