...
exports.default = (0, util_1.createRule)({
  ...
  create(context, [options]) {
    ...
    function isRethrownError(node) {
      ...
      const smVariable = (0, util_1.nullThrows)(
        (0, util_1.findVariable)(scope, node),
      ...
      if (
        def.node.type === utils_1.AST_NODE_TYPES.ArrowFunctionExpression &&
        ...
        const parsedPromiseHandlingCall =
          (0, promiseUtils_1.parseCatchCall)(callExpression, context) ??
        ...
        if (parsedPromiseHandlingCall != null) {
          ...
          if (onRejected === def.node) {
            ...
            if (
              (0, ts_api_utils_1.isThenableType)(
