...
exports.default = (0, util_1.createRule)({
  ...
  defaultOptions: [],
  create(context) {
    const { esTreeNodeToTSNodeMap, program } = (0, util_1.getParserServices)(
      context,
    );
    ...
    return {
      CallExpression({ arguments: args, callee }) {
        ...
        const staticMemberAccessKey = (0, util_1.getStaticMemberAccessValue)(
          callee,
          context,
        );
        ...
        if (
          argsToCheck.some(
            ({ type }) => type === utils_1.AST_NODE_TYPES.SpreadElement,
          )
        ) {
          return;
        }
