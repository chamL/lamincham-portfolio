    ...
    function checkNode(node, descriptor) {
      ...
      for (const typeParameter of tsNode.typeParameters) {
        const esTypeParameter =
          parserServices.tsNodeToESTreeNodeMap.get(typeParameter);
              ...
              *fix(fixer) {
                ...
                for (const reference of smTypeParameterVariable.references) {
                  if (reference.isTypeReference) {
                    ...
                    const isComplexType =
                      constraint?.type === utils_1.AST_NODE_TYPES.TSUnionType ||
                      constraint?.type ===
                ...
                const typeParamsNode = (0, util_1.nullThrows)(
                  node.typeParameters,
                ...
                if (typeParamsNode.params.length === 1) {
                  ...
                  if (index === 0) {
                    const commaAfter = (0, util_1.nullThrows)(
                    ...
                    const tokenAfterComma = (0, util_1.nullThrows)(
                    ...
                    const commaBefore = (0, util_1.nullThrows)(
    ...
    if (
      ...
      if (
        ...
        !(
          ...
          grandparent.parent.typeName.type ===
