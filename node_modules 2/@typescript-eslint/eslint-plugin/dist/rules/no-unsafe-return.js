...
exports.default = (0, util_1.createRule)({
  ...
  create(context) {
    ...
    function checkReturn(returnNode, reportingNode = returnNode) {
      ...
      const anyType = (0, util_1.discriminateAnyType)(
        type,
        checker,
        services.program,
        tsNode,
      );
      const functionNode = (0, getParentFunctionNode_1.getParentFunctionNode)(
        returnNode,
      );
      ...
      const constrainedReturnNodeType = (0,
      util_1.getConstrainedTypeAtLocation)(services, returnNode);
