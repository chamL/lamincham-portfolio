...
exports.default = (0, util_1.createRule)({
  ...
  create(context) {
    ...
    function checkExpression(node) {
      ...
      if (
        (0, util_1.isTypeAnyType)(assertedType) &&
        (0, util_1.isTypeUnknownType)(expressionType)
      ) {
        context.report({
          node,
      ...
      const unsafeExpressionAny = (0, util_1.isUnsafeAssignment)(
        expressionType,
        assertedType,
        checker,
        node.expression,
      ...
      const unsafeAssertedAny = (0, util_1.isUnsafeAssignment)(
        assertedType,
        expressionType,
        checker,
        node.typeAnnotation,
