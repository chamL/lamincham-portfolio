...
exports.default = (0, util_1.createRule)({
  ...
  create(context, [options]) {
    ...
    function searchForDeprecationInAliasesChain(
      symbol,
      checkDeprecationsOfAliasedSymbol,
    ) {
    ...
    function getCallLikeNode(node) {
      let callee = node;
      while (
        callee.parent?.type === utils_1.AST_NODE_TYPES.MemberExpression &&
    ...
    function getJSXAttributeDeprecation(openingElement, propertyName) {
      const contextualType = (0, util_1.nullThrows)(
    ...
    function checkIdentifier(node) {
      ...
      if (
        (0, util_1.typeMatchesSomeSpecifier)(type, allow, services.program) ||
