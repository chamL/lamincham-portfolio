  ...
  create(context, [options]) {
    ...
    return {
      'LogicalExpression[operator!="??"]'(node) {
        ...
        const { newlySeenLogicals, operands } = (0,
        ...
        for (const operand of operands) {
          if (
            operand.type === gatherLogicalOperands_1.OperandValidity.Invalid
          ) {
            ...
            operand.type === gatherLogicalOperands_1.OperandValidity.Last
          ) {
            (0, analyzeChain_1.analyzeChain)(
              context,
              parserServices,
