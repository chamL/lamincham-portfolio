...
exports.default = (0, util_1.createRule)({
  ...
  create(context) {
    ...
    return {
      ...
      "ClassBody:exit"() {
        const { assignedBeforeConstructor, unnecessaryAssignments } = (0,
        util_1.nullThrows)(reportInfoStack.pop(), "The top stack should exist");
      ...
      "MethodDefinition[kind='constructor'] > FunctionExpression AssignmentExpression"(
        ...
        const { assignedBeforeUnnecessary, unnecessaryAssignments } = (0,
        util_1.nullThrows)(
      ...
      "PropertyDefinition AssignmentExpression"(node) {
        ...
        const { assignedBeforeConstructor } = (0, util_1.nullThrows)(
