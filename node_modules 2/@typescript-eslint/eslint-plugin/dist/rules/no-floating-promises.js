...
exports.default = (0, util_1.createRule)({
  ...
  create(context, [options]) {
    ...
    function addAwait(fixer, expression, node) {
      ...
      if (
        (0, util_1.isParenthesized)(expression, context.sourceCode) ||
        (0, util_1.getOperatorPrecedenceForNode)(expression) >
          util_1.OperatorPrecedence.Unary
      ) {
    ...
    function isKnownSafePromiseCall(node) {
      ...
      if (
        (0, util_1.valueMatchesSomeSpecifier)(
          node.callee,
          allowForKnownSafeCalls,
          services.program,
          type,
      ...
      return (0, util_1.typeMatchesSomeSpecifier)(
        type,
        allowForKnownSafeCalls,
        services.program,
      );
    ...
    function isUnhandledPromise(checker, node) {
      ...
      if (node.type === utils_1.AST_NODE_TYPES.CallExpression) {
        ...
        const promiseHandlingMethodCall =
          (0, promiseUtils_1.parseCatchCall)(node, context) ??
          (0, promiseUtils_1.parseThenCall)(node, context);
        ...
        const promiseFinallyCall = (0, promiseUtils_1.parseFinallyCall)(
          node,
          context,
        );
    ...
    function isPromiseLike(node, type) {
      ...
      if (
        (0, util_1.typeMatchesSomeSpecifier)(
          type,
          allowForKnownSafePromises,
          services.program,
        )
