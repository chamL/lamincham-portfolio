...
exports.default = (0, util_1.createRule)({
  ...
  create(context, [options]) {
    ...
    function traverseCallExpression(node) {
      const assertedArgument = (0,
      assertionFunctionUtils_1.findTruthinessAssertedArgument)(services, node);
        ...
        suggestions.push({
          ...
          fix: (fixer) => {
            ...
            if (predicateNode.params.length === 0) {
              const closingBracket = (0, util_1.nullThrows)(
            ...
            const lastClosingParenthesis = (0, util_1.nullThrows)(
