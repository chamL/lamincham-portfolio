...
const constantLoopConditionsAllowedLiterals = new Set([true, false, 1, 0]);
exports.default = (0, util_1.createRule)({
  ...
  create(
    ...
    function checkNode(
      ...
      if (
        expression.type === utils_1.AST_NODE_TYPES.UnaryExpression &&
        expression.operator === "!"
      ) {
    ...
    function checkCallExpression(node) {
      if (checkTypePredicates) {
        const truthinessAssertedArgument = (0,
        assertionFunctionUtils_1.findTruthinessAssertedArgument)(
          services,
          node,
        );
        ...
        const typeGuardAssertedArgument = (0,
        assertionFunctionUtils_1.findTypeGuardAssertedArgument)(services, node);
        if (typeGuardAssertedArgument != null) {
          const typeOfArgument = (0, util_1.getConstrainedTypeAtLocation)(
            services,
      ...
      if (
        (0, util_1.isArrayMethodCallWithPredicate)(context, services, node) &&
        ...
        for (const type of returnTypes) {
          const { constraintType } = (0, util_1.getConstraintInfo)(
            checker,
            type,
          );
        ...
        const isOwnNullable = prevType.types.some((type) => {
          ...
          return indexInfo.some((info) => {
            const isStringTypeName =
              (0, util_1.getTypeName)(checker, info.keyType) === "string";
            return (
              isStringTypeName &&
              (isNoUncheckedIndexedAccess ||
