...
declare const baseRule: TSESLint.RuleModule<
  "preferDestructuring",
  [
    (
      | import("eslint/lib/rules/prefer-destructuring").DestructuringTypeConfig
      | {
    ...
    (import("eslint/lib/rules/prefer-destructuring").Option1 | undefined)?,
  ],
  unknown,
  {
