          ...
          if (
            ...
            !(
              ...
              tsutils.includesModifier(
                (0, util_1.getModifiers)(declaration.parent.parent),
    ...
    return {
      ...
      TSNonNullExpression(node) {
        const removeExclamationFix = (fixer) => {
          const exclamationToken = (0, util_1.nullThrows)(
        ...
        const constrainedType = (0, util_1.getConstrainedTypeAtLocation)(
          services,
          node.expression,
        );
        ...
        const constrainedTypeIsNullable = (0, util_1.isNullableType)(
          constrainedType,
        );
