 ...
 * ```
 */
export declare function doesImmediatelyReturnFunctionExpression({
  node,
  returns,
 ...
 */
export declare function isTypedFunctionExpression(
 ...
 */
export declare function isValidFunctionExpressionReturnType(
  node: FunctionExpression,
  options: Options,
): boolean;
/**
 ...
 */
export declare function checkFunctionReturnType(
 ...
 * Checks if a function declaration/expression has a return type.
 */
export declare function checkFunctionExpressionReturnType(
