...
export declare function arrayGroupByToMap<T, Key extends number | string>(
  array: T[],
  getKey: (item: T) => Key,
): Map<Key, T[]>;
/** Return true if both parameters are equal. */
export type Equal<T> = (a: T, b: T) => boolean;
export declare function arraysAreEqual<T>(
  a: T[] | undefined,
  b: T[] | undefined,
  eq: (a: T, b: T) => boolean,
): boolean;
/** Returns the first non-`undefined` result. */
export declare function findFirstResult<T, U>(
  inputs: T[],
 ...
 */
export declare function getNameFromIndexSignature(
 ...
 */
export declare function getNameFromMember(
  member:
...
export declare function getEnumNames<T extends string>(
...
export declare function typeNodeRequiresParentheses(
  node: TSESTree.TypeNode,
  text: string,
): boolean;
export declare function isRestParameterDeclaration(
  decl: ts.Declaration,
): boolean;
export declare function isParenlessArrowFunction(
 ...
 * ```
 */
export declare function getStaticMemberAccessValue(
  node: NodeWithKey,
 ...
 */
export declare const isStaticMemberAccessOfValue: (
