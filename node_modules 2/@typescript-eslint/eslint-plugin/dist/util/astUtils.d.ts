 ...
 */
export declare function getNameLocationInGlobalDirectiveComment(
  sourceCode: TSESLint.SourceCode,
  comment: TSESTree.Comment,
  name: string,
): TSESTree.SourceLocation;
export declare function forEachReturnStatement<T>(
  body: ts.Block,
 ...
 */
export declare function forEachChildESTree<Result>(
  node: TSESTree.Node,
