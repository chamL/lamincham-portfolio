...
((exports.applyDefault = utils_1.ESLintUtils.applyDefault),
  (exports.deepMerge = utils_1.ESLintUtils.deepMerge),
  (exports.getParserServices = utils_1.ESLintUtils.getParserServices),
  (exports.isObjectNotArray = utils_1.ESLintUtils.isObjectNotArray),
  (exports.nullThrows = utils_1.ESLintUtils.nullThrows),
  (exports.NullThrowsReasons = utils_1.ESLintUtils.NullThrowsReasons));
