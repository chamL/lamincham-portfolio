...
export declare type ExportNamedDeclarationWithoutSource =
  | ExportNamedDeclarationWithoutSourceWithMultiple
  | ExportNamedDeclarationWithoutSourceWithSingle;
/**
...
export declare type LeftHandSideExpression =
  ...
  | TSNonNullExpression
  | TSTypeAssertion;
export declare type LetOrConstOrVarDeclaration =
  | ConstDeclaration
...
export declare type LetOrConstOrVarDeclarator =
...
export declare type Parameter =
  ...
  | RestElement
  | TSParameterProperty;
declare type ParameterPropertyParameter =
  | (AssignmentPattern & {
      left: Identifier;
    })
  | Identifier;
...
declare interface UnaryExpressionSpecific<
  T extends string,
