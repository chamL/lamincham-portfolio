 ...
 */
export declare function getUrlFromPagesDirectories(
  urlPrefix: string,
  directories: string[],
): RegExp[];
export declare function getUrlFromAppDirectory(
  urlPrefix: string,
  directories: string[],
): RegExp[];
export declare function execOnce<TArgs extends any[], TResult>(
