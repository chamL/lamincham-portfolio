...
var ERROR_MSG_GOOGLE_ANALYTICS =
  "Prefer `GoogleAnalytics` component from `@next/third-parties/google` when using the inline script for Google Analytics. See: ".concat(
    url,
  );
var ERROR_MSG_GOOGLE_TAG_MANAGER =
  "Prefer `GoogleTagManager` component from `@next/third-parties/google` when using the inline script for Google Tag Manager. See: ".concat(
    url,
  );
  ...
  create: function create(context) {
    return {
      JSXOpeningElement: function JSXOpeningElement(node) {
        ...
        var dangerouslySetInnerHTML = attributes.value(
        ...
        if (dangerouslySetInnerHTML && dangerouslySetInnerHTML.length > 0) {
          ...
          var htmlContent =
            quasis === null || quasis === void 0
              ? void 0
              : (_quasis_ = quasis[0]) === null || _quasis_ === void 0
                ? void 0
                : (_quasis__value = _quasis_.value) === null ||
                    _quasis__value === void 0
                  ? void 0
                  : _quasis__value.raw;
