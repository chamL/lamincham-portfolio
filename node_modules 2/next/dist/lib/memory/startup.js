...
function enableMemoryDebuggingMode() {
  ...
  process.on("SIGUSR2", () => {
    (0, _log.warn)(
      `Received SIGUSR2 signal. Generating heap snapshot. ${(0, _picocolors.italic)("Note: this will take some time.")}`,
    );
  ...
  (0, _log.warn)(
    `Memory debugging mode is enabled. ${(0, _picocolors.italic)("Note: This will affect performance.")}`,
  );
  (0, _log.info)(
