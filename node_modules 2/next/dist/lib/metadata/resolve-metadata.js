 ...
 */ async function mergeMetadata(
  ...
  for (const key_ in metadata) {
    ...
    switch (key) {
      ...
      case "facebook":
        newResolvedMetadata.facebook = (0, _resolvebasics.resolveFacebook)(
          metadata.facebook,
        );
        break;
      case "verification":
      ...
      case "bookmarks":
      case "keywords": {
        newResolvedMetadata[key] = (0, _utils.resolveAsArrayOrUndefined)(
          metadata[key],
        );
        break;
      }
      ...
      case "itunes": {
        newResolvedMetadata[key] = await (0, _resolvebasics.resolveItunes)(
          metadata.itunes,
          metadataBase,
          pathname,
          metadataContext,
...
async function resolveMetadataItemsImpl(
  ...
  const optionalCatchAllParamName =
    ...
    (interpolatedParams[segmentParam.paramName] === null ||
      ...
      : parentOptionalCatchAllParamName;
  const params = (0, _params.createServerParamsForMetadata)(
    currentParams,
  ...
  if (typeof exportForResult === "function") {
    ...
    if (useCacheFunctionInfo && useCacheFunctionInfo.usedArgs[1]) {
      ...
      resolversAndResults.push(
        (0, _lazyresult.createLazyResult)(async () => exportForResult(promise)),
      );
    } else {
      let result;
