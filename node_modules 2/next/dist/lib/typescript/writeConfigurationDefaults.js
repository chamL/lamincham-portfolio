...
const _commentjson = /*#__PURE__*/ _interop_require_wildcard(
  require("next/dist/compiled/comment-json"),
);
const _semver = /*#__PURE__*/ _interop_require_default(
  require("next/dist/compiled/semver"),
);
...
function getDesiredCompilerOptions(typescriptVersion, userTsConfig) {
  ...
  return {
    ...
    ...(_semver.default.gte(typescriptVersion, "5.4.0") &&
    (userTsConfig == null
      ? void 0
      : (_userTsConfig_compilerOptions = userTsConfig.compilerOptions) == null
        ? void 0
        : (_userTsConfig_compilerOptions_module =
              _userTsConfig_compilerOptions.module) == null
          ? void 0
          : _userTsConfig_compilerOptions_module.toLowerCase()) ===
      moduleKindPreserve
      ? {}
      : {
          esModuleInterop: {
    ...
    ...((userTsConfig == null
      ? void 0
      : (_userTsConfig_compilerOptions1 = userTsConfig.compilerOptions) == null
        ? void 0
        : _userTsConfig_compilerOptions1.verbatimModuleSyntax) === true
      ? undefined
      : {
          isolatedModules: {
            value: true,
...
async function writeConfigurationDefaults(
  typescriptVersion,
  tsConfigPath,
  isFirstTimeSetup,
  hasAppDir,
  ...
  for (const optionKey in desiredCompilerOptions) {
    ...
    if ("suggested" in check) {
      if (
        !(
          optionKey in
          (userTsConfig == null ? void 0 : userTsConfig.compilerOptions)
        )
      ) {
        userTsConfig.compilerOptions[optionKey] = check.suggested;
        suggestedActions.push(
          (0, _picocolors.cyan)(optionKey) +
            " was set to " +
            (0, _picocolors.bold)(check.suggested) +
      ...
      let existingValue =
        userTsConfig == null
          ? void 0
          : (_userTsConfig_compilerOptions1 = userTsConfig.compilerOptions) ==
              null
            ? void 0
            : _userTsConfig_compilerOptions1[optionKey];
      ...
      if (shouldWriteRequiredValue()) {
        ...
        requiredActions.push(
          (0, _picocolors.cyan)(optionKey) +
            " was set to " +
            (0, _picocolors.bold)(check.value) +
            ` (${check.reason})`,
        );
      }
    } else {
  ...
  if (!("include" in userTsConfig)) {
    ...
    suggestedActions.push(
      (0, _picocolors.cyan)("include") +
        " was set to [" +
        (0, _picocolors.bold)(
          defaultInclude.map((type) => `'${type}'`).join(", "),
        ) +
        "]",
    );
  ...
  if (hasAppDir) {
    ...
    const plugins = [
      ...(Array.isArray(userTsConfig == null ? void 0 : userTsConfig.plugins)
        ? userTsConfig.plugins
        : []),
      ...(userTsConfig.compilerOptions &&
    ...
    if (
      ...
      suggestedActions.push(
        (0, _picocolors.cyan)("plugins") +
          " was updated to add " +
          (0, _picocolors.bold)(`{ name: 'next' }`),
      );
    }
    ...
    if (
      ...
      !(userTsConfig == null
        ? void 0
        : (_userTsConfig_compilerOptions2 = userTsConfig.compilerOptions) ==
            null
          ? void 0
          : _userTsConfig_compilerOptions2.strict) &&
      !(
        "strictNullChecks" in
        (userTsConfig == null ? void 0 : userTsConfig.compilerOptions)
      )
      ...
      suggestedActions.push(
        (0, _picocolors.cyan)("strictNullChecks") +
          " was set to " +
          (0, _picocolors.bold)(`true`),
      );
    }
  }
  if (!("exclude" in userTsConfig)) {
    ...
    suggestedActions.push(
      (0, _picocolors.cyan)("exclude") +
        " was set to " +
        (0, _picocolors.bold)(`['node_modules']`),
    );
  }
  ...
  (0, _fs.writeFileSync)(
    tsConfigPath,
    _commentjson.stringify(userTsConfig, null, 2) + _os.default.EOL,
  );
  _log.info("");
  if (isFirstTimeSetup) {
    _log.info(
      `We detected TypeScript in your project and created a ${(0, _picocolors.cyan)("tsconfig.json")} file for you.`,
    );
    return;
  }
  _log.info(
    `We detected TypeScript in your project and reconfigured your ${(0, _picocolors.cyan)("tsconfig.json")} file for you.${((_userTsConfig_compilerOptions = userTsConfig.compilerOptions) == null ? void 0 : _userTsConfig_compilerOptions.strict) ? "" : ` Strict-mode is set to ${(0, _picocolors.cyan)("false")} by default.`}`,
  );
  if (suggestedActions.length) {
    _log.info(
      `The following suggested values were added to your ${(0, _picocolors.cyan)("tsconfig.json")}. These values ${(0, _picocolors.cyan)("can be changed")} to fit your project's needs:\n`,
    );
  ...
  if (requiredActionsToBeLogged.length) {
    _log.info(
      `The following ${(0, _picocolors.white)("mandatory changes")} were made to your ${(0, _picocolors.cyan)("tsconfig.json")}:\n`,
    );
