  ...
  if (typeof message === "string" && diagnostic.code === 2322) {
    ...
    if (match) {
      ...
      const relatedMessage =
        (_diagnostic_relatedInformation = diagnostic.relatedInformation) == null
          ? void 0
          : (_diagnostic_relatedInformation_ =
                _diagnostic_relatedInformation[0]) == null
            ? void 0
            : _diagnostic_relatedInformation_.messageText;
      if (
...
function getAppEntrySourceFilePath(baseDir, diagnostic) {
  ...
  const sourceFilepath =
    ((_diagnostic_file = diagnostic.file) == null
      ? void 0
      : (_diagnostic_file_text_trim_match = _diagnostic_file.text
            .trim()
            .match(/^\/\/ File: (.+)\n/)) == null
        ? void 0
        : _diagnostic_file_text_trim_match[1]) || "";
...
function getFormattedDiagnostic(
  ...
  const isLayoutOrPageError =
    ...
    ((_diagnostic_file = diagnostic.file) == null
      ? void 0
      : _diagnostic_file.fileName.startsWith(
          _path.default.join(baseDir, distDir, "types"),
        ));
  let message = "";
  ...
  switch (category) {
    ...
    case ts.DiagnosticCategory.Warning: {
      message +=
        (0, _picocolors.yellow)((0, _picocolors.bold)("Type warning")) + ": ";
      break;
    }
    // Error
    case ts.DiagnosticCategory.Error: {
      message +=
        (0, _picocolors.red)((0, _picocolors.bold)("Type error")) + ": ";
      break;
    }
    ...
    case ts.DiagnosticCategory.Message:
      message +=
        (0, _picocolors.cyan)(
          (0, _picocolors.bold)(category === 2 ? "Suggestion" : "Info"),
        ) + ": ";
      break;
    default: {
      category;
  ...
  if (!isLayoutOrPageError && diagnostic.file) {
    ...
    let fileName = _path.default.posix.normalize(
      _path.default
        .relative(baseDir, diagnostic.file.fileName)
        .replace(/\\/g, "/"),
    );
    ...
    message =
      ...
      ":" +
      (0, _picocolors.yellow)(line.toString()) +
      ":" +
      (0, _picocolors.yellow)(character.toString()) +
      "\n" +
      message;
