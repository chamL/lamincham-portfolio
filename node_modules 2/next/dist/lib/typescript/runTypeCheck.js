...
async function runTypeCheck(
  ...
  const effectiveConfiguration = await (0,
  _getTypeScriptConfiguration.getTypeScriptConfiguration)(
    typescript,
    tsConfigPath,
  );
  ...
  const requiredConfig = (0,
  _writeConfigurationDefaults.getRequiredConfiguration)(typescript);
  const options = {
    ...requiredConfig,
    ...
    if (firstError) {
      const allErrors = allDiagnostics
        ...
        .map(
          (d) =>
            "[Test Mode] " +
            (0, _diagnosticFormatter.getFormattedDiagnostic)(
              typescript,
              baseDir,
              distDir,
              d,
  ...
  if (firstError) {
    throw Object.defineProperty(
      new _compileerror.CompileError(
        (0, _diagnosticFormatter.getFormattedDiagnostic)(
          typescript,
          baseDir,
          distDir,
