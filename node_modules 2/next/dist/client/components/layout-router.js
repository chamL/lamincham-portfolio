...
function OuterLayoutRouter({
  ...
  const segmentPath =
    parentSegmentPath === null // path. This has led to a bunch of special cases scattered throughout
  ...
  if (typeof window === "undefined" && process.env.__NEXT_CACHE_COMPONENTS) {
    ...
    } = require("./instant-validation/boundary");
    maybeValidationBoundaryId = (0, _react.use)(
      InstantValidationBoundaryContext,
    );
  }
  ...
  */ let segmentBoundaryTriggerNode = null;
    ...
    if (process.env.NODE_ENV !== "production") {
      ...
      } = require("../../next-devtools/userspace/app/segment-explorer-node");
    ...
    if (
      ...
      templateValue = /*#__PURE__*/ (0, _jsxruntime.jsx)(
        RenderValidationBoundaryAtThisLevel,
        {
