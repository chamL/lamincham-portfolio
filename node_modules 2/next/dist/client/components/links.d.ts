...
export declare function setLinkForCurrentNavigation(
  link: LinkInstance | null,
): void;
export declare function unmountLinkForCurrentNavigation(
  link: LinkInstance,
): void;
/**
...
export declare function mountLinkInstance(
  element: LinkElement,
  href: string,
  router: AppRouterInstance,
  fetchStrategy: PrefetchTaskFetchStrategy,
...
export declare function mountFormInstance(
...
export declare function onLinkVisibilityChanged(
  element: Element,
  isVisible: boolean,
): void;
export declare function onNavigationIntent(
  element: HTMLAnchorElement | SVGAElement,
  unstable_upgradeToDynamicPrefetch: boolean,
): void;
export declare function pingVisibleLinks(
  nextUrl: string | null,
