...
const _globalerror = /*#__PURE__*/ _interop_require_default._(
  require("../components/builtin/global-error"),
);
const devToolErrorMod =
  process.env.NODE_ENV !== "production"
    ? require("../../next-devtools/userspace/app/errors")
    : {
...
function onCaughtError(thrownValue, errorInfo) {
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    } = require("../../next-devtools/userspace/app/app-dev-overlay-error-boundary");
