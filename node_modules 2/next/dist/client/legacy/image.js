...
function defaultLoader({ config, src, width, quality }) {
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    if (src.startsWith("/") && config.localPatterns) {
      if (
        process.env.NODE_ENV !== "test" && // micromatch isn't compatible with edge runtime
...
function defaultImageLoader(loaderProps) {
  ...
  throw Object.defineProperty(
    new Error(
      `Unknown "loader" found in "next.config.js". Expected: ${_imageconfig.VALID_LOADERS.join(", ")}. Received: ${loaderKey}`,
    ),
    "__NEXT_ERROR_CODE",
    {
      value: "E1026",
