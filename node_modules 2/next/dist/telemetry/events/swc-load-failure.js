...
async function eventSwcLoadFailure(event) {
  ...
  try {
    ...
    // @ts-ignore
    glibcVersion =
      (_process_report = process.report) == null
        ? void 0
        : _process_report.getReport().header.glibcVersionRuntime;
  } catch {}
  try {
    const pkgNames = Object.keys(
      _packagejson.optionalDependencies || {},
  ...
  telemetry.record({
    ...
    payload: {
      ...
      nativeBindingsErrorCode:
        event == null ? void 0 : event.nativeBindingsErrorCode,
    },
  });
