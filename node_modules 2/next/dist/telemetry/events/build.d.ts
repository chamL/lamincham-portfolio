...
export declare function eventTypeCheckCompleted(
...
export declare function eventLintCheckCompleted(
...
export declare function eventBuildCompleted(
  pagePaths: string[],
  event: Omit<
    EventBuildCompleted,
...
export declare function eventBuildOptimize(
  pagePaths: string[],
  event: Omit<
    EventBuildOptimized,
...
export declare function eventBuildFeatureUsage(
  usages: ReturnType<TelemetryPlugin["usages"]>,
): Array<{
  eventName: string;
  payload: EventBuildFeatureUsage;
}>;
export declare const EVENT_NAME_PACKAGE_USED_IN_GET_SERVER_SIDE_PROPS =
  "NEXT_PACKAGE_USED_IN_GET_SERVER_SIDE_PROPS";
export type EventPackageUsedInGetServerSideProps = {
  package: string;
};
export declare function eventPackageUsedInGetServerSideProps(
...
export declare function eventMcpToolUsage(
  usages: Array<{
...
export declare function eventErrorThrown(
  error: Error,
