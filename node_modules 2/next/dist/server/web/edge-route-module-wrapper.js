...
class EdgeRouteModuleWrapper {
  ...
  async handler(request, evt) {
    ...
    const { nextConfig } = this.routeModule.getNextConfigEdge(
      new _web.WebNextRequest(request),
    );
    ...
    const { params } = utils.normalizeDynamicRouteParams(
      (0, _querystring.searchParamsToUrlQuery)(request.nextUrl.searchParams),
      false,
    );
    ...
    if (!res.body) {
      ...
      const trackedBody = (0, _webonclose.trackStreamConsumed)(res.body, () =>
