  ...
  if (!testApisIntercepted) {
    ...
    if (process.env.NEXT_PRIVATE_TEST_PROXY === "true") {
      const {
        interceptTestApis,
        wrapRequestHandler,
      } = require("next/dist/experimental/testmode/server-edge"); // eslint-disable-next-line @next/internal/typechecked-require -- experimental/testmode is not built ins next/dist/esm
      interceptTestApis();
...
async function adapter(params) {
  ...
  const requestURL = params.bypassNextUrl
    ...
    : new _nexturl.NextURL(params.request.url, {
  ...
  const requestHeaders = (0, _utils.fromNodeOutgoingHttpHeaders)(
  ...
  const request = new NextRequestHint({
    ...
    input: process.env.__NEXT_NO_MIDDLEWARE_URL_NORMALIZE
      ...
      : (0, _internalutils.stripInternalSearchParams)(normalizeURL).toString(),
    init: {
  ...
  const outerWaitUntil =
    ...
    _builtinrequestcontext.getBuiltinRequestContext)()) == null
      ? void 0
  ...
  response = await propagator(request, () => {
    ...
    if (isMiddleware) {
      ...
      return (0, _tracer.getTracer)().trace(
        _constants.MiddlewareSpan.execute,
        {
        ...
        async () => {
          try {
            ...
            _getedgepreviewprops.getEdgePreviewProps)();
            ...
            const requestStore = (0, _requeststore.createRequestStoreForAPI)(
              request,
              request.nextUrl,
              implicitTags,
              onUpdateCookies,
            ...
            const workStore = (0, _workstore.createWorkStore)({
              ...
              renderOpts: {
                cacheLifeProfiles:
                  (_params_request_nextConfig = params.request.nextConfig) ==
                  null
                    ? void 0
            ...
            return await _workasyncstorageexternal.workAsyncStorage.run(
              workStore,
              () =>
   ...
   */ const rewrite =
    response == null ? void 0 : response.headers.get("x-middleware-rewrite");
  if (response && rewrite && (isRSCRequest || !isEdgeRendering)) {
    ...
    _relativizeurl.parseRelativeURL)(
    ...
    if (isRSCRequest && (isRelative || isAllowedOrigin)) {
      ...
      if (requestURL.search !== destination.search) {
        response.headers.set(
          _approuterheaders.NEXT_REWRITTEN_QUERY_HEADER, // remove the leading ? from the search string
  ...
  if (response && redirect && !isEdgeRendering) {
    ...
    if (!process.env.__NEXT_NO_MIDDLEWARE_URL_NORMALIZE) {
      if (redirectURL.host === requestURL.host) {
        ...
        response.headers.set(
          "Location",
          (0, _relativizeurl.getRelativeURL)(redirectURL, requestURL),
        );
      }
    }
    /**
     ...
     */ if (isNextDataRequest) {
      ...
      response.headers.set(
        "x-nextjs-redirect",
        (0, _relativizeurl.getRelativeURL)(
  ...
  return {
    ...
    waitUntil:
      (0, _fetchevent.getWaitUntilPromiseFromEvent)(event) ?? Promise.resolve(),
