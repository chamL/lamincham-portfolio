...
export declare function chainStreams<T>(
  ...streams: ReadableStream<T>[]
): ReadableStream<T>;
export declare function streamFromString(
  str: string,
): ReadableStream<Uint8Array>;
export declare function streamFromBuffer(
  chunk: Buffer,
): ReadableStream<Uint8Array>;
export declare function streamToUint8Array(
...
export declare function createBufferedTransformStream(
  options?: BufferedTransformOptions,
): TransformStream<Uint8Array, Uint8Array>;
export declare function renderToInitialFizzStream({
  ReactDOMServer,
  element,
  streamOptions,
}: {
 ...
 */
export declare function createInstantTestScriptInsertionTransformStream(
  requestId: string | null,
): TransformStream<Uint8Array, Uint8Array>;
export declare function createRootLayoutValidatorStream(): TransformStream<
  Uint8Array,
  Uint8Array
>;
...
export declare function continueFizzStream(
...
export declare function continueDynamicPrerender(
...
export declare function continueStaticPrerender(
  prerenderStream: ReadableStream<Uint8Array>,
  {
    inlinedDataStream,
    getServerInsertedHTML,
...
export declare function continueStaticFallbackPrerender(
  prerenderStream: ReadableStream<Uint8Array>,
  {
    inlinedDataStream,
    getServerInsertedHTML,
 ...
 */
export declare function createRuntimePrefetchTransformStream(
  sentinel: number,
  isPartial: boolean,
  staleTime: number,
): TransformStream<Uint8Array, Uint8Array>;
