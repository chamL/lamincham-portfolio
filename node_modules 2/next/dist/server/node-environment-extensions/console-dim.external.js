...
const _nodeinspector = /*#__PURE__*/ _interop_require_wildcard(
...
function patchConsoleMethod(methodName) {
  ...
  if (
    ...
    const wrapperMethod = function (...args) {
      ...
      const consoleStore =
        _consoleasyncstorageexternal.consoleAsyncStorage.getStore();
      ...
      if (signal) {
        ...
        if (signal.aborted) {
          ...
          (consoleStore == null ? void 0 : consoleStore.dim) === true
        ) {
          return applyWithDimming.call(
            this,
            consoleStore,
...
function applyWithDimming(consoleStore, method, methodName, args) {
  if ((consoleStore == null ? void 0 : consoleStore.dim) === true) {
    ...
    return _consoleasyncstorageexternal.consoleAsyncStorage.run(
      DIMMED_STORE,
