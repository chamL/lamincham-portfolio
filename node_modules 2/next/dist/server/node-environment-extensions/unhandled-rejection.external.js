...
const warnUninstalledOnce = warn
  ? function warnUninstalledOnce(...args) {
    ...
    function (event, listener) {
      if (event === "unhandledRejection") {
        ...
        if (listener === filteringUnhandledRejectionHandler) {
          warnUninstalledOnce == null
            ? void 0
            : warnUninstalledOnce(`Uninstalling filter because \`process.removeListener('unhandledRejection', listener)\` was called with the filter listener. Uninstalling this filter is not recommended and will cause you to observe 'unhandledRejection' events related to intentionally aborted prerenders.
...
You can debug event listener operations by running Next.js with \`NEXT_UNHANDLED_REJECTION_FILTER=debug\` environment variable.`);
  ...
  if (originalProcessOn === originalProcessAddListener) {
    ...
    process.on = patchWithoutReentrancy(
      originalProcessOn,
      function (event, listener) {
        if (event === "unhandledRejection") {
          debugWithTrace == null
  ...
  if (originalProcessOff === originalProcessRemoveListener) {
    ...
    process.off = patchWithoutReentrancy(
      originalProcessOff,
      function (event, listener) {
        if (event === "unhandledRejection") {
          // Check if they're trying to remove our filtering handler
          if (listener === filteringUnhandledRejectionHandler) {
            warnUninstalledOnce == null
              ? void 0
              : warnUninstalledOnce(`Uninstalling filter because \`process.off('unhandledRejection', listener)\` was called with the filter listener. Uninstalling this filter is not recommended and will cause you to observe 'unhandledRejection' events related to intentionally aborted prerenders.
...
You can debug event listener operations by running Next.js with \`NEXT_UNHANDLED_REJECTION_FILTER=debug\` environment variable.`);
  ...
  process.removeAllListeners = patchWithoutReentrancy(
    ...
    function (event) {
      ...
      warnUninstalledOnce == null
        ? void 0
        : warnUninstalledOnce(`Uninstalling filter because \`process.removeAllListeners()\` was called. Uninstalling this filter is not recommended and will cause you to observe 'unhandledRejection' events related to intentionally aborted prerenders.
