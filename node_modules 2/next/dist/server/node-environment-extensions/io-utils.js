  ...
  switch (workUnitStore.type) {
    ...
    case "prerender-runtime": {
      ...
      if (prerenderSignal.aborted === false) {
        ...
        (0, _dynamicrendering.abortOnSynchronousPlatformIOAccess)(
          workStore.route,
          expression,
          applyOwnerStack(
    ...
    case "request": {
      ...
      if (stageController && stageController.shouldTrackSyncInterrupt()) {
        ...
        const syncIOError = applyOwnerStack(
          Object.defineProperty(new Error(message), "__NEXT_ERROR_CODE", {
            value: "E394",
            enumerable: false,
            configurable: true,
...
function applyOwnerStack(error) {
  ...
  if (process.env.NODE_ENV !== "production") {
    var _getClientReact_captureOwnerStack,
      ...
      _getServerReact;
    const ownerStack =
      ((_getClientReact = (0, _runtimereactsexternal.getClientReact)()) == null
        ? void 0
      ...
      ((_getServerReact = (0, _runtimereactsexternal.getServerReact)()) == null
        ? void 0
        : (_getServerReact_captureOwnerStack =
