...
export declare function getSource(
  fileName: string,
): tsModule.SourceFile | undefined;
export declare function removeStringQuotes(str: string): string;
export declare const isPositionInsideNode: (
  position: number,
  node: tsModule.Node,
) => boolean;
export declare const isDefaultFunctionExport: (
  node: tsModule.Node,
...
export declare function getEntryInfo(
  fileName: string,
