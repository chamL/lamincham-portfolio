...
const _config = /*#__PURE__*/ _interop_require_default(
  require("./rules/config"),
);
const _server = /*#__PURE__*/ _interop_require_default(
  require("./rules/server"),
);
const _entry = /*#__PURE__*/ _interop_require_default(require("./rules/entry"));
const _clientboundary = /*#__PURE__*/ _interop_require_default(
  require("./rules/client-boundary"),
);
const _serverboundary = /*#__PURE__*/ _interop_require_default(
  require("./rules/server-boundary"),
);
const _metadata = /*#__PURE__*/ _interop_require_default(
  ...
  function create(info) {
    ...
    proxy.getCompletionsAtPosition = (fileName, position, options) => {
      ...
      if (!entryInfo.client) {
        ...
        prior.entries = _server.default.filterCompletionsAtPosition(
          prior.entries,
        );
      }
      ...
      ts.forEachChild(source, (node) => {
        ...
        if (
          (0, _utils.isPositionInsideNode)(position, node) &&
          (0, _utils.isDefaultFunctionExport)(node)
        ) {
          prior.entries.push(
            ..._entry.default.getCompletionsAtPosition(
              fileName,
              node,
              position,
            ),
    ...
    proxy.getCompletionEntryDetails = (
      ...
      const entryCompletionEntryDetails =
        _config.default.getCompletionEntryDetails(entryName, data, fileName);
    ...
    proxy.getQuickInfoAtPosition = (fileName, position) => {
      ...
      if (!entryInfo.client) {
        ...
        if (
          definitions &&
          _server.default.hasDisallowedReactAPIDefinition(definitions)
        ) {
          return;
        }
      }
      const overridden = _config.default.getQuickInfoAtPosition(
        fileName,
        position,
      );
    ...
    proxy.getSemanticDiagnostics = (fileName) => {
      ...
      if ((0, _utils.isInsideApp)(fileName)) {
        const errorDiagnostic = _error.default.getSemanticDiagnostics(
          source,
          isClientEntry,
        );
        ...
        if (ts.isImportDeclaration(node)) {
          ...
          if (isAppEntry) {
            if (!isClientEntry || isServerEntry) {
              ...
              const diagnostics =
                _server.default.getSemanticDiagnosticsForImportDeclaration(
                  source,
                  node,
                );
          ...
          ((_node_modifiers = node.modifiers) == null
            ? void 0
            : _node_modifiers.some(
          ...
          if (isAppEntry) {
            ...
            const diagnostics =
              _config.default.getSemanticDiagnosticsForExportVariableStatement(
                source,
                node,
              );
            const metadataDiagnostics = isClientEntry
              ? _metadata.default.client.getSemanticDiagnosticsForExportVariableStatement(
                  fileName,
                  node,
                )
              : _metadata.default.server.getSemanticDiagnosticsForExportVariableStatement(
                  fileName,
                  node,
                );
          ...
          if (isClientEntry) {
            prior.push(
              ..._clientboundary.default.getSemanticDiagnosticsForExportVariableStatement(
                source,
                node,
              ),
            );
          ...
          if (isServerEntry) {
            prior.push(
              ..._serverboundary.default.getSemanticDiagnosticsForExportVariableStatement(
                source,
                node,
              ),
            );
          ...
          if (isAppEntry) {
            const diagnostics = _entry.default.getSemanticDiagnostics(
              fileName,
              source,
              node,
            );
          ...
          if (isClientEntry) {
            prior.push(
              ..._clientboundary.default.getSemanticDiagnosticsForFunctionExport(
                source,
                node,
              ),
            );
          ...
          if (isServerEntry) {
            prior.push(
              ..._serverboundary.default.getSemanticDiagnosticsForFunctionExport(
                source,
                node,
              ),
            );
          ...
          ((_node_modifiers1 = node.modifiers) == null
            ? void 0
            : _node_modifiers1.some(
                (m) => m.kind === ts.SyntaxKind.ExportKeyword,
              ))
        ) {
          // export function ...
          ...
          if (isAppEntry) {
            const metadataDiagnostics = isClientEntry
              ? _metadata.default.client.getSemanticDiagnosticsForExportDeclaration(
                  fileName,
                  node,
                )
              : _metadata.default.server.getSemanticDiagnosticsForExportDeclaration(
                  fileName,
                  node,
                );
            prior.push(...metadataDiagnostics);
          ...
          if (isServerEntry) {
            prior.push(
              ..._serverboundary.default.getSemanticDiagnosticsForExportDeclaration(
                source,
                node,
              ),
            );
