  ...
  if (workStore) {
    if (
      ...
      throw Object.defineProperty(
        new Error( // TODO(after): clarify that this only applies to pages?
    ...
    if (workUnitStore) {
      switch (workUnitStore.type) {
        ...
        case "request":
          ...
          if (
            (0, _requestcookies.areCookiesMutableInCurrentPhase)(workUnitStore)
          ) {
          ...
          if (process.env.NODE_ENV === "development") {
            ...
            const early = (0,
            _workunitasyncstorageexternal.isInEarlyRenderStage)(workUnitStore);
...
function makeUntrackedCookiesWithDevWarnings(
  ...
  if (requestStore.asyncApiPromises) {
    const early = (0, _workunitasyncstorageexternal.isInEarlyRenderStage)(
      requestStore,
    );
    let promise;
