...
const _datauritobuffer = /*#__PURE__*/ _interop_require_default(
...
async function getSourceMapFromFile(filename) {
  filename = filename.startsWith("file://")
    ? _url.default.fileURLToPath(filename)
    : filename;
  let fileContents;
  try {
    ...
    throw Object.defineProperty(
      new Error(`Failed to read file contents of ${filename}.`, {
        cause: error,
      }),
      "__NEXT_ERROR_CODE",
      {
  ...
  if (sourceUrl.startsWith("data:")) {
    ...
    try {
      ...
      throw Object.defineProperty(
        new Error(`Failed to parse source map URL for ${filename}.`, {
          cause: error,
        }),
        "__NEXT_ERROR_CODE",
        {
    ...
    try {
      ...
      throw Object.defineProperty(
        new Error(`Failed to parse source map for ${filename}.`, {
          cause: error,
        }),
        "__NEXT_ERROR_CODE",
        {
  ...
  const sourceMapFilename = _path.default.resolve(
    _path.default.dirname(filename),
    decodeURIComponent(sourceUrl),
  );
  try {
    const sourceMapContents = await _promises.default.readFile(
      sourceMapFilename,
      "utf-8",
    );
    ...
    throw Object.defineProperty(
      new Error(`Failed to parse source map ${sourceMapFilename}.`, {
        cause: error,
      }),
      "__NEXT_ERROR_CODE",
      {
