...
async function loadStaticPaths({
  ...
  if (isAppPath) {
    ...
    const segments = await (0, _appsegments.collectSegments)(
    ...
    const isRoutePPREnabled =
      (0, _checks.isAppPageRouteModule)(routeModule) &&
      (0, _ppr.checkIsRoutePPREnabled)(config.pprConfig);
    const rootParamKeys = (0, _collectrootparamkeys.collectRootParamKeys)(
      routeModule,
    );
