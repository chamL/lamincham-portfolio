...
export declare function processTopLevelIssues(
...
export declare function handleRouteType({
  dev,
  page,
  pathname,
  route,
...
export declare function hasEntrypointForKey(
  entrypoints: Entrypoints,
  key: EntryKey,
...
export declare function handleEntrypoints({
  entrypoints,
  currentEntrypoints,
  currentEntryIssues,
  manifestLoader,
...
export declare function handlePagesErrorRoute({
  currentEntryIssues,
  entrypoints,
  manifestLoader,
  devRewrites,
...
export declare function normalizedPageToTurbopackStructureRoute(
  route: string,
  ext: string | false,
): string;
