...
const FAST_REFRESH_RUNTIME_RELOAD =
...
function createBinaryHmrMessageData(message) {
  switch (message.type) {
    case _hotreloadertypes.HMR_MESSAGE_SENT_TO_BROWSER
      ...
      view.setUint8(
        0,
        _hotreloadertypes.HMR_MESSAGE_SENT_TO_BROWSER.ERRORS_TO_SHOW_IN_BROWSER,
      );
    ...
    case _hotreloadertypes.HMR_MESSAGE_SENT_TO_BROWSER.REACT_DEBUG_CHUNK: {
      ...
      view.setUint8(
        0,
        _hotreloadertypes.HMR_MESSAGE_SENT_TO_BROWSER.REACT_DEBUG_CHUNK,
      );
