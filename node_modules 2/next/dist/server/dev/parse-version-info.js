...
const _semver = /*#__PURE__*/ _interop_require_wildcard(
...
function parseVersionInfo(o) {
  ...
  if (installedParsed && latest && canary) {
    if (installedParsed.major < latest.major) {
      ...
      _semver.lt(installedParsed, canary)
    ) {
      ...
      _semver.lt(installedParsed, latest)
    ) {
      ...
      _semver.gt(installedParsed, latest) &&
  ...
  return {
    installed:
      (installedParsed == null ? void 0 : installedParsed.raw) ?? "0.0.0",
    staleness: "unknown",
  };
}
