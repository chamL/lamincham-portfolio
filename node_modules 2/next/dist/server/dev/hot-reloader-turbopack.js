    ...
    try {
      ...
      for await (const data of serverHmrChunkPaths) {
        ...
        for (const chunkPath of chunkPathsToRemove) {
          ...
          subscription == null
            ? void 0
            : (_subscription_return = subscription.return) == null
              ? void 0
              : _subscription_return.call(subscription);
          serverHmrSubscriptions.delete(chunkPath);
        }
      ...
      console.error(
        "[Server HMR Setup] Error in chunk path subscription:",
        err,
      );
    }
  })();
 ...
 */ function rewriteTurbopackSources(projectRoot, sourceMap) {
  if ("sections" in sourceMap) {
    ...
    for (let i = 0; i < sourceMap.sources.length; i++) {
      sourceMap.sources[i] = (0, _url.pathToFileURL)(
        (0, _path.join)(
          projectRoot,
...
async function createHotReloaderTurbopack(
  ...
  var _opts_nextConfig_turbopack,
    _nextConfig_watchOptions,
    _opts_nextConfig_experimental;
  const dev = true;
  ...
  const encryptionKey = await (0,
  _encryptionutilsserver.generateEncryptionKeyBase64)({
    isBuild: false,
    distDir,
  });
  // TODO: Implement
  ...
  const supportedBrowsers = (0, _getsupportedbrowsers.getSupportedBrowsers)(
    projectPath,
    dev,
  );
  const currentNodeJsVersion = process.versions.node;
  const rootPath =
    ((_opts_nextConfig_turbopack = opts.nextConfig.turbopack) == null
      ? void 0
      : _opts_nextConfig_turbopack.root) ||
    opts.nextConfig.outputFileTracingRoot ||
    projectPath;
  const project = await bindings.turbo.createProject(
    {
      rootPath,
      projectPath: (0, _normalizepath.normalizePath)(
        (0, _path.relative)(rootPath, projectPath) || ".",
      ),
      distDir,
      ...
      watch: {
        enable: dev,
        pollIntervalMs:
          (_nextConfig_watchOptions = nextConfig.watchOptions) == null
            ? void 0
            : _nextConfig_watchOptions.pollIntervalMs,
      },
      dev,
      env: process.env,
      ...
      isPersistentCachingEnabled: (0, _utils2.isFileSystemCacheEnabledForDev)(
        opts.nextConfig,
      ),
      nextVersion: "16.2.1",
    ...
    {
      memoryLimit:
        (_opts_nextConfig_experimental = opts.nextConfig.experimental) == null
          ? void 0
          : _opts_nextConfig_experimental.turbopackMemoryLimit,
  ...
  (0, _patcherrorinspect.setBundlerFindSourceMapImplementation)(
  ...
  opts.onDevServerCleanup == null
    ? void 0
    : opts.onDevServerCleanup.call(opts, async () => {
        (0, _patcherrorinspect.setBundlerFindSourceMapImplementation)(
          () => undefined,
        );
  ...
  function clearRequireCache(key, writtenEndpoint, { force } = {}) {
    ...
    const serverPaths = writtenEndpoint.serverPaths.map(({ path: p }) =>
      (0, _path.join)(distDir, p),
    );
    const { type: entryType, page: entryPage } = (0, _entrykey.splitEntryKey)(
      key,
    );
    const isAppPage =
      entryType === "app" &&
      ((_currentEntrypoints_app_get = currentEntrypoints.app.get(entryPage)) ==
      null
        ? void 0
        : _currentEntrypoints_app_get.type) === "app-page";
  ...
  function sendToClient(client, message) {
    const data =
      typeof message.type === "number"
        ? (0, _messages.createBinaryHmrMessageData)(message)
  ...
  const sendEnqueuedMessagesDebounce = (0, _utils1.debounce)(
  ...
  const sendHmr = (id, message) => {
    for (const client of [
      ...
      (_clientStates_get = clientStates.get(client)) == null
        ? void 0
        : _clientStates_get.messages.set(id, message);
    }
  ...
  function sendTurbopackMessage(payload) {
    ...
    for (const client of [
      ...
      (_clientStates_get = clientStates.get(client)) == null
        ? void 0
        : _clientStates_get.turbopackUpdates.push(payload);
    }
    hmrEventHappened = true;
    sendEnqueuedMessagesDebounce();
  }
  ...
  async function unsubscribeFromClientChanges(key) {
    ...
    if (subscription) {
      await (subscription.return == null
        ? void 0
        : subscription.return.call(subscription));
      changeSubscriptions.delete(key);
    }
  ...
  async function subscribeToClientHmrEvents(client, id) {
    ...
    if (
      !(0, _turbopackutils.hasEntrypointForKey)(
        currentEntrypoints,
        key,
        assetMapper,
      )
  ...
  async function handleEntrypointsSubscription() {
    for await (const entrypoints of entrypointsSubscription) {
      ...
      (0, _turbopackutils.processTopLevelIssues)(
      ...
      await (0, _turbopackutils.handleEntrypoints)({
        ...
        dev: {
          ...
          hooks: {
            ...
            propagateServerField: _setupdevbundler.propagateServerField.bind(
              null,
              opts,
            ),
            sendHmr,
      ...
      await (0, _setupdevbundler.propagateServerField)(
        opts,
        "reloadMatchers",
        undefined,
      );
  ...
  await (0, _promises.writeFile)(
    (0, _path.join)(distDir, "package.json"),
    JSON.stringify(
      {
        type: "commonjs",
      },
  ...
  const hotReloader = {
    ...
    async run(req, res, _parsedUrl) {
      ...
      if (
        (_req_url = req.url) == null
          ? void 0
          : _req_url.startsWith("/_next/static/chunks/pages/")
      ) {
        ...
        if (params) {
          ...
          _denormalizepagepath.denormalizePagePath)(decodedPagePath);
          await hotReloader
            .ensurePage({
    ...
    onHMR(req, socket, head, onUpgrade) {
      wsServer.handleUpgrade(req, socket, head, (client) => {
        ...
        client.addEventListener("message", async ({ data }) => {
          ...
          switch (parsedData.event) {
            case "span-end": {
              hotReloaderSpan.manualTraceChild(
                parsedData.spanName,
                (0, _turbopackutils.msToNs)(parsedData.startTime),
                (0, _turbopackutils.msToNs)(parsedData.endTime),
            ...
            case "mcp-error-state-response": {
              (0, _geterrors.handleErrorStateResponse)(
            ...
            case "mcp-page-metadata-response": {
              (0, _getpagemetadata.handlePageMetadataResponse)(
                parsedData.requestId,
            ...
            default:
              ...
              if (!parsedData.type) {
                throw Object.defineProperty(
                  new Error(`unrecognized HMR message "${data}"`),
                  "__NEXT_ERROR_CODE",
                  {
                    value: "E155",
                    enumerable: false,
          ...
          switch (parsedData.type) {
            ...
            default:
              if (!parsedData.event) {
                throw Object.defineProperty(
                  new Error(`unrecognized Turbopack HMR message "${data}"`),
                  "__NEXT_ERROR_CODE",
                  {
                    value: "E492",
                    enumerable: false,
        ...
        (async function () {
          ...
          const devToolsConfig = await (0,
          _devtoolsconfigmiddleware.getDevToolsConfig)(distDir);
          const syncMessage = {
        ...
        if (issue.severity !== "warning") {
          errors.push(
            Object.defineProperty(
              new Error((0, _utils2.formatIssue)(issue)),
              "__NEXT_ERROR_CODE",
              {
                value: "E394",
                enumerable: false,
    ...
    async ensurePage({
      page: inputPage, // Unused parameters
      // clientOnly,
      appPaths,
      definition,
      isApp,
      ...
      return hotReloaderSpan
        ...
        .traceAsyncFn(async () => {
          if (
            _constants.BLOCKED_PAGES.includes(inputPage) &&
            inputPage !== "/_error"
          ) {
            return;
          }
          ...
          let routeDef =
            definition ??
            (await (0, _ondemandentryhandler.findPagePathData)(
              projectPath,
              inputPage,
          ...
          if (appPaths) {
            ...
            const matchingAppPaths = appPaths.filter(
              (path) =>
                (0, _apppaths.normalizeAppPath)(path) === normalizedPage,
            );
            // the last item in the array is the root page, if there are parallel routes
            page = matchingAppPaths[matchingAppPaths.length - 1];
          }
          const pathname =
            (definition == null ? void 0 : definition.pathname) ?? inputPage;
          if (page === "/_error") {
          ...
          const isEntryMetadataRouteFile = (0,
          ...
          const normalizedAppPage = isEntryMetadataRouteFile
            ? (0, _turbopackutils.normalizedPageToTurbopackStructureRoute)(
                page,
                (0, _path.extname)(routeDef.filename),
              )
            : page;
          ...
          if (isApp && route.type === "page") {
            throw Object.defineProperty(
              new Error(`mis-matched route type: isApp && page for ${page}`),
              "__NEXT_ERROR_CODE",
              {
                value: "E373",
                enumerable: false,
            ...
            for (const [key, issue] of issueMap) {
              ...
              errorsMap.set(key, {
                ...
                details: issue.detail
                  ? (0, _utils2.renderStyledStringToErrorAnsi)(issue.detail)
                  : undefined,
              });
            }
          }
