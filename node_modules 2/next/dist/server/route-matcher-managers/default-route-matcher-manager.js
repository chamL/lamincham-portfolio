...
class DefaultRouteMatcherManager {
  ...
  async reload() {
    ...
    try {
      ...
      const providersMatchers = await Promise.all(
      ...
      for (const pathname of sorted) {
        ...
        if (!Array.isArray(indexes)) {
          throw Object.defineProperty(
            new Error("Invariant: expected to find identity in indexes map"),
            "__NEXT_ERROR_CODE",
            {
              value: "E271",
              enumerable: false,
   ...
   */ validate(pathname, matcher, options) {
    ...
    if (
      (_options_i18n = options.i18n) == null
        ? void 0
        : _options_i18n.inferredFromDefault
    ) {
