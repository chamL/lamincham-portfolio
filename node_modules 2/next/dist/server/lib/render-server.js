...
function clearAllModuleContexts() {
  return sandboxContext == null
    ? void 0
    : sandboxContext.clearAllModuleContexts();
}
...
async function getServerField(dir, field) {
  ...
  if (!initialization) {
    throw Object.defineProperty(
      new Error("Invariant cant propagate server field, no app initialized"),
      "__NEXT_ERROR_CODE",
      {
        value: "E116",
        enumerable: false,
...
async function initializeImpl(opts) {
  ...
  if (
    ...
    const createOnCacheEntryHandlers = (0, _interopdefault.interopDefault)(
      await import(
        (0, _formatdynamicimportpath.formatDynamicImportPath)(
          opts.dir,
          process.env.NEXT_PRIVATE_DEBUG_CACHE_ENTRY_HANDLERS,
        )
      ),
  ...
  return {
    ...
    closeUpgraded() {
      ...
      (_opts_bundlerService = opts.bundlerService) == null
        ? void 0
        : _opts_bundlerService.close();
    },
