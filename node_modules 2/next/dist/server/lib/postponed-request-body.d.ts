...
export declare function getMaxPostponedStateSize(
  configuredMaxPostponedStateSize: SizeLimit | undefined,
): {
  maxPostponedStateSize: SizeLimit;
  maxPostponedStateSizeBytes: number;
};
export declare function getPostponedStateExceededErrorMessage(
  maxPostponedStateSize: SizeLimit,
): string;
export declare function readBodyWithSizeLimit(
