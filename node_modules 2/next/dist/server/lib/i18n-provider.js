...
class I18NProvider {
  constructor(config) {
    ...
    if (!config.locales.length) {
      throw Object.defineProperty(
        new Error("Invariant: No locales provided"),
        "__NEXT_ERROR_CODE",
        {
          value: "E510",
          enumerable: false,
    ...
    this.lowerCaseLocales = config.locales.map((locale) =>
      locale.toLowerCase(),
    );
    this.lowerCaseDomains =
      (_config_domains = config.domains) == null
        ? void 0
        : _config_domains.map((domainLocale) => {
            ...
            return {
              ...
              domain,
              locales:
                (_domainLocale_locales = domainLocale.locales) == null
                  ? void 0
                  : _domainLocale_locales.map((locale) => locale.toLowerCase()),
   ...
   */ detectDomainLocale(hostname, detectedLocale) {
    ...
    for (let i = 0; i < this.lowerCaseDomains.length; i++) {
      ...
      if (
        ...
        ((_domainLocale_locales = domainLocale.locales) == null
          ? void 0
          : _domainLocale_locales.some((locale) => locale === detectedLocale))
      ) {
   ...
   */ fromRequest(req, pathname) {
    ...
    return {
      ...
      detectedLocale,
      inferredFromDefault:
        (0, _requestmeta.getRequestMeta)(req, "localeInferredFromDefault") ??
        false,
    };
  }
  /**
