...
const _debug = /*#__PURE__*/ _interop_require_default(
  require("next/dist/compiled/debug"),
);
...
const _compression = /*#__PURE__*/ _interop_require_default(
...
const isNextFont = (pathname) =>
  pathname && /\/media\/[^/]+\.(woff|woff2|eot|ttf|otf)$/.test(pathname);
const requestHandlers = {};
async function initialize(opts) {
  var _development_bundler,
    _development_service,
    _development_service1,
    _development_service2,
    _development_service3,
    _development_service4,
    _development_bundler1;
  ...
  const config = await (0, _config.default)(
    opts.dev
      ? _constants.PHASE_DEVELOPMENT_SERVER
  ...
  if (opts.dev) {
    ...
    let devBundlerService = new _devbundlerservice.DevBundlerService(
      developmentBundler, // The request handler is assigned below, this allows us to create a lazy
      // reference to it.
      (req, res) => {
  ...
  const requestHandlerImpl = async (req, res) => {
    ...
    if (
      ...
      if (config.basePath) {
        urlNoQuery = (0, _removepathprefix.removePathPrefix)(
          urlNoQuery,
          config.basePath,
        );
      }
      ...
      const domainLocale = (0, _detectdomainlocale.detectDomainLocale)(
        config.i18n.domains,
      ...
      const defaultLocale =
        (domainLocale == null ? void 0 : domainLocale.defaultLocale) ||
        config.i18n.defaultLocale;
      const {
        getLocaleRedirect,
      } = require("../../shared/lib/i18n/get-locale-redirect");
      const parsedUrl = (0, _parseurl.parseUrl)(
        (_this = req.url || "") == null ? void 0 : _this.replace(/^\/+/, "/"),
      );
    ...
    async function invokeRender(
      ...
      if (
        config.i18n &&
        (0, _removepathprefix.removePathPrefix)(
          invokePath,
          config.basePath,
        ).startsWith(`/${(0, _requestmeta.getRequestMeta)(req, "locale")}/api`)
      ) {
        invokePath = fsChecker.handleLocale(
          (0, _removepathprefix.removePathPrefix)(invokePath, config.basePath),
        ).pathname;
      }
      if (
        req.headers["x-nextjs-data"] &&
        ((_fsChecker_getMiddlewareMatchers =
          fsChecker.getMiddlewareMatchers()) == null
          ? void 0
          : _fsChecker_getMiddlewareMatchers.length) &&
        (0, _removepathprefix.removePathPrefix)(invokePath, config.basePath) ===
          "/404"
      ) {
      ...
      if (!handlers) {
        throw Object.defineProperty(
          new Error("Failed to initialize render server"),
          "__NEXT_ERROR_CODE",
          {
            value: "E90",
            enumerable: false,
      ...
      try {
        ...
        const initResult = await (renderServer == null
          ? void 0
          : (_renderServer_instance = renderServer.instance) == null
            ? void 0
            : _renderServer_instance.initialize(renderServerOpts));
        try {
          await (initResult == null
            ? void 0
            : initResult.requestHandler(req, res));
        } catch (err) {
    ...
    const handleRequest = async (handleIndex) => {
      ...
      if (handleIndex > 5) {
        throw Object.defineProperty(
          new Error(`Attempted to handle request too many times ${req.url}`),
          "__NEXT_ERROR_CODE",
          {
            value: "E283",
            enumerable: false,
      ...
      if (development) {
        if (
          (0, _blockcrosssitedev.blockCrossSiteDEV)(
            req,
            res,
        ...
        if (
          config.basePath &&
          (0, _pathhasprefix.pathHasPrefix)(origUrl, config.basePath)
        ) {
          req.url = (0, _removepathprefix.removePathPrefix)(
            origUrl,
            config.basePath,
          );
        } else if (
          config.assetPrefix &&
          (0, _pathhasprefix.pathHasPrefix)(origUrl, config.assetPrefix)
        ) {
          req.url = (0, _removepathprefix.removePathPrefix)(
            origUrl,
            config.assetPrefix,
      ...
      if (
        development &&
        (matchedOutput == null ? void 0 : matchedOutput.type) ===
          "devVirtualFsItem"
      ) {
        const origUrl = req.url || "/";
        if (
      ...
      if (finished && parsedUrl.protocol) {
        var _getRequestMeta;
        return await (0, _proxyrequest.proxyRequest)(
          req,
          res,
          parsedUrl,
          undefined,
          (_getRequestMeta = (0, _requestmeta.getRequestMeta)(
            req,
            "clonableBody",
          )) == null
            ? void 0
            : _getRequestMeta.cloneBodyStream(),
          config.experimental.proxyTimeout,
        );
      }
      if (
        (matchedOutput == null ? void 0 : matchedOutput.fsPath) &&
        ...
        if (
          ...
          await invokeRender(parsedUrl, "/_error", handleIndex, {
            invokeStatus: 500,
            invokeError: Object.defineProperty(
              new Error(message),
              "__NEXT_ERROR_CODE",
              {
                value: "E212",
        ...
        try {
          return await (0, _servestatic.serveStatic)(
            req,
            res,
            matchedOutput.itemPath,
            {
          ...
          if (typeof err.statusCode === "number") {
            ...
            return await invokeRender(
              (0, _parseurl.parseUrl)(invokePath),
              invokePath,
              handleIndex,
              {
                invokeStatus,
      ...
      if (
        development &&
        (0, _chromedevtoolsworkspace.isChromeDevtoolsWorkspaceUrl)(req.url)
      ) {
        await (0,
        _chromedevtoolsworkspace.handleChromeDevtoolsWorkspaceRequest)(
          res,
          opts,
          config,
        );
      ...
      if (realRequestPathname) {
        if (config.basePath) {
          realRequestPathname = (0, _removepathprefix.removePathPrefix)(
            realRequestPathname,
            config.basePath,
          );
        }
        ...
        if (config.i18n) {
          realRequestPathname = (0, _removepathprefix.removePathPrefix)(
            realRequestPathname,
            "/" + ((0, _requestmeta.getRequestMeta)(req, "locale") ?? ""),
          );
        }
      }
      ...
      const appNotFound = opts.dev
        ? development == null
          ? void 0
          : (_development_bundler = development.bundler) == null
            ? void 0
            : _development_bundler.serverFields.hasAppNotFound
        : await fsChecker.getItem(_constants.UNDERSCORE_NOT_FOUND_ROUTE);
      res.statusCode = 404;
      if (appNotFound) {
        return await invokeRender(
          parsedUrl,
          _constants.UNDERSCORE_NOT_FOUND_ROUTE,
          handleIndex,
          {
            invokeStatus: 404,
          },
  ...
  if (config.experimental.testProxy) {
    ...
    const {
      ...
      interceptTestApis,
    } = require("next/dist/experimental/testmode/server"); // eslint-disable-next-line @next/internal/typechecked-require -- experimental/testmode is not built ins next/dist/esm
  ...
  const renderServerOpts = {
    ...
    serverFields: {
      ...((development == null
        ...
        : (_development_bundler = development.bundler) == null
          ? void 0
          : _development_bundler.serverFields) || {}),
      setIsrStatus:
        development == null
          ? void 0
          : (_development_service = development.service) == null
            ? void 0
            : _development_service.setIsrStatus.bind(
                development == null ? void 0 : development.service,
              ),
    },
  ...
  if (
    !_routerservercontext.routerServerGlobal[
      _routerservercontext.RouterServerContextSymbol
    ]
  ) {
    _routerservercontext.routerServerGlobal[
      _routerservercontext.RouterServerContextSymbol
  ...
  _routerservercontext.routerServerGlobal[
    ...
    logErrorWithOriginalStack: opts.dev
      ...
      : (err) => !opts.quiet && _log.error(err),
    setCacheStatus: config.cacheComponents
      ? development == null
        ? void 0
        : (_development_service1 = development.service) == null
          ? void 0
          : _development_service1.setCacheStatus.bind(
              development == null ? void 0 : development.service,
            )
      : undefined,
    setIsrStatus:
      development == null
        ? void 0
        : (_development_service2 = development.service) == null
          ? void 0
          : _development_service2.setIsrStatus.bind(
              development == null ? void 0 : development.service,
            ),
    setReactDebugChannel: (
      development == null
        ? void 0
        : development.config.experimental.reactDebugChannel
    )
      ? development == null
        ? void 0
        : (_development_service3 = development.service) == null
          ? void 0
          : _development_service3.setReactDebugChannel.bind(
              development == null ? void 0 : development.service,
            )
      : undefined,
    sendErrorsToBrowser:
      development == null
        ? void 0
        : (_development_service4 = development.service) == null
          ? void 0
          : _development_service4.sendErrorsToBrowser.bind(
              development == null ? void 0 : development.service,
            ),
  };
  ...
  const resolveRoutes = (0, _resolveroutes.getResolveRoutes)(
    ...
    development == null
      ? void 0
      : (_development_bundler1 = development.bundler) == null
        ? void 0
        : _development_bundler1.ensureMiddleware,
  );
  const upgradeHandler = async (req, socket, head) => {
    try {
      ...
      if (opts.dev && development && req.url) {
        ...
        if (assetPrefix) {
          hmrPrefix = (0, _normalizedassetprefix.normalizedAssetPrefix)(
            assetPrefix,
          );
                ...
                client.send(
                  JSON.stringify({
                    ...
                    data:
                      ((_development_service = development.service) == null
                        ? void 0
                        : _development_service.appIsrManifest) || {},
                  }),
                );
              }
            },
  ...
  return {
    ...
    closeUpgraded() {
      ...
      development == null
        ...
        : (_development_bundler = development.bundler) == null
          ? void 0
          : (_development_bundler_hotReloader =
                _development_bundler.hotReloader) == null
            ? void 0
            : _development_bundler_hotReloader.close();
    },
    distDir: config.distDir,
    experimentalFeatures,
    cacheComponents: config.cacheComponents,
