...
export declare function sourceMapIgnoreListsEverything(
 ...
 */
export declare function findApplicableSourceMapPayload(
  line0: number,
  column0: number,
  payload: ModernSourceMapPayload,
): BasicSourceMapPayload | undefined;
export declare function filterStackFrameDEV(
  sourceURL: string,
  functionName: string,
  line1: number,
  column1: number,
): boolean;
export declare function findSourceMapURLDEV(
  scriptNameOrSourceURL: string,
): string | null;
export declare function devirtualizeReactServerURL(sourceURL: string): string;
export declare function ignoreListAnonymousStackFramesIfSandwiched<Frame>(
  frames: Frame[],
