 ...
 */
export declare const formatDebugAddress: ({
  host,
  port,
}: DebugAddress) => string;
/**
 ...
 */
export declare const getParsedDebugAddress: (
 ...
 */
export declare function formatNodeOptions(
  args: Record<string, string | boolean | undefined>,
): {
  nodeOptions: string;
  execArgv: string[];
};
export declare function getParsedNodeOptions(): Record<
  string,
 ...
 */
export declare function getParsedNodeOptionsWithoutInspect(): NodeOptions;
/**
 ...
 */
export declare function getNodeDebugType(
