...
class DevBundlerService {
  constructor(bundler, handler) {
    ...
    this.sendErrorsToBrowser =
      hotReloader.sendErrorsToBrowser.bind(hotReloader);
  }
  ...
  async revalidate({ urlPath, headers, opts: revalidateOpts }) {
    ...
    if (
      ...
      throw Object.defineProperty(
        new Error(`Invalid response ${mocked.res.statusCode}`),
        "__NEXT_ERROR_CODE",
        {
          value: "E175",
          enumerable: false,
  ...
  setIsrStatus(key, value) {
    ...
    (_this_bundler = this.bundler) == null
      ? void 0
      : (_this_bundler_hotReloader = _this_bundler.hotReloader) == null
        ? void 0
        : _this_bundler_hotReloader.sendToLegacyClients({
