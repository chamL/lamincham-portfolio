...
class PagesAPIRouteMatcherProvider
  extends _manifestroutematcherprovider.ManifestRouteMatcherProvider
{
  ...
  async transform(manifest) {
    ...
    const pathnames = Object.keys(manifest).filter((pathname) =>
      (0, _isapiroute.isAPIRoute)(pathname),
    );
    const matchers = [];
    for (const page of pathnames) {
      if (this.i18nProvider) {
        ...
        matchers.push(
          new _pagesapiroutematcher.PagesAPILocaleRouteMatcher({
        ...
        matchers.push(
          new _pagesapiroutematcher.PagesAPIRouteMatcher({
            kind: _routekind.RouteKind.PAGES_API,
