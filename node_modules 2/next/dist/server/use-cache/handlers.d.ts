 ...
 */
export declare function initializeCacheHandlers(
 ...
 * initialized.
 */
export declare function getCacheHandlers():
  | SetIterator<CacheHandler>
  | undefined;
/**
 ...
 * @throws If the cache handlers are not initialized.
 */
export declare function getCacheHandlerEntries():
 ...
 */
export declare function setCacheHandler(
  kind: string,
