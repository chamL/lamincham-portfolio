...
class NodeNextRequest extends _index.BaseNextRequest {
  ...
  constructor(_req) {
    ...
    (super(_req.method.toUpperCase(), _req.url, _req),
      ...
      (this.fetchMetrics =
        (_this__req = this._req) == null ? void 0 : _this__req.fetchMetrics),
      (this[_NEXT_REQUEST_META] =
        this._req[_requestmeta.NEXT_REQUEST_META] || {}),
  ...
  get originalRequest() {
    ...
    this._req[_requestmeta.NEXT_REQUEST_META] =
      this[_requestmeta.NEXT_REQUEST_META];
...
class NodeNextResponse extends _index.BaseNextResponse {
  get originalResponse() {
    if (_apiutils.SYMBOL_CLEARED_COOKIES in this) {
      this._res[_apiutils.SYMBOL_CLEARED_COOKIES] =
        this[_apiutils.SYMBOL_CLEARED_COOKIES];
    }
    return this._res;
  }
  constructor(_res) {
