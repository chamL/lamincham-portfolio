...
async function stringifyResumeDataCache(
  resumeDataCache,
    ...
    const json = {
      store: {
        ...
        cache: Object.fromEntries(
          (
            await (0, _cachestore.serializeUseCacheCacheStore)(
...
function createRenderResumeDataCache(
  ...
  if (process.env.NEXT_RUNTIME === "edge") {
    ...
    return {
      cache: (0, _cachestore.parseUseCacheCacheStore)(
        Object.entries(json.store.cache),
      ),
