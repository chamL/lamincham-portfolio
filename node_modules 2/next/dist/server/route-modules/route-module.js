...
const _responsecache = /*#__PURE__*/ _interop_require_default(
...
const dynamicImportEsmDefault = (id) =>
...
class RouteModule {
  ...
  getRouterServerContext(req) {
    ...
    const relativeProjectDir =
      (0, _requestmeta.getRequestMeta)(req, "relativeProjectDir") ||
    ...
    const routerServerContext =
      (_routerServerGlobal_RouterServerContextSymbol =
        ...
        ? void 0
        : _routerServerGlobal_RouterServerContextSymbol[relativeProjectDir];
    return {
      ...routerServerContext,
      ...(hostname !== undefined
        ? {
  ...
  async instrumentationOnRequestError(req, ...args) {
    if (process.env.NEXT_RUNTIME === "edge") {
      ...
      if (instrumentation) {
        await (instrumentation.onRequestError == null
          ? void 0
          : instrumentation.onRequestError.call(instrumentation, ...args));
      }
    } else {
    ...
    if (process.env.NEXT_RUNTIME === "edge") {
      ...
      result = {
        ...
        clientReferenceManifest:
          (_self___RSC_MANIFEST = self.__RSC_MANIFEST) == null
            ? void 0
            : _self___RSC_MANIFEST[srcPage],
      ...
      if (!projectDir) {
        throw Object.defineProperty(
          new Error("Invariant: projectDir is required for node runtime"),
          "__NEXT_ERROR_CODE",
          {
            value: "E718",
            enumerable: false,
      ...
      } = require("../load-manifest.external");
      const normalizedPagePath = (0, _normalizepagepath.normalizePagePath)(
        srcPage,
      );
      const router =
        this.definition.kind === _routekind.RouteKind.PAGES ||
        this.definition.kind === _routekind.RouteKind.PAGES_API
          ? "pages"
          : "app";
      const [
        routesManifest,
        ...
        loadManifestFromRelativePath({
          ...
          manifest: process.env.TURBOPACK
            ? `server/${router === "app" ? "app" : "pages"}${normalizedPagePath}/${_constants.REACT_LOADABLE_MANIFEST}`
        ...
        router === "app" &&
        !(0, _ismetadataroute.isStaticMetadataRoute)(srcPage)
          ? loadManifestFromRelativePath({
              distDir: this.distDir,
              projectDir,
              useEval: true,
      ...
      result = {
        ...
        clientReferenceManifest:
          clientReferenceManifest == null
            ...
            : (_clientReferenceManifest___RSC_MANIFEST =
                  clientReferenceManifest.__RSC_MANIFEST) == null
              ? void 0
              : _clientReferenceManifest___RSC_MANIFEST[
        ...
        interceptionRoutePatterns: routesManifest.rewrites.beforeFiles
          .filter(_isinterceptionrouterewrite.isInterceptionRouteRewrite)
          .map((rewrite) => new RegExp(rewrite.regex)),
      };
    }
    return result;
  ...
  async loadCustomCacheHandlers(req, nextConfig) {
    if (process.env.NEXT_RUNTIME !== "edge") {
      ...
      for (const [kind, handler] of Object.entries(cacheHandlers)) {
        ...
        } = require("../../lib/format-dynamic-import-path");
        const { join } = require("node:path");
        const absoluteProjectDir = join(
          /* turbopackIgnore: true */ process.cwd(),
          (0, _requestmeta.getRequestMeta)(req, "relativeProjectDir") ||
        ...
        (0, _handlers.setCacheHandler)(
          kind,
          (0, _interopdefault.interopDefault)(
  ...
  async getIncrementalCache(req, nextConfig, prerenderManifest, isMinimalMode) {
    if (process.env.NEXT_RUNTIME === "edge") {
      ...
      if (cacheHandler) {
        ...
        CacheHandler = (0, _interopdefault.interopDefault)(
          await dynamicImportEsmDefault(
  ...
  /** A more lightweight version of `prepare()` for only retrieving the config on edge */ getNextConfigEdge(
    req,
  ) {
    ...
    const nextConfig =
      (routerServerContext == null ? void 0 : routerServerContext.nextConfig) ||
      (serverFilesManifest == null ? void 0 : serverFilesManifest.config);
    if (!nextConfig) {
      throw Object.defineProperty(
        new Error("Invariant: nextConfig couldn't be loaded"),
        "__NEXT_ERROR_CODE",
        {
          value: "E969",
          enumerable: false,
  ...
  async prepare(req, res, { srcPage, multiZoneDraftMode }) {
    ...
    const protocol = (
      (_req_headers_xforwardedproto = req.headers["x-forwarded-proto"]) == null
        ? void 0
    ...
    if (!(0, _requestmeta.getRequestMeta)(req, "initURL")) {
      const initUrl = (
        ...
        : `${protocol}://${(routerServerContext == null ? void 0 : routerServerContext.hostname) || "localhost"}${req.url}`;
    ...
    if (
      ...
      parsedUrl.pathname = (0, _normalizedatapath.normalizeDataPath)(
        parsedUrl.pathname || "/",
      );
    }
    ...
    let detectedLocale;
    if (i18n) {
      localeResult = (0, _normalizelocalepath.normalizeLocalePath)(
        parsedUrl.pathname || "/",
        i18n.locales,
      );
    ...
    const domainLocale = (0, _detectdomainlocale.detectDomainLocale)(
      i18n == null ? void 0 : i18n.domains,
      (0, _gethostname.getHostname)(parsedUrl, req.headers),
      detectedLocale,
    );
    if (Boolean(domainLocale)) {
      (0, _requestmeta.addRequestMeta)(
        req,
        "isLocaleDomain",
        Boolean(domainLocale),
      );
    }
    const defaultLocale =
      (0, _requestmeta.getRequestMeta)(req, "defaultLocale") ||
    ...
    if (i18n) {
      parsedUrl.pathname = (0, _normalizelocalepath.normalizeLocalePath)(
        parsedUrl.pathname || "/",
        i18n.locales,
      ).pathname;
      rewrittenParsedUrl.pathname = (0,
    ...
    if (!params && serverUtils.dynamicRouteMatcher) {
      const paramsMatch = serverUtils.dynamicRouteMatcher(
        (0, _normalizedatapath.normalizeDataPath)(
          (rewrittenParsedUrl == null ? void 0 : rewrittenParsedUrl.pathname) ||
            parsedUrl.pathname ||
            "/",
        ),
      );
    ...
    if (pageIsDynamic) {
      ...
      if (!params) {
        if (queryResult.hasValidParams) {
          ...
          const paramsMatch =
            serverUtils.dynamicRouteMatcher == null
              ? void 0
              : serverUtils.dynamicRouteMatcher.call(
                  serverUtils,
                  (0, _normalizedatapath.normalizeDataPath)(
                    (localeResult == null ? void 0 : localeResult.pathname) ||
                      parsedUrl.pathname ||
                      "/",
                  ),
                );
    ...
    const { isOnDemandRevalidate, revalidateOnlyGenerated } = (0,
    _apiutils.checkIsOnDemandRevalidate)(req, prerenderManifest.preview);
    ...
    if (process.env.NEXT_RUNTIME !== "edge") {
      ...
      } = require("../node-environment-extensions/process-error-handlers");
      installProcessErrorHandlers(
        Boolean(
    ...
    // for URL building
    try {
      resolvedPathname = (0, _decodepathparams.decodePathParams)(
        resolvedPathname,
      );
    } catch (_) {}
    resolvedPathname = (0, _removetrailingslash.removeTrailingSlash)(
      resolvedPathname,
    );
  ...
  getResponseCache(req) {
    if (!this.responseCache) {
      const minimalMode =
        (0, _requestmeta.getRequestMeta)(req, "minimalMode") ?? false;
  ...
  async handleResponse({
    ...
    if (!cacheEntry) {
      if (
        cacheKey && // revalidate only generated can bail even if cacheKey is provided
