...
export declare function isAppRouteRouteModule(
  routeModule: RouteModule,
): routeModule is AppRouteRouteModule;
export declare function isAppPageRouteModule(
  routeModule: RouteModule,
): routeModule is AppPageRouteModule;
export declare function isPagesRouteModule(
  routeModule: RouteModule,
): routeModule is PagesRouteModule;
export declare function isPagesAPIRouteModule(
  routeModule: RouteModule,
