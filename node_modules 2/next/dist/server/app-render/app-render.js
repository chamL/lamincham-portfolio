...
const _approuter = /*#__PURE__*/ _interop_require_default(
  require("../../client/components/app-router"),
);
...
const filterStackFrame =
  process.env.NODE_ENV !== "production"
    ? require("../lib/source-maps").filterStackFrameDEV
    : undefined;
function parseRequestHeaders(headers, options) {
  ...
  const isHmrRefresh =
    headers[_approuterheaders.NEXT_HMR_REFRESH_HEADER] !== undefined;
  const isRSCRequest = headers[_approuterheaders.RSC_HEADER] !== undefined;
  const shouldProvideFlightRouterState =
    isRSCRequest && (!isPrefetchRequest || !options.isRoutePPREnabled);
  const flightRouterState = shouldProvideFlightRouterState
    ? (0, _parseandvalidateflightrouterstate.parseAndValidateFlightRouterState)(
        headers[_approuterheaders.NEXT_ROUTER_STATE_TREE_HEADER],
      )
    : undefined;
  // Checks if this is a prefetch of the Route Tree by the Segment Cache
  const isRouteTreePrefetchRequest =
    headers[_approuterheaders.NEXT_ROUTER_SEGMENT_PREFETCH_HEADER] === "/_tree";
  const csp =
    headers["content-security-policy"] ||
    headers["content-security-policy-report-only"];
  const nonce =
    typeof csp === "string"
      ? (0, _getscriptnoncefromheader.getScriptNonceFromHeader)(csp)
      : undefined;
  const previouslyRevalidatedTags = (0,
  _serverutils.getPreviouslyRevalidatedTags)(headers, options.previewModeId);
  let requestId;
  let htmlRequestId;
  if (process.env.__NEXT_DEV_SERVER) {
    ...
    requestId =
      typeof headers[_approuterheaders.NEXT_REQUEST_ID_HEADER] === "string"
        ? headers[_approuterheaders.NEXT_REQUEST_ID_HEADER]
        : undefined;
    htmlRequestId =
      typeof headers[_approuterheaders.NEXT_HTML_REQUEST_ID_HEADER] === "string"
...
function createNotFoundLoaderTree(loaderTree) {
  ...
  return [
    "",
    {
      children: [_segment.PAGE_SEGMENT_KEY, {}, notFoundTreeComponents, null],
    },
 ...
 */ function makeGetDynamicParamFromSegment(
  ...
  return function getDynamicParamFromSegment(loaderTree) {
    ...
    const dynamicParamType =
      _getshortdynamicparamtype.dynamicParamTypes[segmentParam.paramType];
    // Static siblings are only included when optimistic routing is enabled
    const siblings = optimisticRouting ? staticSiblings : null;
    return (0, _getdynamicparam.getDynamicParam)(
      interpolatedParams,
      segmentKey,
      dynamicParamType,
      fallbackRouteParams,
 ...
 */ async function generateDynamicRSCPayload(ctx, options) {
  ...
  if (!(options == null ? void 0 : options.skipPageRendering)) {
    ...
    const needsFullTree =
      ...
      !(options == null ? void 0 : options.actionResult) && // Only for navigations
      (await (0, _instantconfig.anySegmentNeedsInstantValidationInDev)(
        loaderTree,
      ));
    const metadataIsRuntimePrefetchable = await (0,
    _instantconfig.anySegmentHasRuntimePrefetchEnabled)(loaderTree);
    const { Viewport, Metadata, MetadataOutlet } = createMetadataComponents({
      tree: loaderTree,
      parsedQuery: query,
      pathname: url.pathname,
      metadataContext: (0, _metadatacontext.createMetadataContext)(
        ctx.renderOpts,
      ),
      ...
      needsFullTree
        ...
        : await (0,
          _walktreewithflightrouterstate.walkTreeWithFlightRouterState)({
            ...
            MetadataOutlet,
            hintTree:
              ((_ctx_renderOpts_prefetchHints = ctx.renderOpts.prefetchHints) ==
              null
                ? void 0
                : _ctx_renderOpts_prefetchHints[ctx.pagePath]) ?? null,
          })
  ...
  if (
    (options == null ? void 0 : options.staticStageByteLengthPromise) !==
    undefined
  ) {
    baseResponse.l = options.staticStageByteLengthPromise;
  }
  if (
    (options == null ? void 0 : options.runtimePrefetchStream) !== undefined
  ) {
 ...
 */ async function generateDynamicFlightRenderResult(
  ...
  function onFlightDataRenderError(err, silenceLog) {
    return onInstrumentationRequestError == null
      ? void 0
      : onInstrumentationRequestError(
          err,
          req,
  ...
  const debugChannel =
    setReactDebugChannel && (0, _debugchannelserver.createDebugChannel)();
  if (debugChannel) {
    setReactDebugChannel(debugChannel.clientSide, htmlRequestId, requestId);
  }
  const { clientModules } = (0,
  _manifestssingleton.getClientReferenceManifest)();
  ...
  const flightStream = _workunitasyncstorageexternal.workUnitAsyncStorage.run(
    requestStore,
    _streamops.renderToFlightStream,
    ctx.componentMod,
    rscPayload,
    clientModules,
    {
      onError,
      temporaryReferences:
        options == null ? void 0 : options.temporaryReferences,
      filterStackFrame,
 ...
 */ async function generateStagedDynamicFlightRenderResult(
  ...
  if (hasRuntimePrefetch) {
    ...
    _resumedatacache.createPrerenderResumeDataCache)();
  ...
  const { clientModules } = (0,
  _manifestssingleton.getClientReferenceManifest)();
  const flightReadableStream = await (0,
  _apprenderrenderutils.runInSequentialTasks)(
    () => {
      stageController.advanceStage(_stagedrendering.RenderStage.Static);
      const stream = _workunitasyncstorageexternal.workUnitAsyncStorage.run(
        requestStore,
 ...
 */ async function spawnRuntimePrefetchWithFilledCaches(
  ...
  try {
    ...
    const rootParams = (0, _createcomponenttree.getRootParams)(
      loaderTree,
...
async function stagedRenderToReadableStreamWithoutCachesInDev(
      ...
      default:
        ...
        throw Object.defineProperty(
          new _invarianterror.InvariantError(
            `Invalid render stage: ${currentStage}`,
          ),
          "__NEXT_ERROR_CODE",
          {
            value: "E881",
  ...
  return await (0, _apprenderrenderutils.runInSequentialTasks)(
    () => {
      stageController.advanceStage(_stagedrendering.RenderStage.Static);
      return _workunitasyncstorageexternal.workUnitAsyncStorage.run(
        requestStore,
        _streamops.renderToFlightStream,
        ctx.componentMod,
        rscPayload,
...
async function generateRuntimePrefetchResult(req, ctx, requestStore) {
  ...
  function onFlightDataRenderError(err, silenceLog) {
    return onInstrumentationRequestError == null
      ...
      : onInstrumentationRequestError(
          err,
          req, // TODO(runtime-ppr): should we use a different value?
          createErrorContext(ctx, "react-server-components-payload"),
          silenceLog,
        );
  }
...
async function prospectiveRuntimeServerPrerender(
  ...
  const prerenderOptions = {
    ...
    onError: (err) => {
      ...
      if (initialServerPrerenderController.signal.aborted) {
        ...
        (0, _prospectiverenderutils.printDebugThrownValueForProspectiveRender)(
          err,
          workStore.route,
          _prospectiverenderutils.Phase.ProspectiveRender,
        );
      }
    },
  ...
  const pendingInitialServerResult =
    _workunitasyncstorageexternal.workUnitAsyncStorage.run(
      initialServerPrerenderStore,
      (0, _streamops.getServerPrerender)(ComponentMod),
  ...
  try {
    return await (0, _apprenderprerenderutils.createReactServerPrerenderResult)(
...
async function finalRuntimeServerPrerender(
  ...
  const serverDynamicTracking = (0,
  _dynamicrendering.createDynamicTrackingState)(isDebugDynamicAccesses);
  const finalStageController = new _stagedrendering.StagedRenderingController(
    finalServerController.signal,
    null,
    true, // track sync IO
  );
  const varyParamsAccumulator = (0,
  _varyparams.createResponseVaryParamsAccumulator)();
  ...
  const { clientModules } = (0,
  _manifestssingleton.getClientReferenceManifest)();
  const finalRSCPayload =
    await _workunitasyncstorageexternal.workUnitAsyncStorage.run(
      finalServerPrerenderStore,
      getPayload,
    );
  let prerenderIsPending = true;
  const result = await (0, _apprenderrenderutils.runInSequentialTasks)(
    async () => {
...
async function getRSCPayload(tree, ctx, options) {
  ...
  const hints =
    ((_ctx_renderOpts_prefetchHints = ctx.renderOpts.prefetchHints) == null
      ? void 0
      : _ctx_renderOpts_prefetchHints[ctx.pagePath]) ?? null;
  const initialTree = await (0,
  _createflightrouterstatefromloadertree.createFlightRouterStateFromLoaderTree)(
    tree,
    hints,
    getDynamicParamFromSegment,
    query,
  ...
  const metadataIsRuntimePrefetchable = await (0,
  _instantconfig.anySegmentHasRuntimePrefetchEnabled)(tree);
  const { Viewport, Metadata, MetadataOutlet } = createMetadataComponents({
    tree,
  ...
  return maybeAppendBuildIdToRSCPayload(ctx, {
    ...
    q: getRenderedSearch(query),
    i: !!couldBeIntercepted,
    f: [[initialTree, seedData, initialHead, isPossiblyPartialHead]],
    m: missingSlots,
...
async function getErrorRSCPayload(tree, ctx, ssrError, errorType) {
  ...
  let err = undefined;
  if (ssrError) {
    err = (0, _iserror.default)(ssrError)
      ? ssrError
      : Object.defineProperty(new Error(ssrError + ""), "__NEXT_ERROR_CODE", {
          value: "E394",
          enumerable: false,
          configurable: true,
        });
...
function App({
  ...
  preinitScripts();
  const response = _react.use(
    (0, _useflightresponse.getFlightStream)(
      reactServerStream,
      reactDebugStream,
      debugEndTime,
      nonce,
...
async function renderToHTMLOrFlightImpl(
  ...
  if (ComponentMod.__next_app__) {
    const instrumented = (0,
    _clientcomponentrendererlogger.wrapClientComponentLoader)(ComponentMod);
  ...
  if (process.env.__NEXT_DEV_SERVER && setIsrStatus && !cacheComponents) {
    ...
    setIsrStatus(
      pathname, // Only pages using the Node runtime can use ISR, Edge is always dynamic.
  ...
  if (
    ...
    (0, _helpers.isNodeNextRequest)(req)
  ) {
    res.onClose(() => {
    ...
    req.originalRequest.on("end", () => {
      if ("performance" in globalThis) {
        ...
        if (metrics) {
          (0, _tracer.getTracer)()
            .startSpan(_constants.NextNodeServerSpan.clientComponentLoading, {
              startTime: metrics.clientComponentLoadStart,
              attributes: {
                "next.clientComponentLoadCount":
                  metrics.clientComponentLoadCount,
                "next.span_type":
                  _constants.NextNodeServerSpan.clientComponentLoading,
              },
            })
            .end(
  ...
  const appUsingSizeAdjustment = !!(nextFontManifest == null
    ? void 0
  ...
  const isPossibleActionRequest = (0,
  _serveractionrequestmeta.getIsPossibleServerAction)(req);
  ...
  const resolvedPathname = (0, _requestmeta.getRequestMeta)(
    req,
    "resolvedPathname",
  );
  if (!resolvedPathname) {
  ...
  const implicitTags = await (0, _implicittags.getImplicitTags)(
    workStore.page,
    resolvedPathname,
    fallbackRouteParams,
  );
  ...
  if (isStaticGeneration) {
    ...
    const prerenderToStreamWithTracing = (0, _tracer.getTracer)().wrap(
      _constants.AppRenderSpan.getBodyResult,
      {
    ...
    if (
      ...
      (0, _dynamicrendering.accessedDynamicData)(response.dynamicAccess) &&
      renderOpts.isDebugDynamicAccesses
    ) {
      (0, _log.warn)("The following dynamic usage was detected:");
      for (const access of (0, _dynamicrendering.formatDynamicAPIAccesses)(
        response.dynamicAccess,
      )) {
        (0, _log.warn)(access);
      }
    ...
    if (workStore.invalidDynamicUsageError) {
      (0, _dynamicrendering.logDisallowedDynamicError)(
        workStore,
    ...
    if (response.ssrErrors.length) {
      const buildFailingError = response.ssrErrors.find((err) =>
        (0, _createerrorhandler.isUserLandError)(err),
      );
      if (buildFailingError) throw buildFailingError;
    }
    const options = {
    ...
    const maybeRevalidatesPromise = (0, _revalidationutils.executeRevalidates)(
      workStore,
    );
    ...
    if (
      ...
      (await (0, _instantconfig.anySegmentNeedsInstantValidationInBuild)(
        loaderTree,
      ))
    ) {
    ...
    const fallbackParams =
      (0, _requestmeta.getRequestMeta)(req, "fallbackParams") || null;
    const createRequestStore = _requeststore.createRequestStoreForRender.bind(
      null,
      req,
      res,
      url,
    ...
    if (
      process.env.__NEXT_DEV_SERVER &&
      setIsrStatus &&
      !cacheComponents && // Only pages using the Node runtime can use ISR, so we only need to
    ...
    if (isRSCRequest) {
      if (isRuntimePrefetchRequest) {
        ...
        if (
          ...
          return generateStagedDynamicFlightRenderResult(
            req,
            ctx,
            requestStore,
          );
    ...
    const stream = await renderToStream(
      ...
      formState,
      postponedState,
      metadata, // If we're rendering HTML after an action, we don't want restartable-render behavior
...
const renderToHTMLOrFlight = (
  ...
  const url = (0, _parserelativeurl.parseRelativeUrl)(
    req.url,
    undefined,
    false,
  );
  ...
  const parsedRequestHeaders = parseRequestHeaders(req.headers, {
    ...
    previewModeId:
      (_renderOpts_previewProps = renderOpts.previewProps) == null
        ? void 0
        : _renderOpts_previewProps.previewModeId,
  });
  ...
  if (typeof renderOpts.postponed === "string") {
    ...
    interpolatedParams = (0, _getdynamicparam.interpolateParallelRouteParams)(
      renderOpts.ComponentMod.routeModule.userland.loaderTree,
      renderOpts.params ?? {},
      pagePath,
      fallbackRouteParams,
    );
    postponedState = (0, _postponedstate.parsePostponedState)(
  ...
  if (
    (postponedState == null ? void 0 : postponedState.renderResumeDataCache) &&
    renderOpts.renderResumeDataCache
  ) {
    throw Object.defineProperty(
      new _invarianterror.InvariantError(
  ...
  return _workasyncstorageexternal.workAsyncStorage.run(
    workStore, // The function to run
...
function applyMetadataFromPrerenderResult(response, metadata, workStore) {
  ...
  metadata.headers ??= {};
  metadata.headers[_approuterheaders.NEXT_ROUTER_STALE_TIME_HEADER] =
    staleHeader;
  ...
  if (workStore.forceStatic === false || response.collectedRevalidate === 0) {
    ...
    metadata.cacheControl = {
      revalidate:
        response.collectedRevalidate >= _constants1.INFINITE_CACHE
          ? false
          : response.collectedRevalidate,
      expire:
        response.collectedExpire >= _constants1.INFINITE_CACHE
          ? undefined
...
async function renderToStream(
  ...
  /* eslint-disable @next/internal/no-ambiguous-jsx -- React Client */ const {
    assetPrefix,
    htmlRequestId,
    nonce,
    pagePath,
  ...
  const { cachedNavigations } = renderOpts.experimental;
  const { ServerInsertedHTMLProvider, renderServerInsertedHTML } = (0,
  _serverinsertedhtml.createServerInsertedHTML)();
  const getServerInsertedMetadata = (0,
  _createserverinsertedmetadata.createServerInsertedMetadata)(nonce);
  const tracingMetadata = (0, _utils1.getTracedMetadata)(
  ...
  const polyfills = buildManifest.polyfillFiles
    ...
    .map((polyfill) => ({
      ...
      integrity:
        subresourceIntegrityManifest == null
          ? void 0
          : subresourceIntegrityManifest[polyfill],
      crossOrigin,
      noModule: true,
      nonce,
    }));
  const [preinitScripts, bootstrapScript] = (0,
  _requiredscripts.getRequiredScripts)(
    buildManifest, // Why is assetPrefix optional on renderOpts?
    // @TODO make it default empty string on renderOpts and get rid of it from ctx
    assetPrefix,
    crossOrigin,
    subresourceIntegrityManifest,
    (0, _getassetquerystring.getAssetQueryString)(ctx, true),
    nonce,
    page,
  );
  ...
  const renderSpan = (0, _tracer.getTracer)().startSpan(
    `render route (app) ${pagePath}`,
    {
      attributes: {
  ...
  return (0, _tracer.getTracer)().withSpan(renderSpan, async () => {
    ...
    _createerrorhandler.createReactServerErrorHandler)(
      process.env.NODE_ENV === "development",
      isBuildTimePrerendering,
    ...
    const htmlRendererErrorHandler = (0,
    _createerrorhandler.createHTMLErrorHandler)(
      process.env.NODE_ENV === "development",
      isBuildTimePrerendering,
      reactServerErrorsByDigest,
      allCapturedErrors,
    ...
    try {
      if (
        process.env.__NEXT_DEV_SERVER && // Edge routes never prerender so we don't have a Prerender environment for anything in edge runtime
        ...
        if (
          ...
          reactServerResult = new _apprenderprerenderutils.ReactServerResult(
            serverStream,
          );
          requestStore = finalRequestStore;
          debugChannel = returnedDebugChannel;
          ...
          debugChannel =
            setReactDebugChannel &&
            (0, _debugchannelserver.createDebugChannel)();
          const serverStream =
            await stagedRenderToReadableStreamWithoutCachesInDev(
              ...
              getPayload,
              {
                ...
                filterStackFrame,
                debugChannel:
                  debugChannel == null ? void 0 : debugChannel.serverSide,
              },
            );
          reactServerResult = new _apprenderprerenderutils.ReactServerResult(
            serverStream,
        ...
        const selectStaleTime = (0, _staletime.createSelectStaleTime)(
          experimental,
        );
        const staleTimeIterable = new _staletime.StaleTimeIterable();
        // TODO(cached-navs): this assumes that we checked during build that there's no sync IO.
      ...
      if (typeof renderOpts.postponed === "string") {
        if (
          (postponedState == null ? void 0 : postponedState.type) ===
          _postponedstate.DynamicState.DATA
        ) {
          // We have a complete HTML Document in the prerender but we need to
          // still include the new server component render because it was not included
          // in the static prelude.
          const inlinedDataStream = (0, _streamops.createInlinedDataStream)(
          ...
          return (0, _streamops.chainStreams)(
            inlinedDataStream,
            (0, _streamops.createDocumentClosingStream)(),
          );
        } else if (postponedState) {
          // We assume we have dynamic HTML requiring a resume render to complete
          const { postponed, preludeState } = (0,
          _postponedstate.getPostponedFromState)(postponedState);
          ...
          const getServerInsertedHTML = (0,
          _makegetserverinsertedhtml.makeGetServerInsertedHTML)({
            polyfills,
          ...
          return await (0, _streamops.continueDynamicHTMLResume)(htmlStream, {
            delayDataUntilFirstHtmlChunk:
              preludeState === _postponedstate.DynamicHTMLPreludeState.Empty,
            inlinedDataStream: (0, _streamops.createInlinedDataStream)(
      ...
      if (
        (0, _staticgenerationbailout.isStaticGenBailoutError)(err) ||
        (typeof err === "object" &&
          err !== null &&
          "message" in err &&
      ...
      if ((0, _httpaccessfallback.isHTTPAccessFallbackError)(err)) {
        res.statusCode = (0, _httpaccessfallback.getAccessFallbackHTTPStatus)(
          err,
        );
        metadata.statusCode = res.statusCode;
        errorType = (0, _httpaccessfallback.getAccessFallbackErrorTypeByStatus)(
          res.statusCode,
        );
        ...
        metadata.statusCode = res.statusCode;
        const redirectUrl = (0, _addpathprefix.addPathPrefix)(
          (0, _redirect.getURLFromRedirectError)(err),
          basePath,
        );
        ...
        if (
          (0, _requestcookies.appendMutableCookies)(
            headers,
            requestStore.mutableCookies,
          )
        ) {
      ...
      const [errorPreinitScripts, errorBootstrapScript] = (0,
      _requiredscripts.getRequiredScripts)(
        buildManifest,
        assetPrefix,
        crossOrigin,
        subresourceIntegrityManifest,
        (0, _getassetquerystring.getAssetQueryString)(ctx, false),
        nonce,
        "/_not-found/page",
      );
      let errorRSCPayload;
      ...
      try {
        errorRSCPayload =
          await _workunitasyncstorageexternal.workUnitAsyncStorage.run(
            ...
            tree,
            ctx,
            reactServerErrorsByDigest.has(err.digest) ? null : err,
            errorType,
          );
        errorServerStream =
          _workunitasyncstorageexternal.workUnitAsyncStorage.run(
      ...
      try {
        ...
        if (
          process.env.__NEXT_DEV_SERVER &&
          (0, _httpaccessfallback.isHTTPAccessFallbackError)(finalErr)
        ) {
          const {
            bailOnRootNotFound,
          } = require("../../client/components/dev-root-http-access-fallback-boundary");
          bailOnRootNotFound();
        }
...
async function renderWithRestartOnCacheMissInDev(
  ...
  const initialStreamResult = await (0,
  _apprenderrenderutils.runInSequentialTasks)(
    () => {
      initialStageController.advanceStage(
        _stagedrendering.RenderStage.EarlyStatic,
      );
      startTime = performance.now() + performance.timeOrigin;
      const streamPair = _workunitasyncstorageexternal.workUnitAsyncStorage
        .run(
          requestStore,
          _streamops.renderToFlightStream,
          ComponentMod,
  ...
  if (
    initialStageController.currentStage !==
    _stagedrendering.RenderStage.Abandoned
  ) {
  ...
  requestStore.renderResumeDataCache = (0,
  _resumedatacache.createRenderResumeDataCache)(prerenderResumeDataCache);
  ...
  const finalStreamResult = await (0,
  _apprenderrenderutils.runInSequentialTasks)(
    () => {
      finalStageController.advanceStage(
        _stagedrendering.RenderStage.EarlyStatic,
 ...
 */ async function logMessagesAndSendErrorsToBrowser(messages, ctx) {
  ...
  if (errors.length > 0) {
    ...
    const { clientModules } = (0,
    _manifestssingleton.getClientReferenceManifest)();
    const errorsFlightStream = (0, _streamops.renderToFlightStream)(
      ctx.componentMod,
      {
        errors,
        errorCodes,
 ...
 */ async function spawnStaticShellValidationInDevImpl(
  ...
  const allowEmptyStaticShell =
    ...
    (await (0, _instantconfig.isPageAllowedToBlock)(loaderTree));
  const rootParams = (0, _createcomponenttree.getRootParams)(
    loaderTree,
    getDynamicParamFromSegment,
  );
  const hmrRefreshHash = (0, _workunitasyncstorageexternal.getHmrRefreshHash)(
    requestStore,
  );
  // We don't need to continue the prerender process if we already
  // detected invalid dynamic usage in the initial prerender phase.
  ...
  const needsInstantValidation = await (0,
  _instantconfig.anySegmentNeedsInstantValidationInDev)(loaderTree);
  ...
  const runtimeResult = await validateStagedShell(
    ...
    ctx,
    hmrRefreshHash,
    _dynamicrendering.trackDynamicHoleInRuntimeShell,
  );
  ...
  const staticResult = await validateStagedShell(
    ...
    ctx,
    hmrRefreshHash,
    _dynamicrendering.trackDynamicHoleInStaticShell,
  );
...
async function warmupClientModulesForStagedValidation(
  ...
  const { ServerInsertedHTMLProvider } = (0,
  _serverinsertedhtml.createServerInsertedHTML)();
  ...
  const serverStream = (0, _streamutils.createNodeStreamWithLateRelease)(
    partialServerChunks,
    allServerChunks,
    initialClientReactController.signal,
  );
  const pendingInitialClientResult =
    _workunitasyncstorageexternal.workUnitAsyncStorage.run(
      initialClientPrerenderStore,
      _streamops.getClientPrerender, // eslint-disable-next-line @next/internal/no-ambiguous-jsx -- React Client
      ...
      }),
      {
        ...
        onError: (err) => {
          const digest = (0, _createerrorhandler.getDigestForWellKnownError)(
            err,
          );
          if (digest) {
            return digest;
  ...
  pendingInitialClientResult.catch((err) => {
    if (
      ...
      (0, _dynamicrendering.isPrerenderInterruptedError)(err)
    ) {
      // These are expected errors that might error the prerender. we ignore them.
    } else if (
      process.env.NEXT_DEBUG_BUILD ||
...
async function validateStagedShell(
  ...
  const { implicitTags, nonce, workStore } = ctx;
  const clientDynamicTracking = (0,
  _dynamicrendering.createDynamicTrackingState)(
  ...
  const dynamicValidation = (0,
  _dynamicrendering.createDynamicValidationState)();
  const serverStream = (0, _streamutils.createNodeStreamWithLateRelease)(
    stageChunks,
    allServerChunks,
  ...
  const debugChannelClient = debugChunks
    ? (0, _streamutils.createNodeStreamWithLateRelease)(
        debugChunks,
        debugChunks,
        clientReactController.signal,
      )
  ...
  try {
    ...
    _apprenderrenderutils.runInSequentialTasks)(
      () => {
        const pendingFinalClientResult =
          _workunitasyncstorageexternal.workUnitAsyncStorage.run(
    ...
    const { preludeIsEmpty } = await (0, _streamops.processPrelude)(
      unprocessedPrelude,
    );
    return (0, _dynamicrendering.getStaticShellDisallowedDynamicReasons)(
      workStore,
      preludeIsEmpty
        ? _dynamicrendering.PreludeState.Empty
        : _dynamicrendering.PreludeState.Full,
      dynamicValidation, // TODO(instant-validation): if allowEmptyStaticShell is true (likely due to blocking configs),
    ...
    let errors = (0, _dynamicrendering.getStaticShellDisallowedDynamicReasons)(
      workStore,
      _dynamicrendering.PreludeState.Errored,
      dynamicValidation, // TODO(instant-validation): if allowEmptyStaticShell is true (likely due to blocking configs),
      // we should probably just skip this altogether
      allowEmptyStaticShell,
    );
 ...
 */ async function validateInstantConfigs(
  ...
  } = require("./instant-validation/instant-samples");
  debug == null
    ? void 0
  ...
  async function validateAtDepthImpl(
    ...
    const boundaryState = (0,
    _boundarytracking.createValidationBoundaryTracking)();
    ...
    const instantValidationState = (0,
    _dynamicrendering.createInstantValidationState)(
      payloadResult.createInstantStack,
    );
    const validationSampleTracking =
      validationSamples !== null ? createValidationSampleTracking() : null;
    const clientDynamicTracking = (0,
    _dynamicrendering.createDynamicTrackingState)(false);
    ...
    let errors;
    try {
      const { prelude: unprocessedPrelude } = await (0,
      _apprenderrenderutils.runInSequentialTasks)(
        () => {
          const pendingResult =
            _workunitasyncstorageexternal.workUnitAsyncStorage.run(
              ...
              }),
              {
                ...
                onError: (err, errorInfo) => {
                  if (
                    ...
                    const componentStack = errorInfo.componentStack;
                    if (typeof componentStack === "string") {
                      (0, _dynamicrendering.trackDynamicHoleInNavigation)(
                        workStore,
                        componentStack,
                        instantValidationState,
                        clientDynamicTracking,
                        payloadResult.hasAmbiguousErrors
                          ? _dynamicrendering.DynamicHoleKind.Runtime
                          : _dynamicrendering.DynamicHoleKind.Dynamic,
                        boundaryState,
                      );
                    }
                    return;
                    ...
                    if (typeof componentStack === "string") {
                      ...
                      (0, _dynamicrendering.trackThrownErrorInNavigation)(
                        workStore,
                        instantValidationState,
                        errorForDisplay,
                        componentStack,
                  ...
                  return (0, _createerrorhandler.getDigestForWellKnownError)(
                    err,
                  );
                },
              },
      ...
      errors = (0, _dynamicrendering.getNavigationDisallowedDynamicReasons)(
        workStore,
        preludeIsEmpty
          ? _dynamicrendering.PreludeState.Empty
          : _dynamicrendering.PreludeState.Full,
 ...
 */ async function renderWithRestartOnCacheMissInValidation(
  ...
  const prerenderResumeDataCache = prefilledDataCache
    ? (0, _resumedatacache.createPrerenderResumeDataCache)(prefilledDataCache)
    : (0, _resumedatacache.createPrerenderResumeDataCache)();
  const initialReactController = new AbortController();
...
async function validateInstantConfigsInBuild(ctx, prefilledDataCache) {
  const run = async () => {
    ...
    try {
      ...
      // before we shadow it.
      success = await _workasyncstorageexternal.workAsyncStorage.exit(
        async () => validateInstantConfigsInBuildImpl(ctx, prefilledDataCache),
      );
    } catch (err) {
      console.error(
 ...
 */ async function validateInstantConfigsInBuildImpl(ctx, prefilledDataCache) {
  ...
  const loaderTree = ctx.componentMod.routeModule.userland.loaderTree;
  let samples = await (0, _instantconfig.resolveInstantConfigSamplesForPage)(
    loaderTree,
  );
  ...
  const allPossibleFallbackRouteParams = (0,
  _fallbackparams.getFallbackRouteParams)(route, ctx.componentMod.routeModule);
  for (let sampleIndex = 0; sampleIndex < samples.length; sampleIndex++) {
    const sample = samples[sampleIndex];
    debug == null
      ? void 0
      : debug(
          `Validating sample (${sampleIndex + 1}/${samples.length}):`,
          sample,
        );
    let errors;
    try {
...
async function validateInstantConfigInBuildWithSample(
  ...
  const sampleRootParams = (0, _createcomponenttree.getRootParams)(
    loaderTree,
    getDynamicParamFromSegment,
  );
  ...
  return _workasyncstorageexternal.workAsyncStorage.run(workStore, async () => {
    ...
    if (
      stageController.currentStage === _stagedrendering.RenderStage.Abandoned &&
...
async function prerenderToStream(
  ...
  const allowEmptyStaticShell =
    (renderOpts.allowEmptyStaticShell ?? false) ||
    (await (0, _instantconfig.isPageAllowedToBlock)(tree));
  const rootParams = (0, _createcomponenttree.getRootParams)(
    tree,
    getDynamicParamFromSegment,
  );
  ...
  try {
    if (cacheComponents) {
      ...
      if (initialServerResult) {
        ...
        const pendingInitialClientResult =
          _workunitasyncstorageexternal.workUnitAsyncStorage.run(
            initialClientPrerenderStore,
            _streamops.getClientPrerender, // eslint-disable-next-line @next/internal/no-ambiguous-jsx
            /*#__PURE__*/ (0, _jsxruntime.jsx)(App, {
            ...
            }),
            {
              ...
              onError: (err) => {
                const digest = (0,
                _createerrorhandler.getDigestForWellKnownError)(err);
                if (digest) {
                  return digest;
                }
                if ((0, _reactlargeshellerror.isReactLargeShellError)(err)) {
      ...
      _apprenderprerenderutils.createReactServerPrerenderResult)(
        (0, _apprenderrenderutils.runInSequentialTasks)(
          finalRSCPrerenderFn,
      ...
      let dynamicValidation = (0,
      _dynamicrendering.createDynamicValidationState)();
      const finalClientOnHeaders = (0, _streamops.createOnHeadersCallback)(
        appendHeader,
      );
              ...
              }),
              {
                ...
                onError: (err, errorInfo) => {
                  if (
                    ...
                    const componentStack = errorInfo.componentStack;
                    if (typeof componentStack === "string") {
                      (0, _dynamicrendering.trackAllowedDynamicAccess)(
                        workStore,
                        componentStack,
                        dynamicValidation,
                        clientDynamicTracking,
      ...
      const { prelude, preludeIsEmpty } = await (0, _streamops.processPrelude)(
        unprocessedPrelude,
      );
      ...
      if (!allowEmptyStaticShell) {
        (0, _dynamicrendering.throwIfDisallowedDynamic)(
          workStore,
          preludeIsEmpty
            ? _dynamicrendering.PreludeState.Empty
            : _dynamicrendering.PreludeState.Full,
      ...
      metadata.flightData = await (0, _streamops.streamToBuffer)(
        cachedNavigations
      ...
      if (serverIsDynamic) {
        ...
        if (postponed != null) {
          ...
          _postponedstate.getDynamicHTMLPostponedState)(
            postponed,
            preludeIsEmpty
              ? _postponedstate.DynamicHTMLPreludeState.Empty
              : _postponedstate.DynamicHTMLPreludeState.Full,
            fallbackRouteParams,
            prerenderResumeDataCache,
            cacheComponents,
          );
          ...
          // Dynamic Data case
          metadata.postponed = await (0,
          _postponedstate.getDynamicDataPostponedState)(
            prerenderResumeDataCache,
            cacheComponents,
          );
        }
        ...
        return {
          ...
          stream: await (0, _streamops.continueDynamicPrerender)(
            prelude,
            continueDynamicPrerenderOpts,
          ),
          dynamicAccess: (0, _dynamicrendering.consumeDynamicAccess)(
            serverDynamicTracking,
            clientDynamicTracking,
          ),
          ...
          collectedTags: finalServerPrerenderStore.tags,
          renderResumeDataCache: (0,
          _resumedatacache.createRenderResumeDataCache)(
            prerenderResumeDataCache,
          ),
        };
      } else {
        ...
        if (postponed != null) {
          ...
          const resumePrelude = await (0, _streamops.resumeAndAbort)(
        ...
        if (hasFallbackRouteParams) {
          ...
          _apprenderprerenderutils.createReactServerPrerenderResultFromRender)(
            (0, _streamops.renderToFlightStream)(
              ComponentMod,
              [],
              clientModules,
              {
          ...
          finalStream = await (0, _streamops.continueStaticFallbackPrerender)(
            htmlStream,
            {
              inlinedDataStream: (0, _streamops.createInlinedDataStream)(
          ...
          finalStream = await (0, _streamops.continueStaticPrerender)(
            htmlStream,
            {
              inlinedDataStream: (0, _streamops.createInlinedDataStream)(
      ...
      let dynamicTracking = (0, _dynamicrendering.createDynamicTrackingState)(
        isDebugDynamicAccesses,
      );
      const prerenderResumeDataCache = (0,
      _resumedatacache.createPrerenderResumeDataCache)();
      ...
      reactServerResult = reactServerPrerenderResult = await (0,
      _apprenderprerenderutils.createReactServerPrerenderResultFromRender)(
        _workunitasyncstorageexternal.workUnitAsyncStorage.run(
          reactServerPrerenderStore,
          _streamops.renderToFlightStream,
      ...
      const pprOnHeaders = (0, _streamops.createOnHeadersCallback)(
        appendHeader,
      );
      ...
      if (
        (0, _dynamicrendering.accessedDynamicData)(
      ...
      const { stream: htmlStream } =
        await _workunitasyncstorageexternal.workUnitAsyncStorage.run(
          prerenderLegacyStore,
          _streamops.renderToFizzStream, // eslint-disable-next-line @next/internal/no-ambiguous-jsx
          /*#__PURE__*/ (0, _jsxruntime.jsx)(App, {
            reactServerStream: reactServerResult.asUnclosingStream(),
            reactDebugStream: undefined,
            debugEndTime: undefined,
    ...
    const prerenderLegacyStore = (prerenderStore = {
      ...
      revalidate:
        typeof (prerenderStore == null ? void 0 : prerenderStore.revalidate) !==
        "undefined"
          ? prerenderStore.revalidate
          : _constants1.INFINITE_CACHE,
      expire:
        typeof (prerenderStore == null ? void 0 : prerenderStore.expire) !==
        "undefined"
          ? prerenderStore.expire
          : _constants1.INFINITE_CACHE,
      stale:
        typeof (prerenderStore == null ? void 0 : prerenderStore.stale) !==
        "undefined"
          ? prerenderStore.stale
          : _constants1.INFINITE_CACHE,
      tags: [
        ...((prerenderStore == null ? void 0 : prerenderStore.tags) ||
          implicitTags.tags),
      ],
    });
    const errorRSCPayload =
      await _workunitasyncstorageexternal.workUnitAsyncStorage.run(
        prerenderLegacyStore,
        getErrorRSCPayload,
        tree,
        ctx,
        reactServerErrorsByDigest.has(err.digest) ? undefined : err,
        errorType,
      );
    const errorServerStream =
      _workunitasyncstorageexternal.workUnitAsyncStorage.run(
        prerenderLegacyStore,
        _streamops.renderToFlightStream,
        ComponentMod,
...
const getGlobalErrorStyles = async (tree, ctx) => {
  const globalErrorModule = (0, _parseloadertree.parseLoaderTree)(tree).modules[
    "global-error"
  ];
  ...
  const [GlobalErrorComponent, styles] = await (0,
  _createcomponentstylesandscripts.createComponentStylesAndScripts)({
    ctx,
  ...
  if (process.env.__NEXT_DEV_SERVER) {
    const dir =
      (process.env.NEXT_RUNTIME === "edge"
        ...
        : ctx.renderOpts.dir) || "";
    const globalErrorModulePath = (0,
    _segmentexplorerpath.normalizeConventionFilePath)(
      dir,
      globalErrorModule[1],
    );
...
async function collectSegmentData(
  ...
  const { clientModules, edgeRscModuleMapping, rscModuleMapping } = (0,
  _manifestssingleton.getClientReferenceManifest)();
  ...
  if (!prefetchInlining) {
    ...
    hints =
      ((_renderOpts_prefetchHints = renderOpts.prefetchHints) == null
        ? void 0
        : _renderOpts_prefetchHints[pagePath]) ?? null;
  }
