...
const encryptActionBoundArgs = _react.default.cache(
  async function encryptActionBoundArgs(actionId, ...args) {
    ...
    const prerenderResumeDataCache = workUnitStore
      ? (0, _workunitasyncstorageexternal.getPrerenderResumeDataCache)(
          workUnitStore,
        )
      : null;
    const renderResumeDataCache = workUnitStore
      ? (0, _workunitasyncstorageexternal.getRenderResumeDataCache)(
          workUnitStore,
        )
      : null;
    // Using Flight to serialize the args into a string.
    const serialized = await (0, _nodewebstreamshelper.streamToString)(
      (0, _server.renderToReadableStream)(args, clientModules, {
        filterStackFrame,
...
async function decryptActionBoundArgs(actionId, encryptedPromise) {
  ...
  const deserialized = await (0, _client.createFromReadableStream)(
    new ReadableStream({
      start(controller) {
