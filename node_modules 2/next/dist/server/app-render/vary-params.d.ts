...
export declare function getVaryParamsThenable(
 ...
 * varyParams set.
 */
export declare function accumulateVaryParam(
  accumulator: VaryParamsAccumulator,
  paramName: string,
): void;
/**
...
export declare function createVaryingParams(
  accumulator: VaryParamsAccumulator,
  originalParamsObject: Params,
  optionalCatchAllParamName: string | null,
): Params;
export declare function createVaryingSearchParams(
  accumulator: VaryParamsAccumulator,
 ...
 * "unknown" vary params.
 */
export declare function finishAccumulatingVaryParams(
