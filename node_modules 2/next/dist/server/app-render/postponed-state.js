...
var DynamicHTMLPreludeState = /*#__PURE__*/ (function (
...
async function getDynamicHTMLPostponedState(
  ...
  const data = [preludeState, postponed];
...
async function getDynamicDataPostponedState(
  resumeDataCache,
  isCacheComponentsEnabled,
) {
...
function parsePostponedState(
  ...
  try {
    var _state_match;
    const postponedStringLengthMatch =
      (_state_match = state.match(/^([0-9]*):/)) == null
        ? void 0
        : _state_match[1];
    if (!postponedStringLengthMatch) {
      throw Object.defineProperty(
        new Error(`Invariant: invalid postponed state ${state}`),
        "__NEXT_ERROR_CODE",
        {
          value: "E314",
          enumerable: false,
    ...
    try {
      ...
      if (/^[0-9]/.test(postponedString)) {
        ...
        const match =
          (_postponedString_match = postponedString.match(/^([0-9]*)/)) == null
            ? void 0
            : _postponedString_match[1];
        if (!match) {
          throw Object.defineProperty(
            new Error(
        ...
        const replacements = JSON.parse(
          postponedString.slice(
            match.length, // We then go to the end of the string.
            match.length + length,
          ),
        );
        ...
        for (const [
          ...
          } = (0, _getdynamicparam.getDynamicParam)(
            interpolatedParams,
            segmentKey,
            dynamicParamType,
            null,
