...
export declare function getDynamicDataPostponedState(
  resumeDataCache: PrerenderResumeDataCache | RenderResumeDataCache,
  isCacheComponentsEnabled: boolean,
): Promise<string>;
export declare function parsePostponedState(
  state: string,
  interpolatedParams: Params,
  maxPostponedStateSizeBytes: number | undefined,
): PostponedState;
export declare function getPostponedFromState(
  state: DynamicHTMLPostponedState,
): {
  preludeState: DynamicHTMLPreludeState;
