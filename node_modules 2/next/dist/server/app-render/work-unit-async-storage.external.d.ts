 ...
 */
export declare function isInEarlyRenderStage(
...
export declare function throwForMissingRequestStore(
  callingExpression: string,
): never;
export declare function throwInvariantForMissingStore(): never;
export declare function getPrerenderResumeDataCache(
  workUnitStore: WorkUnitStore,
): PrerenderResumeDataCache | null;
export declare function getRenderResumeDataCache(
  workUnitStore: WorkUnitStore,
): RenderResumeDataCache | null;
export declare function getHmrRefreshHash(
  workUnitStore: WorkUnitStore,
): string | undefined;
export declare function isHmrRefresh(workUnitStore: WorkUnitStore): boolean;
export declare function getServerComponentsHmrCache(
  workUnitStore: WorkUnitStore,
): ServerComponentsHmrCache | undefined;
/**
 * Returns a draft mode provider only if draft mode is enabled.
 */
export declare function getDraftModeProviderForCacheScope(
  workStore: WorkStore,
  workUnitStore: WorkUnitStore,
): DraftModeProvider | undefined;
export declare function getStagedRenderingController(
  workUnitStore: WorkUnitStore,
): StagedRenderingController | null;
export declare function getCacheSignal(
  workUnitStore: WorkUnitStore,
): CacheSignal | null;
