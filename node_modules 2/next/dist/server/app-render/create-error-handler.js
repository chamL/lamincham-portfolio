...
const _stringhash = /*#__PURE__*/ _interop_require_default(
  require("next/dist/compiled/string-hash"),
);
...
function getDigestForWellKnownError(error) {
  ...
  if ((0, _dynamicrendering.isPrerenderInterruptedError)(error))
    return error.digest;
  if ((0, _instantvalidationerror.isInstantValidationError)(error))
    return error.digest;
  return undefined;
}
function createReactServerErrorHandler(
  ...
  return (thrownValue) => {
    ...
    if (err.digest) {
      ...
      err.digest = (0, _errortelemetryutils.createDigestWithErrorCode)(
        err, // TODO-APP: look at using webcrypto instead. Requires a promise to be awaited.
