...
async function walkTreeWithFlightRouterState({
  loaderTreeToFilter,
  parentParams,
  flightRouterState,
  ...
  const currentParams = // Handle null case where dynamic param is optional
    segmentParam && segmentParam.value !== null
      ...
      : parentParams;
  const actualSegment = (0, _segment.addSearchParamsIfPageSegment)(
  ...
  if (
    ...
    !experimental.isRoutePPREnabled && // If PPR is disabled, and this is a request for the route tree, then we
    ...
    const overriddenSegment =
      flightRouterState && // TODO: Why does canSegmentBeOverridden exist? Why don't we always just
    ...
    const routerState = parsedRequestHeaders.isRouteTreePrefetchRequest
      ? await (0,
        _createflightrouterstatefromloadertree.createRouteTreePrefetch)(
          loaderTreeToFilter,
          hintTree,
          getDynamicParamFromSegment,
        )
    ...
    return [[overriddenSegment, routerState, null, [null, null], true]];
  }
  ...
  if (flightRouterState && flightRouterState[3] === "metadata-only") {
    ...
    return [[overriddenSegment, routerState, null, rscHead, false]];
  }
  if (renderComponentsOnThisLevel) {
    ...
    return [[overriddenSegment, routerState, seedData, rscHead, false]];
  }
  ...
  if (layoutPath) {
    (0, _getcssinlinedlinktags.getLinkAndScriptTags)(
      layoutPath,
      injectedCSSWithCurrentLayout,
      injectedJSWithCurrentLayout,
      true,
    );
    (0, _getpreloadablefonts.getPreloadableFonts)(
      nextFontManifest,
      layoutPath,
  ...
  for (const parallelRouteKey of parallelRoutesKeys) {
    ...
    const subPaths = await walkTreeWithFlightRouterState({
      ...
      hintTree:
        (hintTree == null
          ? void 0
          : (_hintTree_slots = hintTree.slots) == null
            ? void 0
            : _hintTree_slots[parallelRouteKey]) ?? null,
    });
...
async function createFullTreeFlightDataForNavigation({
  loaderTree,
  rscHead,
  injectedCSS,
  injectedJS,
  ...
  const hintTreeForInitialRender =
    ((_ctx_renderOpts_prefetchHints = ctx.renderOpts.prefetchHints) == null
      ? void 0
      : _ctx_renderOpts_prefetchHints[pagePath]) ?? null;
  const routerState = await (0,
  _createflightrouterstatefromloadertree.createFlightRouterStateFromLoaderTree)(
    loaderTree,
 ...
 */ const canSegmentBeOverridden = (existingSegment, segment) => {
  ...
  return (
    ((_getSegmentParam = (0, _getsegmentparam.getSegmentParam)(
      ...
      ? void 0
      : _getSegmentParam.paramName) === segment[0]
  );
};
