...
const _superstruct = /*#__PURE__*/ _interop_require_default(
  require("next/dist/compiled/superstruct"),
);
...
const segmentSchema = _superstruct.default.union([
  ...
  _superstruct.default.tuple([
    ...
    _superstruct.default.nullable(
      _superstruct.default.array(_superstruct.default.string()),
    ),
  ]),
]);
const flightRouterStateSchema = _superstruct.default.tuple([
  segmentSchema,
  _superstruct.default.record(
    _superstruct.default.string(),
    _superstruct.default.lazy(() => flightRouterStateSchema),
  ),
  _superstruct.default.optional(
    _superstruct.default.nullable(
      _superstruct.default.tuple([
        _superstruct.default.string(),
        _superstruct.default.string(),
