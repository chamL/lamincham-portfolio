...
const _totelemetry = /*#__PURE__*/ _interop_require_default(
  require("./to-telemetry"),
);
const _tojson = /*#__PURE__*/ _interop_require_default(require("./to-json"));
const _tojsonbuild = /*#__PURE__*/ _interop_require_default(
  require("./to-json-build"),
);
...
class MultiReporter {
  ...
  async flushAll(opts) {
    await Promise.all(
      this.reporters.map((reporter) => reporter.flushAll(opts)),
    );
  }
  report(event) {
