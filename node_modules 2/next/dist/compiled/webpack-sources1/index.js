(function () {
  var e = {
    513: function (e, t, r) {
      ...
      class CodeNode {
        ...
        getMappings(e) {
          const t = n(this.generatedCode);
          const r = Array(t + 1).join(";");
          if (t > 0) {
      ...
      class SingleLineNode {
        ...
        getMappings(e) {
          ...
          if (e.unfinishedGeneratedLine)
            i = "," + n.encode(e.unfinishedGeneratedLine);
          i += n.encode(r - e.currentSource);
          i += n.encode(this.line - e.currentOriginalLine);
          i += "A";
          e.currentSource = r;
          e.currentOriginalLine = this.line;
          const a = (e.unfinishedGeneratedLine = s(this.generatedCode));
          i += Array(t).join(o);
          if (a === 0) {
            i += ";";
          } else {
      ...
      class SourceListMap {
        constructor(e, t, r) {
          if (Array.isArray(e)) {
            ...
            this.children = [];
            if (e || t) this.add(e, t, r);
          }
        }
        add(e, t, r) {
          if (typeof e === "string") {
            if (t) {
              this.children.push(new i(e, t, r));
            } else if (
              this.children.length > 0 &&
              this.children[this.children.length - 1] instanceof n
            ) {
              this.children[this.children.length - 1].addGeneratedCode(e);
            } else {
              this.children.push(new n(e));
            }
        ...
        preprend(e, t, r) {
          if (typeof e === "string") {
            if (t) {
              this.children.unshift(new i(e, t, r));
            } else if (
              this.children.length > 0 &&
      ...
      class SourceNode {
        ...
        getMappings(e) {
          ...
          if (e.unfinishedGeneratedLine)
            i = "," + n.encode(e.unfinishedGeneratedLine);
          i += n.encode(r - e.currentSource);
          i += n.encode(this.startingLine - e.currentOriginalLine);
          i += "A";
          e.currentSource = r;
        ...
        getNormalizedNodes() {
          ...
          while (n < i) {
            var s = r.indexOf("\n", n) + 1;
            if (s === 0) s = i;
            var o = r.substr(n, s - n);
            e.push(new a(o, this.source, this.originalSource, t));
            n = s;
            t++;
          }
          return e;
    ...
    558: function (e, t, r) {
      ...
      e.exports = function fromStringWithSourceMap(e, t) {
        const r = t.sources;
        const a = t.sourcesContent;
        const u = t.mappings.split(";");
        const c = e.split("\n");
        const h = [];
        let d = null;
        let l = 1;
        ...
        function addCode(e) {
          ...
          } else if (d && d instanceof i && !e.trim()) {
            d.addGeneratedCode(e);
            p++;
          } else {
            d = new s(e);
        ...
        function addSource(e, t, r, n) {
          if (d && d instanceof i && d.source === t && p === n) {
            d.addGeneratedCode(e);
            p++;
          } else {
            d = new i(e, t, r, n);
        ...
        u.forEach(function (e, t) {
          ...
          e = { value: 0, rest: e };
          let n = false;
          while (e.rest) n = processMapping(e, r, n) || n;
          if (!n) addCode(r);
        });
        ...
        function processMapping(e, t, i) {
          ...
          if (!i) {
            addSource(t, r ? r[s] : null, a ? a[s] : null, o);
            return true;
          }
        }
      };
    ...
    113: function (e, t, r) {
      t.SourceListMap = r(492);
      r(692);
      r(856);
      r(513);
      r(337);
      t.fromStringWithSourceMap = r(558);
    },
    37: function (e, t, r) {
      "use strict";
      const n = r(83);
    ...
    926: function (e, t, r) {
      "use strict";
      const n = r(749).SourceNode;
      const i = r(113).SourceListMap;
      const s = r(83);
      class ConcatSource extends s {
        constructor() {
          ...
          for (var e = 0; e < arguments.length; e++) {
            ...
            if (t instanceof ConcatSource) {
              var r = t.children;
              for (var n = 0; n < r.length; n++) this.children.push(r[n]);
            } else {
        ...
        add(e) {
          if (e instanceof ConcatSource) {
            var t = e.children;
            for (var r = 0; r < t.length; r++) this.children.push(t[r]);
          } else {
            this.children.push(e);
          }
        }
        ...
        size() {
          ...
          for (let r = 0; r < t.length; r++) {
            const n = t[r];
            e += typeof n === "string" ? n.length : n.size();
          }
          return e;
        }
        node(e) {
        ...
        updateHash(e) {
          ...
          for (var r = 0; r < t.length; r++) {
            var n = t[r];
            if (typeof n === "string") e.update(n);
            else n.updateHash(e);
          }
        }
      }
      r(975)(ConcatSource.prototype);
      e.exports = ConcatSource;
    },
    869: function (e, t, r) {
      "use strict";
      var n = r(749).SourceNode;
      var i = r(749).SourceMapConsumer;
      var s = r(113).SourceListMap;
      var o = r(83);
      class LineToLineMappedSource extends o {
        ...
        node(e) {
          ...
          var s = new n(
            ...
            null,
            i.map(function (e, t) {
              return new n(t + 1, 0, r, e + (t != i.length - 1 ? "\n" : ""));
            }),
          );
          s.setSourceContent(r, this._originalSource);
          return s;
        }
        listMap(e) {
      ...
      r(975)(LineToLineMappedSource.prototype);
    ...
    624: function (e, t, r) {
        ...
        node(e) {
          ...
          var o = new n(
            ...
            s.map(function (t, r) {
              var o = 0;
              if (e.columns === false) {
                var a = t + (r != s.length - 1 ? "\n" : "");
                return new n(r + 1, 0, i, a);
              }
              return new n(
                null,
                null,
      ...
      r(975)(OriginalSource.prototype);
      e.exports = OriginalSource;
    },
    526: function (e, t, r) {
      "use strict";
      var n = r(83);
      var i = r(749).SourceNode;
      var s = /\n(?=.|\s)/g;
      function cloneAndPrefix(e, t, r) {
        if (typeof e === "string") {
          var n = e.replace(s, "\n" + t);
          if (r.length > 0) n = r.pop() + n;
          if (/\n$/.test(e)) r.push(t);
          return n;
        } else {
          var o = new i(
          ...
          t.walk(function (e, t) {
            ...
            for (var a = 0; a < s.length; a += 2) {
              ...
              if (c) {
                ...
                n.push(new i(t.line, t.column, t.source, c, t.name));
                o = u;
              }
            }
          });
      ...
      class ReplaceSource extends n {
        ...
        replace(e, t, r, n) {
          ...
          this.replacements.push(
            new Replacement(e, t, r, this.replacements.length, n),
          );
        }
        insert(e, t, r) {
          if (typeof t !== "string")
          ...
          this.replacements.push(
            new Replacement(e, e - 1, t, this.replacements.length, r),
          );
        }
        source(e) {
        ...
        _replaceString(e) {
          ...
          this.replacements.forEach(function (e) {
            var r = t.pop();
            var n = this._splitString(r, Math.floor(e.end + 1));
            var i = this._splitString(n[0], Math.floor(e.start));
            t.push(n[1], e.content, i[0]);
          }, this);
          let r = "";
        ...
        listMap(e) {
          ...
          t = t.mapGeneratedCode(function (e) {
            ...
            if (s > e.length) {
              ...
              var o = "";
              while (i >= 0 && n[i].start < t) {
                var a = n[i];
                var u = Math.floor(a.start);
                var c = Math.floor(a.end + 1);
                var h = e.substr(0, Math.max(0, u - r));
                if (c <= t) {
                  var d = e.substr(Math.max(0, c - r));
                  o += h + a.content;
                  e = d;
                  r = Math.max(r, c);
                } else {
        ...
        _replaceInStringNode(e, t, r, n, s, o) {
          var a = undefined;
          do {
            var u = t.position - s;
            if (u < 0) {
            ...
            if (u >= n.length || t.done) {
              if (t.emit) {
                var c = new i(o.line, o.column, o.source, n, o.name);
                e.push(c);
              }
              return s + n.length;
            }
            ...
            if (u > 0) {
              ...
              if (a && a.length >= u && a.startsWith(d)) {
                o.column += u;
                a = a.substr(u);
              }
            }
            ...
            if (!l) {
              if (u > 0) {
                var f = new i(o.line, h, o.source, d, o.name);
                e.push(f);
              }
              if (t.value) {
                e.push(
    ...
    321: function (e, t, r) {
      ...
      var n = r(749).SourceNode;
      var i = r(749).SourceMapConsumer;
      var s = r(749).SourceMapGenerator;
      var o = r(113).SourceListMap;
      var a = r(113).fromStringWithSourceMap;
      var u = r(83);
      var c = r(401);
      class SourceMapSource extends u {
        ...
        node(e) {
          var t = this._sourceMap;
          var r = n.fromStringWithSourceMap(this._value, new i(t));
          r.setSourceContent(this._name, this._originalSource);
          var s = this._innerSourceMap;
          if (s) {
            r = c(r, new i(s), this._name, this._removeOriginalSource);
          }
          return r;
        }
        listMap(e) {
      ...
      r(975)(SourceMapSource.prototype);
    ...
    401: function (e, t, r) {
      ...
      var n = r(749).SourceNode;
      var i = r(749).SourceMapConsumer;
      var applySourceMap = function (e, t, r, s) {
        var o = new n();
        var a = [];
        var u = {};
        var c = {};
        ...
        e.walk(function (e, i) {
          var l;
          if (i.source === r && i.line && c[i.line]) {
            var p;
            var g = c[i.line];
            for (var _ = 0; _ < g.length; _++) {
              if (g[_].generatedColumn <= i.column) {
                p = g[_];
              }
            }
            if (p) {
              ...
              if (
                f &&
                w &&
                (m = f[p.generatedLine - 1]) &&
                ((C = d[w]) || (S = t.sourceContentFor(w, true)))
              ) {
                if (!C) {
                  C = d[w] = S.split("\n");
                }
                var L = C[p.originalLine - 1];
                if (L) {
                  var M = i.column - p.generatedColumn;
                  if (M > 0) {
                    var x = m.slice(p.generatedColumn, i.column);
                    var b = L.slice(p.originalColumn, p.originalColumn + M);
                    if (x === b) {
                      p = Object.assign({}, p, {
                        originalColumn: p.originalColumn + M,
              ...
              if (!("$" + l in h)) {
                h["$" + l] = true;
                var N = t.sourceContentFor(l, true);
                if (N) {
                  o.setSourceContent(l, N);
                }
              }
              return;
            }
          }
          if ((s && i.source === r) || !i.source) {
            a.push(e);
            return;
          }
          l = i.source;
          a.push(new n(i.line, i.column, l, e, i.name));
          if ("$" + l in u) {
            if (!("$" + l in h)) {
              o.setSourceContent(l, u["$" + l]);
              delete u["$" + l];
            }
          }
        });
  ...
  !(function () {
    var e = r;
    e.Source = __nccwpck_require__(83);
    e.RawSource = __nccwpck_require__(23);
    e.OriginalSource = __nccwpck_require__(624);
    e.SourceMapSource = __nccwpck_require__(321);
    e.LineToLineMappedSource = __nccwpck_require__(869);
    e.CachedSource = __nccwpck_require__(37);
    e.ConcatSource = __nccwpck_require__(926);
    e.ReplaceSource = __nccwpck_require__(116);
    e.PrefixSource = __nccwpck_require__(526);
  })();
  module.exports = r;
})();
