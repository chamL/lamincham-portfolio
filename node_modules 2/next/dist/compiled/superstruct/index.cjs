      ...
      (function (e, n) {
        ...
        function toFailure(e, t, n, r) {
          ...
          const {
            refinement: a,
            message:
              s = `Expected a value of type \`${o}\`${a ? ` with refinement \`${a}\`` : ""}, but received: \`${print(r)}\``,
          } = e;
          return {
            value: r,
            type: o,
        ...
        function* run(e, t, n = {}) {
          ...
          for (let [u, f, l] of t.entries(e, a)) {
            const t = run(f, l, {
              path: u === undefined ? r : [...r, u],
              branch: u === undefined ? i : [...i, f],
              coerce: c,
              mask: o,
              message: n.message,
            });
        ...
        function assert(e, t, n) {
          const r = validate(e, t, { message: n });
          if (r[0]) {
            throw r[0];
          }
        }
        function create(e, t, n) {
          const r = validate(e, t, { coerce: true, message: n });
          if (r[0]) {
            throw r[0];
          } else {
            return r[1];
        ...
        function mask(e, t, n) {
          const r = validate(e, t, { coerce: true, mask: true, message: n });
          if (r[0]) {
            throw r[0];
          } else {
            return r[1];
        ...
        function partial(e) {
          const t = e instanceof Struct ? { ...e.schema } : { ...e };
          for (const e in t) {
            t[e] = optional(t[e]);
          }
          return object(t);
          ...
          return new Struct({
            ...
            *entries(t) {
            ...
            validator(e) {
              return (
                Array.isArray(e) ||
                `Expected an array value, but received: ${print(e)}`
              );
            },
          });
        }
        ...
        function date() {
          return define(
            ...
            (e) =>
              ...
              `Expected a valid \`Date\` object, but received: ${print(e)}`,
          );
        }
        function enums(e) {
          const t = {};
          ...
          return new Struct({
            ...
            validator(t) {
              return (
                e.includes(t) ||
                `Expected one of \`${n}\`, but received: ${print(t)}`
              );
            },
          });
        }
        function func() {
          return define(
            ...
            (e) =>
              typeof e === "function" ||
              `Expected a function, but received: ${print(e)}`,
          );
        }
        function instance(e) {
          return define(
            ...
            (t) =>
              t instanceof e ||
              `Expected a \`${e.name}\` instance, but received: ${print(t)}`,
          );
        }
        function integer() {
          return define(
            ...
            (e) =>
              ...
              `Expected an integer, but received: ${print(e)}`,
          );
        }
        ...
        function literal(e) {
          ...
          return new Struct({
            type: "literal",
            schema:
              n === "string" || n === "number" || n === "boolean" ? e : null,
            validator(n) {
              return (
                n === e ||
                `Expected the literal \`${t}\`, but received: ${print(n)}`
              );
            },
          });
        }
          ...
          return new Struct({
            ...
            *entries(n) {
            ...
            validator(e) {
              return (
                e instanceof Map ||
                `Expected a \`Map\` object, but received: ${print(e)}`
              );
            },
          });
        }
        ...
        function number() {
          return define(
            ...
            (e) =>
              ...
              `Expected a number, but received: ${print(e)}`,
          );
        }
        function object(e) {
          ...
          return new Struct({
            ...
            *entries(r) {
            ...
            validator(e) {
              return (
                isObject(e) || `Expected an object, but received: ${print(e)}`
              );
            },
            coercer(e) {
              return isObject(e) ? { ...e } : e;
            },
          });
        }
        function optional(e) {
          ...
          return new Struct({
            ...
            *entries(t) {
            ...
            validator(e) {
              return (
                e instanceof Set ||
                `Expected a \`Set\` object, but received: ${print(e)}`
              );
            },
          });
        }
        function string() {
          return define(
            ...
            (e) =>
              typeof e === "string" ||
              `Expected a string, but received: ${print(e)}`,
          );
        }
        function tuple(e) {
          const t = never();
          return new Struct({
            ...
            *entries(n) {
            ...
            validator(e) {
              return (
                Array.isArray(e) ||
                `Expected an array, but received: ${print(e)}`
              );
            },
          });
        }
        ...
        function union(e) {
          ...
          return new Struct({
            ...
            coercer(t) {
              for (const n of e) {
                const [e, r] = n.validate(t, { coerce: true });
                if (!e) {
                  return r;
                }
              }
        ...
        function coerce(e, t, n) {
          return new Struct({
            ...e,
            coercer: (r, i) =>
              is(r, t) ? e.coercer(n(r, i), i) : e.coercer(r, i),
          });
        }
        ...
        function nonempty(e) {
          return refine(e, "nonempty", (t) => {
            const n = getSize(t);
            return (
              n > 0 || `Expected a nonempty ${e.type} but received an empty one`
            );
          });
        }
        function pattern(e, t) {
          return refine(
            ...
            (n) =>
              t.test(n) ||
              `Expected a ${e.type} matching \`/${t.source}/\` but received "${n}"`,
          );
        }
        function size(e, t, n = t) {
          ...
          return refine(e, "size", (e) => {
            if (typeof e === "number" || e instanceof Date) {
              ...
              return (
                (t <= c && c <= n) ||
                `${r} with a size ${i} but received one with a size of \`${c}\``
              );
            } else {
              const { length: c } = e;
              return (
                (t <= c && c <= n) ||
                `${r} with a length ${i} but received one with a length of \`${c}\``
              );
            }
          });
        }
