  ...
  var e = {
      ...
      class ValidationError extends Error {
        ...
        formatSchema(e, r = true, t = []) {
          ...
          if (likeArray(e)) {
            ...
            if (typeof e.minItems === "number") {
              r.push(
                `should not have fewer than ${e.minItems} item${e.minItems > 1 ? "s" : ""}`,
              );
            }
            if (typeof e.maxItems === "number") {
              r.push(
                `should not have more than ${e.maxItems} item${e.maxItems > 1 ? "s" : ""}`,
              );
            }
            if (e.uniqueItems) {
              ...
              if (Array.isArray(e.items) && e.items.length > 0) {
                ...
                if (t) {
                  if (
                    ...
                    r.push(
                      `additional items should be ${formatInnerSchema(e.additionalItems)}`,
                    );
                  }
                }
            ...
            if (e.contains && Object.keys(e.contains).length > 0) {
              r.push(
                `should contains at least one ${this.formatSchema(e.contains)} item`,
              );
            }
          ...
          if (likeObject(e)) {
            ...
            if (typeof e.minProperties === "number") {
              r.push(
                `should not have fewer than ${e.minProperties} ${e.minProperties > 1 ? "properties" : "property"}`,
              );
            }
            if (typeof e.maxProperties === "number") {
              r.push(
                `should not have more than ${e.maxProperties} ${e.minProperties && e.minProperties > 1 ? "properties" : "property"}`,
              );
            }
            if (
              e.patternProperties &&
              ...
              r.push(
                `additional property names should match pattern${t.length > 1 ? "s" : ""} ${t.map((e) => JSON.stringify(e)).join(" | ")}`,
              );
            }
            ...
            if (n) {
              Object.keys(n).forEach((e) => {
                ...
                if (Array.isArray(t)) {
                  r.push(
                    `should have ${t.length > 1 ? "properties" : "property"} ${t.map((e) => `'${e}'`).join(", ")} when property '${e}' is present`,
                  );
                } else {
                  r.push(
                    `should be valid according to the schema ${formatInnerSchema(t)} when property '${e}' is present`,
                  );
                }
              });
            }
            if (l && Object.keys(l).length > 0) {
              r.push(
                `each property name should match format ${JSON.stringify(e.propertyNames.format)}`,
              );
            }
            if (u && u.length > 0) {
              r.push(
                `should have property matching pattern ${u.map((e) => JSON.stringify(e))}`,
              );
            }
        ...
        formatValidationError(e) {
          ...
          switch (r) {
            ...
            case "contains": {
              const { parentSchema: r } = e;
              return `${a} should contains at least one ${this.getSchemaPartText(r, ["contains"])} item${getSchemaNonTypes(r)}.`;
            }
            case "required": {
              const { parentSchema: r, params: t } = e;
              const s = t.missingProperty.replace(/^\./, "");
              const i = r && Boolean(r.properties && r.properties[s]);
              return `${a} misses the property '${s}'${getSchemaNonTypes(r)}.${i ? ` Should be:\n${this.getSchemaPartText(r, ["properties", s])}` : this.getSchemaPartDescription(r)}`;
            }
    ...
    3314: (e, r) => {
      ...
      function getErrorFor(e, r, t) {
        const a = e
          ...
          : `A relative path is expected. However, the provided value ${JSON.stringify(t)} is an absolute path!`;
          ...
          compile(e, r) {
            const callback = (t) => {
              ...
              if (s) {
                callback.errors = [
                  errorMessage(
                    `The provided value ${JSON.stringify(t)} contains exclamation mark (!) which is not allowed because it's reserved for loader syntax.`,
                    r,
                    t,
                  ),
                ];
    ...
    7931: (e, r, t) => {
      ...
      e.exports.stringHints = function stringHints(e, r) {
        ...
        if (s.pattern) {
          t.push(
            `should${r ? "" : " not"} match pattern ${JSON.stringify(s.pattern)}`,
          );
        }
        if (s.format) {
          t.push(
        ...
        if (s.formatMinimum) {
          t.push(
            `should be ${s.formatExclusiveMinimum ? ">" : ">="} ${JSON.stringify(s.formatMinimum)}`,
          );
        }
        if (s.formatMaximum) {
          t.push(
            `should be ${s.formatExclusiveMaximum ? "<" : "<="} ${JSON.stringify(s.formatMaximum)}`,
          );
        }
        return [a].concat(t);
      };
