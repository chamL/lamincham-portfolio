(() => {
  var a = {
    218: (a) => {
      "use strict";
      a.exports = balanced;
      function balanced(a, e, i) {
        if (a instanceof RegExp) a = maybeMatch(a, i);
        if (e instanceof RegExp) e = maybeMatch(e, i);
        var n = range(a, e, i);
        return (
          n && {
            start: n[0],
            ...
            pre: i.slice(0, n[0]),
            body: i.slice(n[0] + a.length, n[1]),
            post: i.slice(n[1] + e.length),
          }
        );
      }
      function maybeMatch(a, e) {
        var i = e.match(a);
        return i ? i[0] : null;
      }
      balanced.range = range;
      function range(a, e, i) {
        var n, o, s, t, c;
        var p = i.indexOf(a);
        var r = i.indexOf(e, p + 1);
        var l = p;
        if (p >= 0 && r > 0) {
          if (a === e) {
            return [p, r];
    ...
    800: (a, e, i) => {
      ...
      function expandTop(a) {
        if (!a) return [];
        if (a.substr(0, 2) === "{}") {
          a = "\\{\\}" + a.substr(2);
        }
        return expand(escapeBraces(a), true).map(unescapeBraces);
      }
      function identity(a) {
        return a;
      }
      ...
      function expand(a, e) {
        var i = [];
        var s = o("{", "}", a);
        if (!s || /\$$/.test(s.pre)) return [a];
        var t = /^-?\d+\.\.-?\d+(?:\.\.-?\d+)?$/.test(s.body);
        var p = /^[a-zA-Z]\.\.[a-zA-Z](?:\.\.-?\d+)?$/.test(s.body);
        var r = t || p;
        var l = s.body.indexOf(",") >= 0;
        if (!r && !l) {
          if (s.post.match(/,.*\}/)) {
            a = s.pre + "{" + s.body + c + s.post;
            return expand(a);
          }
          return [a];
        }
        ...
        if (r) {
          var v = numeric(u[0]);
          var f = numeric(u[1]);
          var h = Math.max(u[0].length, u[1].length);
          var g = u.length == 3 ? Math.abs(numeric(u[2])) : 1;
          var b = lte;
          var w = f < v;
          if (w) {
            g *= -1;
          ...
          var y = u.some(isPadded);
          x = [];
          for (var k = v; b(k, f); k += g) {
            var j;
            if (p) {
              ...
              if (y) {
                var z = h - j.length;
                if (z > 0) {
                  var q = new Array(z + 1).join("0");
                  if (k < 0) j = "-" + q + j.slice(1);
                  else j = q + j;
                }
              }
            }
    ...
    502: (a, e, i) => {
      ...
      function contentType(a) {
        ...
        var i = a.indexOf("/") === -1 ? e.lookup(a) : a;
        if (!i) {
          return false;
        }
      ...
      function lookup(a) {
        ...
        return e.types[i] || false;
      }
      function populateMaps(a, e) {
        ...
        Object.keys(n).forEach(function forEachMimeType(o) {
          ...
          for (var c = 0; c < t.length; c++) {
            var p = t[c];
            if (e[p]) {
              var r = i.indexOf(n[e[p]].source);
              var l = i.indexOf(s.source);
              if (
                e[p] !== "application/octet-stream" &&
                (r > l || (r === l && e[p].substr(0, 12) === "application/"))
              ) {
                continue;
              }
            }
    ...
    923: (a, e, i) => {
      ...
      minimatch.sep = n.sep;
      var o = (minimatch.GLOBSTAR = Minimatch.GLOBSTAR = {});
      var s = i(800);
      var t = {
        "!": { open: "(?:(?!(?:", close: "))[^/]*?)" },
        "?": { open: "(?:", close: ")?" },
      ...
      var u = charSet("().*{}+?[]^$\\!");
      function charSet(a) {
        return a.split("").reduce(function (a, e) {
          a[e] = true;
          return a;
        }, {});
      }
      ...
      minimatch.defaults = function (a) {
        if (!a || typeof a !== "object" || !Object.keys(a).length) {
          return minimatch;
        }
        var e = minimatch;
        var i = function minimatch(i, n, o) {
          return e(i, n, ext(a, o));
        };
        i.Minimatch = function Minimatch(i, n) {
          return new e.Minimatch(i, ext(a, n));
        };
        i.Minimatch.defaults = function defaults(i) {
          return e.defaults(ext(a, i)).Minimatch;
        };
        i.filter = function filter(i, n) {
          return e.filter(i, ext(a, n));
        };
        i.defaults = function defaults(i) {
          return e.defaults(ext(a, i));
        };
        i.makeRe = function makeRe(i, n) {
          return e.makeRe(i, ext(a, n));
        };
        i.braceExpand = function braceExpand(i, n) {
          return e.braceExpand(i, ext(a, n));
        };
        i.match = function (i, n, o) {
          return e.match(i, n, ext(a, o));
        };
        return i;
      };
      Minimatch.defaults = function (a) {
        return minimatch.defaults(a).Minimatch;
      };
      function minimatch(a, e, i) {
        assertValidPattern(e);
        if (!i) i = {};
        if (!i.nocomment && e.charAt(0) === "#") {
          return false;
        }
        return new Minimatch(e, i).match(a);
      }
      function Minimatch(a, e) {
        if (!(this instanceof Minimatch)) {
          return new Minimatch(a, e);
        }
        assertValidPattern(a);
        if (!e) e = {};
        a = a.trim();
        if (!e.allowWindowsEscape && n.sep !== "/") {
          a = a.split(n.sep).join("/");
        }
        this.options = e;
        this.set = [];
        this.pattern = a;
      ...
      function parseNegate() {
        ...
        for (var o = 0, s = a.length; o < s && a.charAt(o) === "!"; o++) {
          e = !e;
          n++;
        }
        if (n) this.pattern = a.substr(n);
        this.negate = e;
      }
      minimatch.braceExpand = function (a, e) {
        return braceExpand(a, e);
      };
      Minimatch.prototype.braceExpand = braceExpand;
      function braceExpand(a, e) {
        if (!e) {
          if (this instanceof Minimatch) {
            e = this.options;
          } else {
        ...
        a = typeof a === "undefined" ? this.pattern : a;
        assertValidPattern(a);
        if (e.nobrace || !/\{(?:(?!\{).)*\}/.test(a)) {
          return [a];
        }
      ...
      var m = 1024 * 64;
      var assertValidPattern = function (a) {
        if (typeof a !== "string") {
      ...
      function parse(a, e) {
        ...
        function clearStateChar() {
          if (m) {
            ...
            b.debug("clearStateChar %j %j", m, n);
            m = false;
          }
        }
        for (var w = 0, y = a.length, k; w < y && (k = a.charAt(w)); w++) {
          this.debug("%s\t%s %s %j", a, w, n, k);
          if (r && u[k]) {
            n += "\\" + k;
            r = false;
            continue;
          ...
          switch (k) {
            ...
            case "@":
            case "!":
              this.debug("%s\t%s %s %j <-- stateChar", a, w, n, k);
              if (v) {
                this.debug("  in class");
                if (k === "!" && w === h + 1) k = "^";
                n += k;
              ...
              b.debug("call clearStateChar %j", m);
              clearStateChar();
              m = k;
              if (i.noext) clearStateChar();
              continue;
            case "(":
              if (v) {
                n += "(";
            ...
            case "]":
              ...
              var z = a.substring(h + 1, w);
              try {
                RegExp("[" + z + "]");
              } catch (a) {
                var q = this.parse(z, x);
                n = n.substr(0, f) + "\\[" + q[0] + "\\]";
                s = s || q[1];
                v = false;
                continue;
        ...
        for (j = l.pop(); j; j = l.pop()) {
          var E = n.slice(j.reStart + j.open.length);
          this.debug("setting tail", n, j);
          E = E.replace(/((?:\\{2}){0,64})(\\?)\|/g, function (a, e, i) {
            if (!i) {
              i = "\\";
            }
            return e + e + i + "|";
          ...
          this.debug("tail=%j\n   %s", E, E, j, n);
          var C = j.type === "*" ? p : j.type === "?" ? c : "\\" + j.type;
          s = true;
          n = n.slice(0, j.reStart) + C + "\\(" + E;
        }
        clearStateChar();
        if (r) {
          n += "\\\\";
        ...
        for (var O = d.length - 1; O > -1; O--) {
          var M = d[O];
          var _ = n.slice(0, M.reStart);
          var T = n.slice(M.reStart, M.reEnd - 8);
          var N = n.slice(M.reEnd - 8, M.reEnd);
          var R = n.slice(M.reEnd);
          N += R;
          var A = _.split("(").length - 1;
          var $ = R;
          for (w = 0; w < A; w++) {
            $ = $.replace(/\)[+*?]?/, "");
          }
        ...
        if (!s) {
          return globUnescape(a);
        }
        var H = i.nocase ? "i" : "";
        try {
          var I = new RegExp("^" + n + "$", H);
        } catch (a) {
          return new RegExp("$.");
        }
        I._glob = a;
      ...
      minimatch.makeRe = function (a, e) {
        return new Minimatch(a, e || {}).makeRe();
      };
      ...
      function makeRe() {
        ...
        var e = this.options;
        var i = e.noglobstar ? p : e.dot ? r : l;
        var n = e.nocase ? "i" : "";
        var s = a
          .map(function (a) {
            return a
      ...
      minimatch.match = function (a, e, i) {
        i = i || {};
        var n = new Minimatch(e, i);
        a = a.filter(function (a) {
          return n.match(a);
        });
        if (n.options.nonull && !a.length) {
          a.push(e);
        }
        return a;
      };
      Minimatch.prototype.match = function match(a, e) {
        ...
        for (t = 0; t < o.length; t++) {
          var c = o[t];
          var p = a;
          if (i.matchBase && c.length === 1) {
            p = [s];
          }
          var r = this.matchOne(p, c, e);
          if (r) {
      ...
      Minimatch.prototype.matchOne = function (a, e, i) {
        var n = this.options;
        this.debug("matchOne", { this: this, file: a, pattern: e });
        this.debug("matchOne", a.length, e.length);
        for (
          var s = 0, t = 0, c = a.length, p = e.length;
          s < c && t < p;
          s++, t++
        ) {
          ...
          if (r === o) {
            ...
            while (u < c) {
              var m = a[u];
              this.debug("\nglobstar while", a, u, e, d, m);
              if (this.matchOne(a.slice(u), e.slice(d), i)) {
                this.debug("globstar found match!", u, c, m);
                return true;
              } else {
                if (
                  m === "." ||
                  ...
                  this.debug("dot detected!", a, u, e, d);
                  break;
                }
          ...
          if (typeof r === "string") {
            x = l === r;
            this.debug("string match", r, l, x);
          } else {
            x = l.match(r);
            this.debug("pattern match", r, l, x);
          }
          if (!x) return false;
        }
        if (s === c && t === p) {
    ...
    611: (a, e, i) => {
      ...
      a.exports = function (a, e) {
        a = stripTrailingSep(a);
        e = stripTrailingSep(e);
        ...
        return (
          a.lastIndexOf(e, 0) === 0 &&
          (a[e.length] === n.sep || a[e.length] === undefined)
        );
      };
      function stripTrailingSep(a) {
        if (a[a.length - 1] === n.sep) {
          return a.slice(0, -1);
        }
        return a;
      }
    ...
    216: (a) => {
       ...
       * MIT Licensed
       */ a.exports = rangeParser;
      function rangeParser(a, e, i) {
        var n = e.indexOf("=");
        if (n === -1) {
          return -2;
        }
        var o = e.slice(n + 1).split(",");
        var s = [];
        s.type = e.slice(0, n);
        for (var t = 0; t < o.length; t++) {
          var c = o[t].split("-");
          var p = parseInt(c[0], 10);
          ...
          if (isNaN(p) || isNaN(r) || p > r || p < 0) {
            continue;
          }
          s.push({ start: p, end: r });
        }
        if (s.length < 1) {
          return -1;
        }
        return i && i.combine ? combineRanges(s) : s;
      }
      function combineRanges(a) {
        var e = a.map(mapWithIndex).sort(sortByRangeStart);
        for (var i = 0, n = 1; n < e.length; n++) {
          var o = e[n];
          var s = e[i];
          if (o.start > s.end + 1) {
            e[++i] = o;
            ...
            s.end = o.end;
            s.index = Math.min(s.index, o.index);
          }
        }
        e.length = i + 1;
        var t = e.sort(sortByRangeIndex).map(mapWithoutIndex);
        t.type = a.type;
        return t;
      }
      function mapWithIndex(a, e) {
        return { start: a.start, end: a.end, index: e };
      }
      function mapWithoutIndex(a) {
        return { start: a.start, end: a.end };
      }
      function sortByRangeIndex(a, e) {
        return a.index - e.index;
      }
      function sortByRangeStart(a, e) {
      ...
      (function () {
        function directory(a) {
          var e =
            typeof i !== "undefined"
              ...
              : (function (a) {
                  ...
                  return function (a) {
                    return a
                      ? a.toString().replace(i, function (a) {
                          return e[a] || a;
                        })
                      : "";
                  };
          ...
          if (o) {
            ...
            while (t < c) {
              s = o[(t += 1)];
              n += ' <a href="/' + e(s.url) + '">' + e(s.name) + "</a> ";
            }
          }
          n += ' </h1> </header> <ul id="files"> ';
          var p = a.files;
          if (p) {
            var s,
              t = -1,
    ...
    107: (a) => {
      (function () {
        ...
        if (true && a.exports) a.exports = e;
          ...
          window.render = window.render || {};
          window.render["error"] = e;
        }
      })();
    },
    6: (a, e, i) => {
      const n = i(17);
      const normalize = (a) => n.posix.normalize(n.posix.join("/", a));
      a.exports = (a) =>
        a.charAt(0) === "!" ? `!${normalize(a.substr(1))}` : normalize(a);
      a.exports.normalize = normalize;
    },
    374: (a, e, i) => {
      const { promisify: n } = i(837);
      const o = i(17);
      const { createHash: s } = i(113);
      const { realpath: t, lstat: c, createReadStream: p, readdir: r } = i(147);
      const l = i(310);
      const u = i(6);
      const d = i(923);
      const m = i(671);
      ...
      const w = i(107);
      const y = new Map();
      const calculateSha = (a, e) =>
        new Promise((i, n) => {
          const t = s("sha1");
          t.update(o.extname(e));
          t.update("-");
          const c = a.createReadStream(e);
          c.on("error", n);
          c.on("data", (a) => t.update(a));
          c.on("end", () => {
            const a = t.digest("hex");
            i(a);
          });
        });
      const sourceMatches = (a, e, i) => {
        const n = [];
        const s = u(a);
        const t = o.posix.resolve(e);
        let c = null;
        if (i) {
          const a = s.replace("*", "(.*)");
          const e = m(a, n);
        ...
        if (c || d(t, s)) {
          return { keys: n, results: c };
        }
        return null;
      };
      const toTarget = (a, e, i) => {
        const n = sourceMatches(a, i, true);
        if (!n) {
          return null;
        }
        const { keys: o, results: s } = n;
        const t = {};
        const { protocol: c } = l.parse(e);
        const p = c ? e : u(e);
        const r = m.compile(p);
      ...
      const applyRewrites = (a, e = [], i) => {
        ...
        for (let i = 0; i < n.length; i++) {
          const { source: o, destination: s } = e[i];
          const t = toTarget(o, s, a);
          if (t) {
            n.splice(i, 1);
            return applyRewrites(u(t), n, true);
          }
        }
        return o;
      };
      const ensureSlashStart = (a) => (a.startsWith("/") ? a : `/${a}`);
      const shouldRedirect = (
        a,
        { redirects: e = [], trailingSlash: i },
        n,
      ) => {
        const s = typeof i === "boolean";
        const t = 301;
        const c = /(\.html|\/index)$/g;
        if (e.length === 0 && !s && !n) {
          return null;
        }
        if (n && c.test(a)) {
          ...
          return { target: ensureSlashStart(a), statusCode: t };
        }
        if (s) {
          const { ext: e, name: n } = o.parse(a);
          const s = a.endsWith("/");
          ...
          if (p) {
            return { target: ensureSlashStart(p), statusCode: t };
          }
        }
        for (let i = 0; i < e.length; i++) {
          const { source: n, destination: o, type: s } = e[i];
          const c = toTarget(n, o, a);
          if (c) {
            return { target: c, statusCode: s || t };
          }
        }
        return null;
      };
      const appendHeaders = (a, e) => {
        for (let i = 0; i < e.length; i++) {
          const { key: n, value: o } = e[i];
          a[n] = o;
        }
      };
      const getHeaders = async (a, e, i, n, s) => {
        const { headers: t = [], etag: c = false } = e;
        const p = {};
        const { base: r } = o.parse(n);
        const l = o.relative(i, n);
        if (t.length > 0) {
          for (let a = 0; a < t.length; a++) {
            const { source: e, headers: i } = t[a];
            if (sourceMatches(e, u(l))) {
              appendHeaders(p, i);
            }
          }
        }
        ...
        if (s) {
          d = {
            ...
            "Content-Disposition": f(r, { type: "inline" }),
            "Accept-Ranges": "bytes",
          };
          if (c) {
            let [e, i] = y.get(n) || [];
            if (Number(e) !== Number(s.mtime)) {
              i = await calculateSha(a, n);
              y.set(n, [s.mtime, i]);
            }
            d["ETag"] = `"${i}"`;
          } else {
            d["Last-Modified"] = s.mtime.toUTCString();
          }
          const e = x.contentType(r);
          if (e) {
            d["Content-Type"] = e;
          }
        }
      ...
      const getPossiblePaths = (a, e) =>
        [
          o.join(a, `index${e}`),
          a.endsWith("/") ? a.replace(/\/$/g, e) : a + e,
        ].filter((a) => o.basename(a) !== e);
      const findRelated = async (a, e, i, n) => {
        const s = i ? [i] : getPossiblePaths(e, ".html");
        let t = null;
        for (let e = 0; e < s.length; e++) {
          ...
          try {
            ...
            if (a.code !== "ENOENT" && a.code !== "ENOTDIR") {
              throw a;
            }
          }
          if (t) {
            return { stats: t, absolutePath: c };
          }
        }
        return null;
      };
      const canBeListed = (a, e) => {
        const i = u(e);
        let n = true;
        for (let e = 0; e < a.length; e++) {
          const o = a[e];
          if (sourceMatches(o, i)) {
            n = false;
            break;
          }
        }
      ...
      const renderDirectory = async (a, e, i, n, s, t) => {
        const {
          directoryListing: c,
          trailingSlash: p,
          unlisted: r = [],
        ...
        const u = typeof p === "boolean" ? (p ? "/" : "") : "/";
        const { relativePath: d, absolutePath: m } = t;
        const x = [".DS_Store", ".git", ...r];
        if (!applicable(d, c) && !l) {
          return {};
        }
        let f = await i.readdir(m);
        const h = l && f.length === 1;
        for (let a = 0; a < f.length; a++) {
          const e = f[a];
          const s = o.resolve(m, e);
          const t = o.parse(s);
          let c = null;
          if (n.lstat) {
            c = await i.lstat(s, true);
          } else {
            c = await i.lstat(s);
          }
          t.relative = o.join(d, t.base);
          if (c.isDirectory()) {
            t.base += u;
            t.relative += u;
            t.type = "folder";
            ...
            if (h) {
              return { singleFile: true, absolutePath: s, stats: c };
            }
            t.ext = t.ext.split(".")[1] || "txt";
            t.type = "file";
            t.size = v(c.size, { unitSeparator: " ", decimalPlaces: 0 });
          }
          t.title = t.base;
          if (canBeListed(x, e)) {
            f[a] = t;
        ...
        const g = o.relative(a, m);
        const w = o.join(o.basename(a), g, u);
        const y = w.split(o.sep).filter(Boolean);
        f = f
          .sort((a, e) => {
            const i = a.type === "directory";
            const n = e.type === "directory";
            if (i && !n) {
              return -1;
            }
            if ((n && !i) || a.base > e.base) {
              return 1;
            }
            if (a.base < e.base) {
              return -1;
        ...
        const j = { files: f, directory: w, paths: k };
        const z = e ? JSON.stringify(j) : b(j);
        return { directory: z };
      };
      const sendError = async (a, e, i, n, s, t, c) => {
        const { err: p, message: r, code: l, statusCode: u } = c;
        if (p && process.env.NODE_ENV !== "test") {
          console.error(p);
        }
        e.statusCode = u;
        if (i) {
          e.setHeader("Content-Type", "application/json; charset=utf-8");
          e.end(JSON.stringify({ error: { code: l, message: r } }));
          return;
        }
        let d = null;
        const m = o.join(n, `${u}.html`);
        try {
          d = await s.lstat(m);
        } catch (a) {
          if (a.code !== "ENOENT") {
        ...
        if (d) {
          let a = null;
          try {
            a = await s.createReadStream(m);
            const i = await getHeaders(s, t, n, m, d);
            e.writeHead(u, i);
            a.pipe(e);
            return;
          } catch (a) {
        ...
        const x = await getHeaders(s, t, n, a, null);
        x["Content-Type"] = "text/html; charset=utf-8";
        e.writeHead(u, x);
        e.end(w({ statusCode: u, message: r }));
      };
      const internalError = async (...a) => {
        const e = a.length - 1;
        const i = a[e];
        a[e] = {
          statusCode: 500,
      ...
      a.exports = async (a, e, i = {}, n = {}) => {
        const s = process.cwd();
        const t = i.public ? o.resolve(s, i.public) : s;
        const c = getHandlers(n);
        let p = null;
        let r = null;
        if (a.headers.accept) {
          r = a.headers.accept.includes("application/json");
        }
        try {
          p = decodeURIComponent(l.parse(a.url).pathname);
        } catch (a) {
          return sendError("/", e, r, t, c, i, {
            statusCode: 400,
            code: "bad_request",
            message: "Bad Request",
          });
        ...
        let u = o.join(t, p);
        if (!h(u, t)) {
          return sendError(u, e, r, t, c, i, {
            statusCode: 400,
            code: "bad_request",
            message: "Bad Request",
          });
        }
        const d = applicable(p, i.cleanUrls);
        const m = shouldRedirect(p, i, d);
        if (m) {
          e.writeHead(m.statusCode, { Location: encodeURI(m.target) });
          e.end();
          return;
        }
        let x = null;
        if (o.extname(p) !== "") {
          try {
            ...
            if (a.code !== "ENOENT" && a.code !== "ENOTDIR") {
              return internalError(u, e, r, t, c, i, a);
            }
          }
        }
        const v = applyRewrites(p, i.rewrites);
        if (!x && (d || v)) {
          try {
            const a = await findRelated(t, p, v, c.lstat);
            if (a) {
              ({ stats: x, absolutePath: u } = a);
            }
          } catch (a) {
            if (a.code !== "ENOENT" && a.code !== "ENOTDIR") {
              return internalError(u, e, r, t, c, i, a);
        ...
        if (x && x.isDirectory()) {
          ...
          let o = null;
          try {
            const e = await renderDirectory(t, r, c, n, i, {
              relativePath: p,
              absolutePath: u,
            });
            if (e.singleFile) {
              ({ stats: x, absolutePath: u, singleFile: o } = e);
            } else {
              ({ directory: a } = e);
            }
          } catch (a) {
        ...
        const f = x && x.isSymbolicLink();
        if (!x || (!i.symlinks && f)) {
          return c.sendError(u, e, r, t, c, i, {
            statusCode: 404,
            code: "not_found",
        ...
        const b = {};
        if (a.headers.range && x.size) {
          const i = g(x.size, a.headers.range);
          if (typeof i === "object" && i.type === "bytes") {
            const { start: a, end: n } = i[0];
            b.start = a;
            b.end = n;
            e.statusCode = 206;
          } else {
            e.statusCode = 416;
            e.setHeader("Content-Range", `bytes */${x.size}`);
          }
        }
        let w = null;
        try {
          w = await c.createReadStream(u, b);
        } catch (a) {
          return internalError(u, e, r, t, c, i, a);
        }
        const y = await getHeaders(c, i, t, u, x);
        if (b.start !== undefined && b.end !== undefined) {
          y["Content-Range"] = `bytes ${b.start}-${b.end}/${x.size}`;
          y["Content-Length"] = b.end - b.start + 1;
        }
        if (
          a.headers.range == null &&
          y.ETag &&
          y.ETag === a.headers["if-none-match"]
        ) {
          e.statusCode = 304;
          e.end();
          return;
        }
        e.writeHead(e.statusCode || 200, y);
        w.pipe(e);
      };
    },
    113: (a) => {
    ...
    666: (a) => {
      "use strict";
      a.exports = require("next/dist/compiled/bytes");
    },
    836: (a) => {
      "use strict";
      a.exports = require("next/dist/compiled/content-disposition");
    },
    671: (a) => {
      "use strict";
      a.exports = require("next/dist/compiled/path-to-regexp");
    },
    17: (a) => {
      "use strict";
  ...
  function __nccwpck_require__(i) {
    ...
    var s = true;
    try {
      a[i](o, o.exports, __nccwpck_require__);
      s = false;
    } finally {
      if (s) delete e[i];
    }
