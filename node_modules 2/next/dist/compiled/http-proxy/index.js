  ...
  var e = {
    ...
    900: (e, t, r) => {
      ...
      function wrap(e) {
        ...
        Object.keys(e).forEach(function (s) {
          var i = s + ":";
          var c = (r[i] = e[s]);
          var f = (t[s] = Object.create(c));
          f.request = function (e, s, c) {
            if (typeof e === "string") {
              var f = e;
              try {
                e = urlToOptions(new n(f));
              } catch (t) {
                e = o.parse(f);
              }
    ...
    341: (e, t, r) => {
      ...
      o.setupOutgoing = function (e, t, r, u) {
        ...
        e.headers = Object.assign({}, r.headers);
        if (t.headers) {
          Object.assign(e.headers, t.headers);
        }
        if (t.auth) {
          e.auth = t.auth;
        }
        ...
        e.headers = e.headers || {};
        var f = Object.keys(e.headers).some(function (t) {
          return (
            t.toLowerCase() === "transfer-encoding" &&
            typeof e.headers[t] !== "undefined"
          );
        });
        if (
          f ||
        ...
        if (!e.agent) {
          if (
            typeof e.headers.connection !== "string" ||
            !i.test(e.headers.connection)
          ) {
            e.headers.connection = "close";
          }
        }
        var h = t[u || "target"];
        var p = h && t.prependPath !== false ? h.path || "" : "";
        var d = !t.toProxy ? n.parse(r.url).path || "" : r.url;
        d = !t.ignorePath ? d : "";
        e.path = o.urlJoin(p, d);
        if (t.changeOrigin) {
          e.headers.host =
            s(e.port, t[u || "target"].protocol) && !hasPort(e.host)
              ? e.host + ":" + e.port
              : e.host;
        }
        return e;
    ...
    458: (e, t, r) => {
      ...
      function createRightProxy(e) {
        return function (t) {
          return function (r, o) {
            var s = e === "ws" ? this.wsPasses : this.webPasses,
            ...
            var f = t;
            if (!(i[a] instanceof Buffer) && i[a] !== o) {
              f = Object.assign({}, t);
              Object.assign(f, i[a]);
              a--;
            }
            if (i[a] instanceof Buffer) {
              c = i[a];
            }
            ["target", "forward"].forEach(function (e) {
              if (typeof f[e] === "string") f[e] = n(f[e]);
            });
            if (!f.target && !f.forward) {
              return this.emit(
                "error",
      ...
      function ProxyServer(e) {
        ...
        this.options = e;
        this.webPasses = Object.keys(c).map(function (e) {
          return c[e];
        });
      ...
      ProxyServer.prototype.listen = function (e, t) {
        ...
        this._server = this.options.ssl
          ? a.createServer(this.options.ssl, closure)
          : i.createServer(closure);
        if (this.options.ws) {
       ...
       */ e.exports = {
        deleteLength: function deleteLength(e, t, r) {
          if (
            ...
            typeof e.headers["content-length"] === "undefined" &&
            typeof e.headers["transfer-encoding"] === "undefined"
          ) {
        ...
        stream: function stream(e, t, r, o, n, u) {
