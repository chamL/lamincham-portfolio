    ...
    533: function (e, t) {
      (function (e, i) {
        ...
        function wordsRegexp(e) {
          return (
            w[e] || (w[e] = new RegExp("^(?:" + e.replace(/ /g, "|") + ")$"))
          );
        }
        ...
        Q.inGenerator.get = function () {
          return (
            (this.currentVarScope().flags & R) > 0 &&
            !this.currentVarScope().inClassFieldInit
          );
        };
        Q.inAsync.get = function () {
          return (
            (this.currentVarScope().flags & L) > 0 &&
            !this.currentVarScope().inClassFieldInit
          );
        };
        ...
        $.parseForStatement = function (e) {
          ...
          var c =
            t > -1
              ? this.parseExprSubscripts(h, "await")
              : this.parseExpression(true, h);
          if (
            this.type === m._in ||
        ...
        m.parenL.updateContext = function (e) {
          var t =
            e === m._if || e === m._for || e === m._with || e === m._while;
        ...
        m._function.updateContext = m._class.updateContext = function (e) {
          if (
            e.beforeExpr &&
            e !== m._else &&
            !(e === m.semi && this.curContext() !== oe.p_stat) &&
            !(
              e === m._return &&
              g.test(this.input.slice(this.lastTokEnd, this.start))
            ) &&
        ...
        pe.parseMaybeUnary = function (e, t, i, s) {
          ...
          if (this.isContextual("await") && this.canAwait) {
            ...
            if (h) {
              ...
              this.strict &&
              o.operator === "delete" &&
              isLocalVariableAccess(o.argument)
            ) {
              this.raiseRecoverable(
                o.start,
        ...
        pe.parseExprAtom = function (e, t, i) {
          ...
          switch (this.type) {
            ...
            case m.regexp:
              ...
              s.regex = { pattern: p.pattern, flags: p.flags };
              return s;
            case m.num:
            case m.string:
        ...
        pe.parseTemplateElement = function (e) {
          ...
          if (this.type === m.invalidTemplate) {
            ...
            i.value = { raw: this.value.replace(/\r\n?/g, "\n"), cooked: null };
          } else {
            i.value = {
              raw: this.input
        ...
        var ke = be;
        var _e = ke;
        var Se = { 9: ve, 10: xe, 11: ye, 12: be, 13: ke, 14: _e };
        var Ce =
        ...
        var Ve = Te + " " + ge;
        var Le = { 9: Ie, 10: Ae, 11: Pe, 12: Ne, 13: Te, 14: Ve };
        var Re = {};
        ...
        var Ue = function RegExpValidationState(e) {
          ...
          this.unicodeProperties =
            Re[e.options.ecmaVersion >= 14 ? 14 : e.options.ecmaVersion];
          this.source = "";
          this.flags = "";
          this.start = 0;
          this.switchU = false;
        ...
        Me.regexp_eatClassSetCharacter = function (e) {
          ...
          if (
            i < 0 ||
            (i === e.lookahead() &&
              isClassSetReservedDoublePunctuatorCharacter(i))
          ) {
            return false;
          }
