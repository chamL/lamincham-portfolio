  ...
  var e = {
    ...
    119: (e, t, i) => {
      ...
      class Command extends n {
        ...
        hook(e, t) {
          ...
          if (!i.includes(e)) {
            throw new Error(
              `Unexpected value for event passed to hook : '${e}'.\nExpecting one of '${i.join("', '")}'`,
            );
          }
        ...
        _registerOption(e) {
          ...
          if (t) {
            ...
            throw new Error(
              `Cannot add option '${e.flags}'${this._name && ` to command '${this._name}'`} due to conflicting flag '${i}'\n-  already used by option '${t.flags}'`,
            );
          }
          this.options.push(e);
        }
          ...
          if (e.negate) {
            ...
            if (!this._findOption(t)) {
              this.setOptionValueWithSource(
                i,
                e.defaultValue === undefined ? true : e.defaultValue,
                "default",
              );
            }
        ...
        requiredOption(e, t, i, n) {
          return this._optionEx({ mandatory: true }, e, t, i, n);
        }
        ...
        _executeSubCommand(e, t) {
          ...
          if (a.platform !== "win32") {
            if (i) {
              ...
              c = s.spawn(a.argv[0], t, { stdio: "inherit" });
            } else {
              c = s.spawn(h, t, { stdio: "inherit" });
            }
          } else {
            t.unshift(h);
            t = incrementNodeInspectorPort(a.execArgv).concat(t);
            c = s.spawn(a.execPath, t, { stdio: "inherit" });
          }
          if (!c.killed) {
          ...
          this._getCommandAndAncestors()
            ...
            .forEach((e) => {
              e._lifeCycleHooks[t].forEach((t) => {
                n.push({ hookedCommand: e, callback: t });
              });
            });
          if (t === "postAction") {
            n.reverse();
        ...
        _checkForMissingMandatoryOptions() {
          this._getCommandAndAncestors().forEach((e) => {
            e.options.forEach((t) => {
              if (
                t.mandatory &&
                e.getOptionValue(t.attributeName()) === undefined
              ) {
        ...
        _checkForConflictingLocalOptions() {
          ...
          t.forEach((t) => {
            const i = e.find((e) =>
              t.conflictsWith.includes(e.attributeName()),
            );
            if (i) {
        ...
        _parseOptionsImplied() {
          ...
          this.options
            .filter(
              (t) =>
                t.implied !== undefined &&
                hasCustomOptionValue(t.attributeName()) &&
                e.valueFromOption(this.getOptionValue(t.attributeName()), t),
            )
            .forEach((e) => {
        ...
        alias(e) {
          ...
          if (i) {
            const t = [i.name()].concat(i.aliases()).join("|");
            throw new Error(
        ...
        outputHelp(e) {
          ...
          this._getCommandAndAncestors()
            .reverse()
            .forEach((e) => e.emit("beforeAllHelp", i));
        ...
        addHelpText(e, t) {
          ...
          this.on(n, (e) => {
            ...
            if (typeof t === "function") {
              i = t({ error: e.error, command: e.command });
            } else {
              i = t;
            }
            if (i) {
    ...
    638: (e, t, i) => {
      ...
      class Help {
        ...
        longestSubcommandTermLength(e, t) {
          return t
            .visibleCommands(e)
            .reduce((e, i) => Math.max(e, t.subcommandTerm(i).length), 0);
        }
        longestOptionTermLength(e, t) {
          return t
            .visibleOptions(e)
            .reduce((e, i) => Math.max(e, t.optionTerm(i).length), 0);
        }
        ...
        longestArgumentTermLength(e, t) {
          return t
            .visibleArguments(e)
            .reduce((e, i) => Math.max(e, t.argumentTerm(i).length), 0);
        }
        commandUsage(e) {
          let t = e._name;
          if (e._aliases[0]) {
        ...
        optionDescription(e) {
          ...
          if (e.argChoices) {
            t.push(
              `choices: ${e.argChoices.map((e) => JSON.stringify(e)).join(", ")}`,
            );
          }
        ...
        formatHelp(e, t) {
          ...
          if (a.length > 0) {
            o = o.concat([t.wrap(a, n, 0), ""]);
          }
          const h = t
            .visibleArguments(e)
            .map((e) =>
              formatItem(t.argumentTerm(e), t.argumentDescription(e)),
            );
          if (h.length > 0) {
    ...
    301: (e, t) => {
      ...
      function editDistance(e, t) {
        if (Math.abs(e.length - t.length) > i)
