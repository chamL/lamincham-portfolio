(() => {
    ...
    582: (e, r) => {
      ...
      r.PARENT_MESSAGE_SETUP_ERROR =
        ...
        r.CHILD_MESSAGE_CALL =
          void 0;
      const _ = 0;
      r.CHILD_MESSAGE_INITIALIZE = _;
      const t = 1;
      r.CHILD_MESSAGE_CALL = t;
      const n = 2;
  ...
  function __nccwpck_require__(e) {
    ...
    var t = true;
    try {
      __webpack_modules__[e](_, _.exports, __nccwpck_require__);
      t = false;
    } finally {
  ...
  (() => {
    var _types = __nccwpck_require__(582);
    let file = null;
    let setupArgs = [];
    ...
    const messageListener = (e) => {
      switch (e[0]) {
        ...
        default:
          throw new TypeError(
            "Unexpected request from parent process: " + e[0],
          );
      }
    };
    ...
    function execFunction(e, r, _, t, n) {
      let o;
      try {
        o = e.apply(r, _);
      } catch (e) {
