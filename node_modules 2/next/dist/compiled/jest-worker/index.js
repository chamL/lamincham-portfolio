  ...
  var e = {
      ...
      class Farm {
        constructor(e, t, r = {}) {
          ...
          this._workerSchedulingPolicy =
            (s = r.workerSchedulingPolicy) !== null && s !== void 0
              ? s
              : "round-robin";
          this._taskQueue =
            (o = r.taskQueue) !== null && o !== void 0 ? o : new i.default();
        }
        doWork(e, ...t) {
          const r = new Set();
          ...
          const i = new Promise(
            ((t, i, o) => {
              ...
              const u = [s.CHILD_MESSAGE_CALL, false, e, t];
              let _ = null;
              let l = null;
              if (n) {
                l = n.call(this, e, ...t);
    ...
    552: (e, t) => {
      ...
      class FifoQueue {
        ...
        enqueue(e, t) {
          ...
          const s = { previousSharedTask: i, task: e };
          r.enqueue(s);
        }
        dequeue(e) {
          var t, r, i;
          ...
          const o =
            (r =
              s === null || s === void 0
                ? void 0
                : (i = s.previousSharedTask) === null || i === void 0
                  ? void 0
                  : i.request[1]) !== null && r !== void 0
              ? r
              : true;
          if (s != null && o) {
            var n, u, _;
      ...
      class PriorityQueue {
        ...
        dequeue(e) {
          ...
          if (i == null || (r != null && r.priority <= i.priority)) {
            var s, o;
            return (s =
              (o = t.poll()) === null || o === void 0 ? void 0 : o.task) !==
              null && s !== void 0
              ? s
              : null;
          }
    ...
    922: (e, t, r) => {
      ...
      function messageParent(e, t = process) {
        if (s) {
          ...
          t.postMessage([i.PARENT_MESSAGE_CUSTOM, e]);
        } else if (typeof t.send === "function") {
          t.send([i.PARENT_MESSAGE_CUSTOM, e]);
        } else {
    ...
    178: (e, t, r) => {
      ...
      e.exports = {
        ...
        stdout: getSupportLevel({ isTTY: s.isatty(1) }),
        stderr: getSupportLevel({ isTTY: s.isatty(2) }),
      };
    },
    81: (e) => {
  ...
  (() => {
    ...
    class Worker {
      constructor(e, r) {
        ...
        const a = {
          enableWorkerThreads:
            (s = this._options.enableWorkerThreads) !== null && s !== void 0
              ? s
              : false,
          forkOptions:
            (o = this._options.forkOptions) !== null && o !== void 0 ? o : {},
          maxRetries:
