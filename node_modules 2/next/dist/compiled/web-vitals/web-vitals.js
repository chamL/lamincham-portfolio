(function () {
  ...
  !(function () {
    n.d = function (b, L) {
      for (var P in L) {
        if (n.o(L, P) && !n.o(b, P)) {
          Object.defineProperty(b, P, { enumerable: true, get: L[P] });
        }
      }
    };
  })();
  ...
  var L,
    ...
    f = function (n, b) {
      var L = c(),
        P = "navigate";
      D >= 0
        ? (P = "back-forward-cache")
        : L &&
          (document.prerendering || u() > 0
            ? (P = "prerender")
            : document.wasDiscarded
              ? (P = "restore")
              : L.type && (P = L.type.replace(/_/g, "-")));
      return {
        name: n,
        value: void 0 === b ? -1 : b,
        rating: "good",
    ...
    s = function (n, b, L) {
      try {
        if (PerformanceObserver.supportedEntryTypes.includes(n)) {
          ...
          return (
            P.observe(Object.assign({ type: n, buffered: !0 }, L || {})),
            P
          );
        }
      } catch (n) {}
    ...
    d = function (n, b, L, P) {
      ...
      return function (F) {
        b.value >= 0 &&
          (F || P) &&
          ((A = b.value - (I || 0)) || void 0 === I) &&
          ((I = b.value),
          (b.delta = A),
          (b.rating = (function (n, b) {
    ...
    g = function (n) {
      "hidden" === document.visibilityState &&
        O > -1 &&
        ((O = "visibilitychange" === n.type ? n.timeStamp : 0), T());
    },
    y = function () {
      ...
      ((b = b || {}),
        C(function () {
          var L,
            P = E(),
            I = f("FCP"),
            A = s("paint", function (n) {
              n.forEach(function (n) {
                "first-contentful-paint" === n.name &&
                  (A.disconnect(),
                  n.startTime < P.firstHiddenTime &&
                ...
                (n.forEach(function (n) {
                  if (!n.hadRecentInput) {
                    var b = A[0],
                      L = A[A.length - 1];
                    I &&
                    n.startTime - L.startTime < 1e3 &&
                    n.startTime - b.startTime < 5e3
                      ? ((I += n.value), A.push(n))
                      : ((I = n.value), (A = [n]));
                  }
                }),
    ...
    M = function (n) {
      n.forEach(function (n) {
        n.interactionId &&
          ((_ = Math.min(_, n.interactionId)),
          (G = Math.max(G, n.interactionId)),
          (x = G ? (G - _) / 7 + 1 : 0));
      });
    },
    k = function () {
    ...
    H = function (n) {
      if (
        ...
        var b = J[J.length - 1],
          L = Q.get(n.interactionId);
        if (L || J.length < 10 || n.duration > b.latency) {
          if (L)
            n.duration > L.latency
              ? ((L.entries = [n]), (L.latency = n.duration))
              : n.duration === L.latency &&
                n.startTime === L.entries[0].startTime &&
                L.entries.push(n);
          else {
            var P = { id: n.interactionId, latency: n.duration, entries: [n] };
    ...
    q = function (n) {
      var b = self.requestIdleCallback || self.setTimeout,
        L = -1;
      return (
        (n = v(n)),
        "hidden" === document.visibilityState ? n() : ((L = b(n)), p(n)),
        L
      );
    },
    nn = [200, 500],
          ...
          var P,
            ...
            o = function (n) {
              q(function () {
                ...
                var b,
                  L =
                    ((b = Math.min(J.length - 1, Math.floor(R() / 50))), J[b]);
                L &&
                  L.latency !== I.value &&
                  ((I.value = L.latency), (I.entries = L.entries), P());
              });
            },
            A = s("event", o, {
              durationThreshold:
                null !== (L = b.durationThreshold) && void 0 !== L ? L : 40,
            });
          ((P = d(n, I, nn, b.reportAllChanges)),
            A &&
      ...
      ((b = b || {}),
        C(function () {
          var L,
            ...
            I = f("LCP"),
            o = function (n) {
              (b.reportAllChanges || (n = n.slice(-1)),
                n.forEach(function (n) {
                  n.startTime < P.firstHiddenTime &&
                    ((I.value = Math.max(n.startTime - u(), 0)),
                    (I.entries = [n]),
          ...
          if (A) {
            ...
            var F = v(function () {
              tn[I.id] ||
                (o(A.takeRecords()), A.disconnect(), (tn[I.id] = !0), L(!0));
            });
            (["keydown", "click"].forEach(function (n) {
              ...
              a(function (P) {
                ((I = f("LCP")),
                  (L = d(n, I, en, b.reportAllChanges)),
                  l(function () {
                    ((I.value = performance.now() - P.timeStamp),
                      (tn[I.id] = !0),
                      L(!0));
                  }));
              }));
    ...
    K = function (n, b) {
      b = b || {};
      var L = f("TTFB"),
        P = d(n, L, rn, b.reportAllChanges);
      on(function () {
        var I = c();
        I &&
          ((L.value = Math.max(I.responseStart - u(), 0)),
          (L.entries = [I]),
          P(!0),
          a(function () {
        ...
        "pointerdown" == n.type
          ? (function (n, b) {
              var t = function () {
                ...
                i = function () {
                  (removeEventListener("pointerup", t, an),
                    removeEventListener("pointercancel", r, an));
                };
              (addEventListener("pointerup", t, an),
                addEventListener("pointercancel", r, an));
            })(b, n)
          : V(b, n);
      }
    },
      ...
      ((b = b || {}),
        C(function () {
          var L,
            ...
            D = f("FID"),
            l = function (n) {
              n.startTime < A.firstHiddenTime &&
                ((D.value = n.processingStart - n.startTime),
                D.entries.push(n),
                L(!0));
            },
            m = function (n) {
