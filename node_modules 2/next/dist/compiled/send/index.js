  ...
  var e = {
      ...
      function createError() {
        ...
        for (var o = 0; o < arguments.length; o++) {
          ...
          if (s === "object" && p instanceof Error) {
            ...
            throw new TypeError(
              "argument #" + (o + 1) + " unsupported type " + s,
            );
          }
        }
    ...
    71: (e, t, a) => {
      ...
      function attachFinishedListener(e, t) {
        ...
        a = i = n([[e, "end", "finish"]], onFinish);
        function onSocket(t) {
          e.removeListener("socket", onSocket);
          if (r) return;
          if (a !== i) return;
          i = n([[t, "error", "close"]], onFinish);
        }
        if (e.socket) {
          onSocket(e.socket);
          return;
    ...
    228: (e, t, a) => {
      ...
      function createHttpError(e, t) {
        ...
        return t instanceof Error ? i(e, t, { expose: false }) : i(e, t);
      }
      function decode(e) {
        try {
