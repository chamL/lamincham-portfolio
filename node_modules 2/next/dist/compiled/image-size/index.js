(() => {
  var t = {
    ...
    833: (t, e, n) => {
      ...
      const c = n(457);
      const a = 512 * 1024;
      const u = new s.default({ concurrency: 100, autostart: true });
    ...
    512: (t, e, n) => {
      ...
      function readImageHeader(t, e) {
        const n = e + o;
        return [(0, r.toUTF8String)(t, e, n), (0, r.readUInt32BE)(t, n)];
      }
      ...
      e.ICNS = {
        ...
        calculate(t) {
          ...
          o += c[1];
          if (o === n) return a;
          const u = { height: a.height, images: [a], width: a.width };
          while (o < n && o < e) {
    ...
    845: (t, e, n) => {
      ...
      e.ICO = {
        ...
        calculate(t) {
          ...
          return { height: n.height, images: i, width: n.width };
        },
      };
    },
    229: (t, e, n) => {
    ...
    33: (t, e, n) => {
      ...
      function calculateImageWidth(t, e, n, r) {
        if (e && n === 0) {
          ...
          const t = [1, 1.2, 4 / 3, 1.5, 16 / 9, 5 / 4, 2];
    ...
    753: (t, e, n) => {
      ...
      e.TGA = {
        validate(t) {
          return (
            (0, r.readUInt16LE)(t, 0) === 0 && (0, r.readUInt16LE)(t, 4) === 0
          );
        },
        calculate(t) {
          return {
    ...
    779: (t, e) => {
      ...
      const toHexString = (t, e = 0, n = t.length) =>
        t
          .slice(e, n)
          .reduce((t, e) => t + ("0" + e.toString(16)).slice(-2), "");
