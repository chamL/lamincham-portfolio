  ...
  var e = {
    701: (e) => {
      let t = process || {},
        ...
        s = t.env || {};
      let i =
        !(!!s.NO_COLOR || r.includes("--no-color")) &&
        (!!s.FORCE_COLOR ||
          r.includes("--color") ||
          t.platform === "win32" ||
          ((t.stdout || {}).isTTY && s.TERM !== "dumb") ||
          !!s.CI);
      let formatter =
        (e, t, r = e) =>
        (s) => {
