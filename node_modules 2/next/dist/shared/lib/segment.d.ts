...
export declare function addSearchParamsIfPageSegment(
  segment: Segment,
  searchParams: Record<string, string | string[] | undefined>,
): Segment;
export declare function computeSelectedLayoutSegment(
  segments: string[] | null,
  parallelRouteKey: string,
): string | null;
/** Get the canonical parameters from the current level to the leaf node. */
export declare function getSelectedLayoutSegmentPath(
